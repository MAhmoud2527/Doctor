...
function XM_Accordion(t) {
    var s = {
        ...
        try {
            for (var o, r = d.accordions[Symbol.iterator](); !(t = (o = r.next()).done); t = !0) {
                var i = o.value;
                i.content.style.overflow = "hidden", i.startOpen ? (i.content.style.height = "".concat(i.content.scrollHeight, "px"),
                    i.content.parentElement.classList.add(s.selectedClass)) : f(i);
            }
        } catch (t) {
            n = !0, e = t;
        } finally {
        ...
        t.open || (t.open = !0, t.content.style.height = "".concat(t.content.scrollHeight, "px"),
            t.content.parentElement.classList.add(s.selectedClass), s.paddingAnimation && (t.content.style.padding = t.padding));
    }, f = function (t) {
        t.open && (t.open = !1, t.content.style.height = 0, t.content.parentElement.classList.remove(s.selectedClass),
            s.paddingAnimation && (t.content.style.padding = 0));
    };
    return function t(n, e) {
        var o;
        for (var r in e) "object" !== _typeof(e[r]) || e[r] instanceof Date ? e[r] instanceof Date ? n[r] = new Date(e[r].getTime()) : n[r] = e[r] : (o = e[r] instanceof Array ? [] : {},
            void 0 === n[r] && (n[r] = o), t(n[r], e[r]));
...
function XM_Dropdown(t) {
    ...
    return function t(n, r) {
        var o;
        for (var e in r) "object" !== _typeof(r[e]) || r[e] instanceof Date ? r[e] instanceof Date ? n[e] = new Date(r[e].getTime()) : n[e] = r[e] : (o = r[e] instanceof Array ? [] : {},
            void 0 === n[e] && (n[e] = o), t(n[e], r[e]));
    }(g, t), r(), o(), g.controlToggle || i(), g.closeOnDropdownClick && s(), g.closeOnWindowClick && y(),
        d(), window.setTimeout(e, 300), n.showDropdowns = function () {
            var t = !0, n = !1, r = void 0;
            try {
                for (var o, e = h[Symbol.iterator](); !(t = (o = e.next()).done); t = !0) {
                    var i = o.value;
...
function XM_Hexagon(t) {
    var p = {
        ...
        try {
            for (var r, o = t[Symbol.iterator](); !(i = (r = o.next()).done); i = !0) {
                var a = r.value, d = {};
                d.container = a, d.imageSrc = a.getAttribute("data-src"), d.canvas = document.createElement("canvas"),
                    d.ctx = d.canvas.getContext("2d"), d.finishedDrawing = !1, d.canvas.width = p.width,
                    d.canvas.height = p.height, d.canvas.style.position = "absolute", d.canvas.style.top = 0,
                    d.canvas.style.left = 0, d.container.style.width = "".concat(p.width, "px"), d.container.style.height = "".concat(p.height, "px"),
                    d.container.style.position = "relative", d.container.append(d.canvas), h.push(d);
            }
        } catch (t) {
            e = !0, n = t;
        } finally {
        ...
        t.scale && (p.scale.stop = p.scale.stop > p.scale.end ? p.scale.end : p.scale.stop,
            p.scale.stop = p.scale.stop < p.scale.start ? p.scale.start : p.scale.stop, p.scale.stop = void 0 !== t.scale.stop ? p.scale.stop : p.scale.end),
            v.sideWidth = o(p.width, p.height), v.perimeter = 6 * v.sideWidth, v.lineLength = p.scale.stop / p.scale.end * v.perimeter,
            v.sideCount = Math.floor(v.lineLength / v.sideWidth), p.stopPoint = p.scale.stop;
    }, n = function () {
        ...
        try {
            for (var n, r = h[Symbol.iterator](); !(t = (n = r.next()).done); t = !0) {
                ...
                if (p.gradient) {
                    ...
                    a.addColorStop(0, p.gradient.colors[0]), a.addColorStop(1, p.gradient.colors[1]),
                        o.ctx.strokeStyle = a, o.ctx.fillStyle = a;
        ...
        try {
            for (var n, r = h[Symbol.iterator](); !(t = (n = r.next()).done); t = !0) {
                var o = n.value;
                p.speed = 100 < p.speed ? 100 : p.speed, p.speed = p.speed < 1 ? 1 : p.speed, o.animation = {},
                    o.animation.easing = p.animation.easing, o.animation.speed = p.speed, o.animation.step = o.animation.speed * p.width / 2e3,
    ...
    function d(t) {
        t.animation.currentProgress < p.stopPoint && (t.animation.easing ? (t.animation.currentProgress += .06 * (p.stopPoint - t.animation.currentProgress),
            t.animation.currentProgress >= p.stopPoint - 1 && (t.animation.currentProgress = p.stopPoint,
                t.finishedDrawing = !0)) : (t.animation.currentProgress += t.animation.step, t.animation.currentProgress >= p.stopPoint && (t.animation.currentProgress = p.stopPoint,
                    t.finishedDrawing = !0))), s(t, t.animation.currentProgress), t.finishedDrawing || window.requestAnimationFrame(d);
    }
    function m(t, i) {
    ...
    var o = function (t, i) {
        ...
        if (n.ctx.clearRect(0, 0, p.width, p.height), 0 !== i) {
            if (n.ctx.beginPath(), p.roundedCorners) {
                ...
                if (p.clip || p.fill) n.ctx.moveTo(p.width / 2 - r, p.roundedCornerRadius + e),
                    n.ctx.quadraticCurveTo(p.width / 2, 0 + e, p.width / 2 + r, p.roundedCornerRadius + e),
                    n.ctx.lineTo(p.width - e - r, o), n.ctx.quadraticCurveTo(p.width - e, (p.height - v.sideWidth) / 2, p.width - e, (p.height - v.sideWidth) / 2 + r),
                    n.ctx.lineTo(p.width - e, p.height - (p.height - v.sideWidth) / 2 - r), n.ctx.quadraticCurveTo(p.width - e, p.height - (p.height - v.sideWidth) / 2, p.width - e - r, p.height - o),
                    n.ctx.lineTo(p.width / 2 + r, p.height - e - p.roundedCornerRadius), n.ctx.quadraticCurveTo(p.width / 2, p.height - e, p.width / 2 - r, p.height - e - p.roundedCornerRadius),
                    n.ctx.lineTo(0 + e + r, p.height - o), n.ctx.quadraticCurveTo(0 + e, p.height - (p.height - v.sideWidth) / 2, 0 + e, p.height - (p.height - v.sideWidth) / 2 - r),
                    n.ctx.lineTo(0 + e, (p.height - v.sideWidth) / 2 + r), n.ctx.quadraticCurveTo(0 + e, (p.height - v.sideWidth) / 2, 0 + e + r, o),
                    n.ctx.lineTo(p.width / 2 - r, p.roundedCornerRadius + e); else for (; ;) {
                        var a = {
                            x: p.width / 2 - r,
                        ...
                        if (f = {
                            ...
                            x: p.width - e - r,
                            y: o
                        }, w = T(f, x, g), n.ctx.moveTo(p.width / 2 + r, p.roundedCornerRadius + e), n.ctx.lineTo(w.x, w.y),
                            (g -= w.distance) <= 0) break;
                        if (i <= 1 / 6) break;
                        if (n.ctx.quadraticCurveTo(p.width - e, (p.height - v.sideWidth) / 2, p.width - e, (p.height - v.sideWidth) / 2 + r),
                            (g -= s) <= 0) break;
                        if (f = {
                            x: p.width - e,
                        ...
                        if (i <= 2 / 6) break;
                        if (n.ctx.quadraticCurveTo(p.width - e, p.height - (p.height - v.sideWidth) / 2, p.width - e - r, p.height - o),
                            (g -= s) <= 0) break;
                        if (f = {
                            x: p.width - e - r,
                            y: p.height - o
                        ...
                        if (i <= .5) break;
                        if (n.ctx.quadraticCurveTo(p.width / 2, p.height - e, p.width / 2 - r, p.height - e - p.roundedCornerRadius),
                            (g -= s) <= 0) break;
                        if (f = {
                            x: p.width / 2 - r,
                            y: p.height - e - p.roundedCornerRadius
                        ...
                        if (i <= 4 / 6) break;
                        if (n.ctx.quadraticCurveTo(0 + e, p.height - (p.height - v.sideWidth) / 2, 0 + e, p.height - (p.height - v.sideWidth) / 2 - r),
                            (g -= s) <= 0) break;
                        if (f = {
                            x: 0 + e,
                            y: p.height - (p.height - v.sideWidth) / 2 - r
            ...
            } else p.clip || p.fill ? (n.ctx.moveTo(p.width / 2, 0), n.ctx.lineTo(p.width, (p.height - v.sideWidth) / 2),
                n.ctx.lineTo(p.width, p.height - (p.height - v.sideWidth) / 2), n.ctx.lineTo(p.width / 2, p.height),
                n.ctx.lineTo(0, p.height - (p.height - v.sideWidth) / 2), n.ctx.lineTo(0, (p.height - v.sideWidth) / 2),
                n.ctx.lineTo(p.width / 2, 0)) : (n.ctx.moveTo(p.width / 2, 0 + p.lineWidth / 2),
                    n.ctx.lineTo(p.width - p.lineWidth / 2, (p.height - v.sideWidth) / 2), n.ctx.lineTo(p.width - p.lineWidth / 2, p.height - (p.height - v.sideWidth) / 2),
                    n.ctx.lineTo(p.width / 2, p.height - p.lineWidth / 2), n.ctx.lineTo(0 + p.lineWidth / 2, p.height - (p.height - v.sideWidth) / 2),
                    n.ctx.lineTo(0 + p.lineWidth / 2, (p.height - v.sideWidth) / 2), n.ctx.lineTo(p.width / 2, 0 + p.lineWidth / 2));
            if (p.clip) {
                if (n.ctx.clip(), n.imageSrc) {
                    var y = new Image();
                    y.src = n.imageSrc, y.addEventListener("load", function () {
                        var t = Math.max(p.width, p.height), i = (Math.abs(p.width - p.height), p.width < p.height ? (p.width - p.height) / 2 : 0), e = p.height < p.width ? (p.height - p.width) / 2 : 0;
    ...
    this.render = function (t) {
        t = (t = (t = t > p.scale.end ? p.scale.end : t) < p.scale.start ? p.scale.start : t) / p.scale.end * p.width,
            s(t);
    }, function t(i, e) {
        var n;
        for (var r in e) "object" !== _typeof(e[r]) || e[r] instanceof Date ? e[r] instanceof Date ? i[r] = new Date(e[r].getTime()) : i[r] = e[r] : (n = e[r] instanceof Array ? [] : {},
            void 0 === i[r] && (i[r] = n), t(i[r], e[r]));
...
function XM_Popup(t) {
    function n() {
        "static" === s.overlay.animation.type ? r.overlay.style.display = "block" : "fade" === s.overlay.animation.type && (r.overlay.style.opacity = 1,
            r.overlay.style.visibility = "visible"), r.visible = !0, s.sticky || (r.popupContainer.style.top = "".concat(s.offset.top + window.scrollY, "px")),
            "fade" === s.animation.type ? (r.popupContainer.style.opacity = 1, r.popupContainer.style.visibility = "visible") : "translate-in" === s.animation.type || "translate-out" === s.animation.type ? (r.popupContainer.style.visibility = "visible",
                r.popupContainer.style.transform = "translate(0, 0)") : "zoom" === s.animation.type ? (r.popupContainer.style.visibility = "visible",
                    r.popupContainer.style.transform = "scale(1)") : "translate-in-fade" === s.animation.type || "translate-out-fade" === s.animation.type ? (r.popupContainer.style.opacity = 1,
                        r.popupContainer.style.visibility = "visible", r.popupContainer.style.transform = "translate(0, 0)") : "zoom-fade" === s.animation.type && (r.popupContainer.style.opacity = 1,
    ...
    var s = {
        ...
        r.overlay.style.width = "100%", r.overlay.style.height = "100%", r.overlay.style.backgroundColor = "rgba(".concat(s.overlay.color, ", ").concat(s.overlay.opacity, ")"),
            r.overlay.style.position = "fixed", r.overlay.style.top = 0, r.overlay.style.left = 0,
            r.overlay.style.zIndex = 1e5, a(), i();
    }, i = function () {
        ...
        "static" === s.overlay.animation.type ? r.overlay.style.display = "none" : "fade" === s.overlay.animation.type && (r.overlay.style.opacity = 0,
        ...
        r.popupContainer.style.position = s.sticky ? "fixed" : "absolute", r.popupContainer.style.left = "50%",
            r.popupContainer.style.zIndex = 100001, f(), u();
    }, c = function () {
        var t = window.innerHeight - r.popupContainer.offsetHeight, n = t < 0 ? 0 : t / 2, e = t < 0 ? 0 : t;
        "center" === s.align ? r.popupContainer.style.top = "".concat(n, "px") : "top" === s.align ? r.popupContainer.style.top = "".concat(s.offset.top, "px") : "bottom" === s.align && (r.popupContainer.style.top = "".concat(e, "px")),
        ...
        r.visible = !1, "fade" === s.animation.type ? (r.popupContainer.style.opacity = 0,
            r.popupContainer.style.visibility = "hidden") : "translate-in" === s.animation.type ? (r.popupContainer.style.visibility = "hidden",
                r.popupContainer.style.transform = "translate(0, -".concat(s.animation.translateOffset, "px)")) : "translate-out" === s.animation.type ? (r.popupContainer.style.visibility = "hidden",
                    r.popupContainer.style.transform = "translate(0, ".concat(s.animation.translateOffset, "px)")) : "zoom" === s.animation.type ? (r.popupContainer.style.visibility = "hidden",
                        r.popupContainer.style.transform = "scale(0)") : "translate-in-fade" === s.animation.type ? (r.popupContainer.style.opacity = 0,
                            r.popupContainer.style.visibility = "hidden", r.popupContainer.style.transform = "translate(0, -".concat(s.animation.translateOffset, "px)")) : "translate-out-fade" === s.animation.type ? (r.popupContainer.style.opacity = 0,
                                r.popupContainer.style.visibility = "hidden", r.popupContainer.style.transform = "translate(0, ".concat(s.animation.translateOffset, "px)")) : "zoom-fade" === s.animation.type && (r.popupContainer.style.opacity = 0,
    ...
    return function t(n, e) {
        var o;
        for (var i in e) "object" !== _typeof(e[i]) || e[i] instanceof Date ? e[i] instanceof Date ? n[i] = new Date(e[i].getTime()) : n[i] = e[i] : (o = e[i] instanceof Array ? [] : {},
            void 0 === n[i] && (n[i] = o), t(n[i], e[i]));
...
function XM_ProgressBar(h) {
    ...
    var p = {
        ...
        t.style.width = "".concat(e.partWidth + 2 * e.width, "px"), t.style.height = "".concat(p.height + 2 * e.width, "px"),
            t.style.border = "".concat(e.width, "px solid ").concat(e.color), t.style.borderRadius = "200px",
            t.style.position = "absolute", t.style.top = "-".concat(e.width, "px"), t.style.left = "".concat(e.offset, "px"),
        ...
        o.width = p.width, o.height = p.height, o.style.position = "absolute", o.style.top = 0,
            o.style.left = 0, l.container.style.width = "".concat(p.width, "px"), l.container.style.height = "".concat(p.height, "px"),
            l.container.style.position = "relative", l.container.append(o);
    }, m = function () {
        var e = 1 / 0;
        ...
        void 0 === e && ((e = {}).width = p.width, e.height = p.height), o.width = e.width,
            o.height = e.height, l.container.style.width = "".concat(e.width, "px"), l.container.style.height = "".concat(e.height, "px");
        var t = p.scale.stop / p.scale.end * e.width;
        if (a(t), p.linkElContainer && p.innerTextFollowsProgress && (p.linkElContainer.style.left = "".concat(t, "px")),
            k(), 0 != t) {
            if (r.beginPath(), "butt" === p.lineCap && (r.moveTo(0, e.height / 2), r.lineTo(t, e.height / 2)),
                "round" === p.lineCap) {
                var n = r.lineWidth / 2, i = t - n;
                p.reverse ? (r.moveTo(e.width - n, e.height / 2), e.width - t <= n ? r.lineTo(n, e.height / 2) : r.lineTo(e.width - t, e.height / 2)) : (r.moveTo(n, e.height / 2),
                    i < n ? r.lineTo(n, e.height / 2) : r.lineTo(i, e.height / 2));
            }
            r.stroke();
        }
    }, T = function () {
        p.linkText && (p.innerLink && (p.linkElContainer = l.container.parentElement.querySelector(p.linkToContainer),
            p.linkElContainer || (p.linkElContainer = document.createElement("div"), e(p.linkElContainer, p.linkToContainer),
                l.container.append(p.linkElContainer)), p.linkEl = l.container.parentElement.querySelector(p.linkTo),
            p.linkEl || (p.linkEl = document.createElement("p"), e(p.linkEl, p.linkTo), p.linkElContainer.append(p.linkEl)),
            p.innerTextFollowsProgress && (p.linkElContainer.style.position = "absolute"), p.linkUnits && (p.linkUnitsEl = document.createElement("span"),
                e(p.linkUnitsEl, p.linkUnitsSelector), p.linkUnitsEl.innerHTML = p.linkUnits)),
            0 < p.extraLinkTo.length && (p.extraLinkEl = [], p.extraLinkTo.forEach(function (e) {
        ...
        if (p.linkText) {
            ...
            p.invertedProgress && (t = p.scale.end - t), p.innerLink && (p.linkEl.innerHTML = t,
                p.linkUnits && p.linkEl.append(p.linkUnitsEl), "/" === p.linkUnits && (p.linkEl.innerHTML += p.scale.end),
                p.innerTextFollowsProgress && (p.linkElContainer.style.left = "".concat(e, "px"))),
                0 < p.extraLinkTo.length && p.extraLinkEl.forEach(function (e) {
                    e.innerHTML = t;
                });
        }
    }, y = function () {
        p.speed = 100 < p.speed ? 100 : p.speed, p.speed = p.speed < 1 ? 1 : p.speed, p.animation.step = p.speed * p.width / 2e3,
            p.animation.currentProgress = 0;
    };
    function k() {
        if (p.gradient) {
            var e = r.createLinearGradient(0, p.height, p.width, 0);
            e.addColorStop(0, p.gradient.colors[0]), e.addColorStop(1, p.gradient.colors[1]),
                r.strokeStyle = e;
    ...
    function x() {
        p.animation.currentProgress < p.stopPoint && (p.animation.easing ? (p.animation.currentProgress += .06 * (p.stopPoint - p.animation.currentProgress),
            p.animation.currentProgress >= p.stopPoint - 1 && (p.animation.currentProgress = p.stopPoint,
                l.done = !0)) : (p.animation.currentProgress += p.animation.step, p.animation.currentProgress >= p.stopPoint && (p.animation.currentProgress = p.stopPoint,
                    l.done = !0))), E(p.animation.currentProgress), l.done || window.requestAnimationFrame(x);
    }
    var E = function (e) {
        var t = 0 < arguments.length && void 0 !== e ? e : p.stopPoint;
        if (a(t), r.clearRect(0, 0, p.width, p.height), 0 === t) return p.emptyText && (p.emptyTextContainer ? p.emptyTextEl = document.querySelector(p.emptyTextContainer) : p.emptyTextEl = p.linkEl.parentElement,
            p.emptyTextEl.innerHTML = p.emptyText), void (l.done = !0);
        if (r.beginPath(), "butt" === p.lineCap && (r.moveTo(0, p.height / 2), r.lineTo(t, p.height / 2),
            r.stroke()), "round" === p.lineCap) {
            var n = r.lineWidth / 2, i = t - n;
            p.reverse ? (r.moveTo(p.width - n, p.height / 2), p.width - t <= n ? r.lineTo(n, p.height / 2) : r.lineTo(p.width - t, p.height / 2)) : (r.moveTo(n, p.height / 2),
                i < n ? r.lineTo(n, p.height / 2) : r.lineTo(i, p.height / 2)), r.stroke(), p.buttEnd && (r.lineCap = "butt",
                    p.reverse ? (r.moveTo(p.width - t, p.height / 2), r.lineTo(p.width - t - n, p.height / 2)) : (r.moveTo(i, p.height / 2),
                        r.lineTo(t, p.height / 2)), r.stroke(), r.lineCap = "round");
        }
        p.barText && s(t), p.completeText && t === p.width && (p.completeTextContainer ? p.completeTextEl = document.querySelector(p.completeTextContainer) : p.completeTextEl = p.linkEl.parentElement,
            p.completeTextEl.innerHTML = p.completeText);
    }, s = function (e) {
        var t = 0;
        r.font = p.barTextStyle.font;
        for (var n = 0; n < p.barText.length; n++) r.fillStyle = p.barTextStyle.primaryColor,
            e < t + 12 && (r.fillStyle = p.barTextStyle.secondaryColor), r.fillText(p.barText[n], 12 + t, 4 + p.height / 2),
            t += r.measureText(p.barText[n]).width;
    };
    l.render = function (e) {
        e = (e = (e = e > p.scale.end ? p.scale.end : e) < p.scale.start ? p.scale.start : e) / p.scale.end * p.width,
            E(e);
    };
    var b = function e(t, n) {
        var i;
        for (var o in n) "object" !== _typeof(n[o]) || n[o] instanceof Date ? n[o] instanceof Date ? t[o] = new Date(n[o].getTime()) : t[o] = n[o] : (i = n[o] instanceof Array ? [] : {},
            void 0 === t[o] && (t[o] = i), e(t[o], n[o]));
    };
    !function () {
        ...
        if (p.originalDimensions = {
            width: p.width,
            height: p.height
        }, m(), h.scale && (p.scale.stop = p.scale.stop > p.scale.end ? p.scale.end : p.scale.stop,
            p.scale.stop = p.scale.stop < p.scale.start ? p.scale.start : p.scale.stop, p.scale.stop = void 0 !== h.scale.stop ? p.scale.stop : p.scale.end),
            p.stopPoint = p.scale.stop / p.scale.end * p.width, u(), T(), k(), y(), p.animateOnScroll ? v() ? window.requestAnimationFrame(x) : window.addEventListener("scroll", function e() {
...
function XM_Tab(n) {
    var a = {
        ...
        var i;
        for (var r in e) "object" !== _typeof(e[r]) || e[r] instanceof Date ? e[r] instanceof Date ? n[r] = new Date(e[r].getTime()) : n[r] = e[r] : (i = e[r] instanceof Array ? [] : {},
            void 0 === n[r] && (n[r] = i), t(n[r], e[r]));
    };
    return function () {
        if (T(a, n), r() && i()) {
            s.animationType = a.animation.type, window.innerWidth < 1366 && (a.animation.type = "static"),
                l(), u(a.startOpen - 1), g(), o();
            var t = e();
            window.addEventListener("resize", function () {
                window.innerWidth < 1366 && "desktop" === t ? (v(), a.animation.type = "static",
...
function XM_Tooltip(t) {
    var W = {
        ...
        o(t[0], W.container), h.tooltips = [], t.forEach(function (t) {
            ...
            void 0 !== W.parent ? t.parentElement.append(e) : t.append(e), i.containerElement = t,
                i.tooltipWrap = {
                    item: e,
                    visible: !1
                }, h.tooltips.push(i);
        ...
        try {
            for (var a, n = h.tooltips[Symbol.iterator](); !(t = (a = n.next()).done); t = !0) {
                ...
                void 0 !== W.parent ? o.containerElement.parentElement.style.position = "relative" : o.containerElement.style.position = "relative",
                    o.tooltipWrap.item.style.whiteSpace = "nowrap", o.tooltipWrap.item.style.position = "absolute",
                ...
                var l = -W.offset - r;
                o.tooltipWrap.item.style[W.direction] = "".concat(l, "px"), "center" === W.align ? "top" === W.direction || "bottom" === W.direction ? (o.tooltipWrap.item.style.left = "50%",
                    o.tooltipWrap.item.style.marginLeft = "-".concat(o.tooltipWrap.item.offsetWidth / 2, "px")) : "left" !== W.direction && "right" !== W.direction || (o.tooltipWrap.item.style.top = "50%",
                        o.tooltipWrap.item.style.marginTop = "-".concat(o.tooltipWrap.item.offsetHeight / 2, "px")) : o.tooltipWrap.item.style[W.align] = 0;
            }
        } catch (t) {
            i = !0, e = t;
        } finally {
        ...
        try {
            for (var a, n = function () {
                var t = a.value;
                "static" === W.animation.type ? t.tooltipWrap.item.style.display = "none" : "fade" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                    t.tooltipWrap.item.style.opacity = 0) : "zoom" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                        t.tooltipWrap.item.style.transform = "scale(0)") : "zoom-fade" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                            t.tooltipWrap.item.style.opacity = 0, t.tooltipWrap.item.style.transform = "scale(0)") : "translate-in" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                                "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out" === W.animation.type ? (t.tooltipWrap.item.style.visibility = "hidden",
                                    "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))) : "translate-in-fade" === W.animation.type ? (t.tooltipWrap.item.style.opacity = 0,
                                        t.tooltipWrap.item.style.visibility = "hidden", "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out-fade" === W.animation.type && (t.tooltipWrap.item.style.opacity = 0,
                                            t.tooltipWrap.item.style.visibility = "hidden", "top" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.tooltipWrap.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.tooltipWrap.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.tooltipWrap.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))),
                    window.setTimeout(function () {
        ...
        "static" === W.animation.type ? t.item.style.display = "block" : "fade" === W.animation.type ? (t.item.style.visibility = "visible",
            t.item.style.opacity = 1) : "zoom" === W.animation.type ? (t.item.style.visibility = "visible",
                t.item.style.transform = "scale(1)") : "zoom-fade" === W.animation.type ? (t.item.style.visibility = "visible",
                    t.item.style.opacity = 1, t.item.style.transform = "scale(1)") : "translate-in" === W.animation.type || "translate-out" === W.animation.type ? (t.item.style.visibility = "visible",
                        t.item.style.transform = "translate(0, 0)") : "translate-in-fade" !== W.animation.type && "translate-out-fade" !== W.animation.type || (t.item.style.visibility = "visible",
                            t.item.style.opacity = 1, t.item.style.transform = "translate(0, 0)"), window.setTimeout(function () {
                                t.visible = !0;
                            }, W.animation.speed);
    }, w = function (t) {
        "static" === W.animation.type ? t.item.style.display = "none" : "fade" === W.animation.type ? (t.item.style.visibility = "hidden",
            t.item.style.opacity = 0) : "zoom" === W.animation.type ? (t.item.style.visibility = "hidden",
                t.item.style.transform = "scale(0)") : "zoom-fade" === W.animation.type ? (t.item.style.visibility = "hidden",
                    t.item.style.opacity = 0, t.item.style.transform = "scale(0)") : "translate-in" === W.animation.type ? (t.item.style.visibility = "hidden",
                        "top" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out" === W.animation.type ? (t.item.style.visibility = "hidden",
                            "top" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))) : "translate-in-fade" === W.animation.type ? (t.item.style.opacity = 0,
                                t.item.style.visibility = "hidden", "top" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)"))) : "translate-out-fade" === W.animation.type && (t.item.style.opacity = 0,
                                    t.item.style.visibility = "hidden", "top" === W.direction ? t.item.style.transform = "translate(0, ".concat(W.animation.translateOffset, "px)") : "bottom" === W.direction ? t.item.style.transform = "translate(0, -".concat(W.animation.translateOffset, "px)") : "right" === W.direction ? t.item.style.transform = "translate(-".concat(W.animation.translateOffset, "px, 0)") : "left" === W.direction && (t.item.style.transform = "translate(".concat(W.animation.translateOffset, "px, 0)"))),
            window.setTimeout(function () {
                t.visible = !1;
            }, W.animation.speed);
    }, o = function (t, i, e) {
    ...
    (function t(i, e) {
        var a;
        for (var n in e) "object" !== _typeof(e[n]) || e[n] instanceof Date ? e[n] instanceof Date ? i[n] = new Date(e[n].getTime()) : i[n] = e[n] : (a = e[n] instanceof Array ? [] : {},
            void 0 === i[n] && (i[n] = a), t(i[n], e[n]));
    })(W, t), i(), e(), a(), n();
}
...
!function a(o, s, l) {
        ...
        i = this, r = function (i) {
            ...
            var e, d = {
                ...
                o.rgb.hsl = function (e) {
                    var t, n, i = e[0] / 255, r = e[1] / 255, a = e[2] / 255, o = Math.min(i, r, a), s = Math.max(i, r, a), l = s - o;
                    return s === o ? t = 0 : i === s ? t = (r - a) / l : r === s ? t = 2 + (a - i) / l : a === s && (t = 4 + (i - r) / l),
                        (t = Math.min(60 * t, 360)) < 0 && (t += 360), n = (o + s) / 2, [t, 100 * (s === o ? 0 : n <= .5 ? l / (s + o) : l / (2 - s - o)), 100 * n];
                }, o.rgb.hsv = function (e) {
                    function t(e) {
                        return (d - e) / 6 / u + .5;
                    }
                    var n, i, r, a, o, s = e[0] / 255, l = e[1] / 255, c = e[2] / 255, d = Math.max(s, l, c), u = d - Math.min(s, l, c);
                    return 0 == u ? a = o = 0 : (o = u / d, n = t(s), i = t(l), r = t(c), s === d ? a = r - i : l === d ? a = 1 / 3 + n - r : c === d && (a = 2 / 3 + i - n),
                        a < 0 ? a += 1 : 1 < a && (a -= 1)), [360 * a, 100 * o, 100 * d];
                    ...
                    for (var o in d) if (d.hasOwnProperty(o)) {
                        var s = d[o], l = (i = e, r = s, Math.pow(i[0] - r[0], 2) + Math.pow(i[1] - r[1], 2) + Math.pow(i[2] - r[2], 2));
                        l < a && (a = l, n = o);
                    }
                    return n;
                    ...
                    return i /= 100, r /= 108.883, n = .008856 < (n /= 95.047) ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116,
                        [116 * (i = .008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16, 500 * (n - i), 200 * (i - (r = .008856 < r ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116))];
                    ...
                    for (var c = 0; c < 3; c++) (i = o + 1 / 3 * -(c - 1)) < 0 && i++, 1 < i && i--,
                        a = 6 * i < 1 ? t + 6 * (n - t) * i : 2 * i < 1 ? n : 3 * i < 2 ? t + (n - t) * (2 / 3 - i) * 6 : t,
                        r[c] = 255 * a;
                    return r;
                    ...
                    var t = e[0] / 60, n = e[1] / 100, i = e[2] / 100, r = Math.floor(t) % 6, a = t - Math.floor(t), o = 255 * i * (1 - n), s = 255 * i * (1 - n * a), l = 255 * i * (1 - n * (1 - a));
                    switch (i *= 255, r) {
                        case 0:
                            return [i, l, o];
                    ...
                    switch (1 < u && (c /= u, d /= u), i = 6 * l - (t = Math.floor(6 * l)), 0 != (1 & t) && (i = 1 - i),
                    r = c + i * ((n = 1 - d) - c), t) {
                        default:
                        case 6:
                        case 0:
                    ...
                    return n = -.9689 * r + 1.8758 * a + .0415 * o, i = .0557 * r + -.204 * a + 1.057 * o,
                        t = .0031308 < (t = 3.2406 * r + -1.5372 * a + -.4986 * o) ? 1.055 * Math.pow(t, 1 / 2.4) - .055 : 12.92 * t,
                        n = .0031308 < n ? 1.055 * Math.pow(n, 1 / 2.4) - .055 : 12.92 * n, i = .0031308 < i ? 1.055 * Math.pow(i, 1 / 2.4) - .055 : 12.92 * i,
                        [255 * (t = Math.min(Math.max(0, t), 1)), 255 * (n = Math.min(Math.max(0, n), 1)), 255 * (i = Math.min(Math.max(0, i), 1))];
                }, o.xyz.lab = function (e) {
                    var t = e[0], n = e[1], i = e[2];
                    return n /= 100, i /= 108.883, t = .008856 < (t /= 95.047) ? Math.pow(t, 1 / 3) : 7.787 * t + 16 / 116,
                        [116 * (n = .008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (t - n), 200 * (n - (i = .008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116))];
                }, o.lab.xyz = function (e) {
                    var t, n, i, r = e[0];
                    t = e[1] / 500 + (n = (r + 16) / 116), i = n - e[2] / 200;
                    var a = Math.pow(n, 3), o = Math.pow(t, 3), s = Math.pow(i, 3);
                    return n = .008856 < a ? a : (n - 16 / 116) / 7.787, t = .008856 < o ? o : (t - 16 / 116) / 7.787,
                        i = .008856 < s ? s : (i - 16 / 116) / 7.787, [t *= 95.047, n *= 100, i *= 108.883];
                    ...
                    var t, n = e[0] / 255, i = e[1] / 255, r = e[2] / 255, a = Math.max(Math.max(n, i), r), o = Math.min(Math.min(n, i), r), s = a - o;
                    return t = s <= 0 ? 0 : a === n ? (i - r) / s % 6 : a === i ? 2 + (r - n) / s : 4 + (n - i) / s + 4,
                        t /= 6, [360 * (t %= 1), 100 * s, 100 * (s < 1 ? o / (1 - s) : 0)];
                    ...
                    return 0 < n && n < .5 ? i = t / (2 * n) : .5 <= n && n < 1 && (i = t / (2 * (1 - n))),
                        [e[0], 100 * i, 100 * n];
            ...
            c.rgb, c.hsl, c.hsv, c.hwb, c.cmyk, c.xyz, c.lab, c.lch, c.hex, c.keyword, c.ansi16,
                c.ansi256, c.hcg, c.apple, c.gray;
            function s(e) {
                var t = function () {
            ...
            function l(e, t) {
                for (var n = [t[e].parent, e], i = c[t[e].parent][e], r = t[e].parent; t[r].parent;) n.unshift(t[r].parent),
                    i = a(c[t[r].parent][r], i), r = t[r].parent;
            ...
            Object.keys(c).forEach(function (n) {
                ...
                Object.keys(i).forEach(function (e) {
                    ...
                    r[n][e] = function (r) {
                        ...
                        function e(e) {
                            return null == e ? e : (1 < arguments.length && (e = Array.prototype.slice.call(arguments)),
                                t(e));
                        }
            ...
            var u = r, o = {
                ...
                percentString: function (e, t) {
                    ...
                    var n = Math.round(e[0] / 255 * 100), i = Math.round(e[1] / 255 * 100), r = Math.round(e[2] / 255 * 100);
                    return "rgb(" + n + "%, " + i + "%, " + r + "%)";
                },
                percentaString: v,
            ...
            M.prototype = {
                ...
                mix: function (e, t) {
                    var n = this, i = e, r = void 0 === t ? .5 : t, a = 2 * r - 1, o = n.alpha() - i.alpha(), s = (1 + (a * o == -1 ? a : (a + o) / (1 + a * o))) / 2, l = 1 - s;
                ...
                if (this.valid = !0, "alpha" === e) s = t; else if (t.length) r[e] = t.slice(0, e.length),
                    s = t[e.length]; else if (void 0 !== t[e.charAt(0)]) {
            ...
            var w, _ = M, S = {
                ...
                each: function (e, t, n, i) {
                    var r, a, o;
                    if (S.isArray(e)) if (a = e.length, i) for (r = a - 1; 0 <= r; r--) t.call(n, e[r], r); else for (r = 0; r < a; r++) t.call(n, e[r], r); else if (S.isObject(e)) for (a = (o = Object.keys(e)).length,
                        r = 0; r < a; r++) t.call(n, e[o[r]], o[r]);
                },
                ...
                merge: function (e, t, n) {
                    ...
                    for (i = (n = n || {}).merger || S._merger, r = 0; r < c; ++r) if (t = l[r], S.isObject(t)) for (s = 0,
                        o = (a = Object.keys(t)).length; s < o; ++s) i(a[s], e, t, n);
                    return e;
                },
                ...
                inherits: function (e) {
                    ...
                    return t.prototype = n.prototype, i.prototype = new t(), i.extend = S.inherits,
                        e && S.extend(i.prototype, e), i.__super__ = n.prototype, i;
                },
            ...
            var k = {
                ...
                easeInElastic: function (e) {
                    ...
                    return 0 === e ? 0 : 1 === e ? 1 : (n = n || .3, t = i < 1 ? (i = 1, n / 4) : n / (2 * Math.PI) * Math.asin(1 / i),
                ...
                easeInOutElastic: function (e) {
                    var t = 1.70158, n = 0, i = 1;
                    return 0 === e ? 0 : 2 == (e /= .5) ? 1 : (n = n || .45, t = i < 1 ? (i = 1, n / 4) : n / (2 * Math.PI) * Math.asin(1 / i),
            ...
            var L = Math.PI, A = L / 180, E = 2 * L, O = L / 2, P = L / 4, D = 2 * L / 3, V = {
                ...
                roundedRect: function (e, t, n, i, r, a) {
                    if (a) {
                        ...
                        e.moveTo(t, l), s < c && l < d ? (e.arc(s, l, o, -L, -O), e.arc(c, l, o, -O, 0),
                            e.arc(c, d, o, 0, O), e.arc(s, d, o, O, L)) : s < c ? (e.moveTo(s, n), e.arc(c, l, o, -O, O),
                                e.arc(s, l, o, O, L + O)) : l < d ? (e.arc(s, l, o, -L, 0), e.arc(s, d, o, 0, L)) : e.arc(s, l, o, -L, L),
                            e.closePath(), e.moveTo(t, n);
                    } else e.rect(t, n, i, r);
                },
                drawPoint: function (e, t, n, i, r, a) {
                    var o, s, l, c, d, u = (a || 0) * A;
                    if (t && "object" == typeof t && ("[object HTMLImageElement]" === (o = t.toString()) || "[object HTMLCanvasElement]" === o)) return e.save(),
                        e.translate(i, r), e.rotate(u), e.drawImage(t, -t.width / 2, -t.height / 2, t.width, t.height),
                        void e.restore();
                    if (!(isNaN(n) || n <= 0)) {
                        switch (e.beginPath(), t) {
                            ...
                            case "triangle":
                                e.moveTo(i + Math.sin(u) * n, r - Math.cos(u) * n), u += D, e.lineTo(i + Math.sin(u) * n, r - Math.cos(u) * n),
                                    u += D, e.lineTo(i + Math.sin(u) * n, r - Math.cos(u) * n), e.closePath();
                                break;

                            case "rectRounded":
                                c = n - (d = .516 * n), s = Math.cos(u + P) * c, l = Math.sin(u + P) * c, e.arc(i - s, r - l, d, u - L, u - O),
                                    e.arc(i + l, r - s, d, u - O, u), e.arc(i + s, r + l, d, u, u + O), e.arc(i - l, r + s, d, u + O, u + L),
                                    e.closePath();
                                break;
                            ...
                            case "rectRot":
                                s = Math.cos(u) * n, l = Math.sin(u) * n, e.moveTo(i - s, r - l), e.lineTo(i + l, r - s),
                                    e.lineTo(i + s, r + l), e.lineTo(i - l, r + s), e.closePath();
                                break;
                            ...
                            case "cross":
                                s = Math.cos(u) * n, l = Math.sin(u) * n, e.moveTo(i - s, r - l), e.lineTo(i + s, r + l),
                                    e.moveTo(i + l, r - s), e.lineTo(i - l, r + s);
                                break;

                            case "star":
                                s = Math.cos(u) * n, l = Math.sin(u) * n, e.moveTo(i - s, r - l), e.lineTo(i + s, r + l),
                                    e.moveTo(i + l, r - s), e.lineTo(i - l, r + s), u += P, s = Math.cos(u) * n, l = Math.sin(u) * n,
                                    e.moveTo(i - s, r - l), e.lineTo(i + s, r + l), e.moveTo(i + l, r - s), e.lineTo(i - l, r + s);
                                break;
            ...
            var N = {
                ...
                toPadding: function (e) {
                    var t, n, i, r;
                    return C.isObject(e) ? (t = +e.top || 0, n = +e.right || 0, i = +e.bottom || 0,
                        r = +e.left || 0) : t = n = i = r = +e || 0, {
                        top: t,
                        right: n,
                        bottom: i,
                        left: r,
                ...
                resolve: function (e, t, n, i) {
                    var r, a, o, s = !0;
                    for (r = 0, a = e.length; r < a; ++r) if (void 0 !== (o = e[r]) && (void 0 !== t && "function" == typeof o && (o = o(t),
                        s = !1), void 0 !== n && C.isArray(o) && (o = o[n], s = !1), void 0 !== o)) return i && !s && (i.cacheable = !1),
                            o;
                }
            }, I = {
            ...
            var W = C, j = T, Y = R, G = N, U = F, q = {
                ...
                overrideTextDirection: function (e, t) {
                    var n, i;
                    "ltr" !== t && "rtl" !== t || (i = [(n = e.canvas.style).getPropertyValue("direction"), n.getPropertyPriority("direction")],
            ...
            W.extend(X.prototype, {
                ...
                transition: function (e) {
                    ...
                    return n && 1 !== e ? (r = r || (t._view = {}), function (e, t, n, i) {
                        ...
                        for (r = 0, a = f.length; r < a; ++r) if (c = n[o = f[r]], t.hasOwnProperty(o) || (t[o] = c),
                            (s = t[o]) !== c && "_" !== o[0]) {
                    ...
                    }(i = i || (t._start = {}), r, n, e)) : (t._view = W.extend({}, n), t._start = null),
                        t;
                },
            ...
            var J = {
                ...
                addAnimation: function (e, t, n, i) {
                    ...
                    for (t.chart = e, t.startTime = Date.now(), t.duration = n, i || (e.animating = !0),
                        r = 0, a = o.length; r < a; ++r) if (o[r].chart === e) return void (o[r] = t);
                ...
                advance: function () {
                    for (var e, t, n, i, r = this.animations, a = 0; a < r.length;) t = (e = r[a]).chart,
                        n = e.numSteps, i = Math.floor((Date.now() - e.startTime) / e.duration * n) + 1,
                        e.currentStep = Math.min(i, n), W.callback(e.render, [t, e], t), W.callback(e.onAnimationProgress, [e], t),
                        e.currentStep >= n ? (W.callback(e.onAnimationComplete, [e], t), t.animating = !1,
                            r.splice(a, 1)) : ++a;
                }
            ...
            W.extend(ne.prototype, {
                ...
                linkScales: function () {
                    ...
                    null !== e.xAxisID && e.xAxisID in n && !i.xAxisID || (e.xAxisID = i.xAxisID || r.xAxes[0].id),
                ...
                getStyle: function (e) {
                    ...
                    return this._configure(), !1 !== (t = i && void 0 === e ? this._resolveDatasetElementOptions(i || {}) : (e = e || 0,
                        this._resolveDataElementOptions(n.data[e] || {}, e))).fill && null !== t.fill || (t.backgroundColor = t.borderColor),
                        t;
                },
                _resolveDatasetElementOptions: function (e, t) {
                    var n, i, r, a, o = this, s = o.chart, l = o._config, c = e.custom || {}, d = s.options.elements[o.datasetElementType.prototype._type] || {}, u = o._datasetElementOptions, h = {}, f = {
                        chart: s,
                        dataset: o.getDataset(),
                        datasetIndex: o.index,
                        hover: t
                    };
                    for (n = 0, i = u.length; n < i; ++n) r = u[n], a = t ? "hover" + r.charAt(0).toUpperCase() + r.slice(1) : r,
                        h[r] = Q([c[a], l[a], d[a]], f);
                    return h;
                },
                _resolveDataElementOptions: function (e, t) {
                    ...
                    if (r && !i) return r;
                    var a, o, s, l, c = n.chart, d = n._config, u = c.options.elements[n.dataElementType.prototype._type] || {}, h = n._dataElementOptions, f = {}, g = {
                        chart: c,
                        dataIndex: t,
                    ...
                    if (i = i || {}, W.isArray(h)) for (o = 0, s = h.length; o < s; ++o) f[l = h[o]] = Q([i[l], d[l], u[l]], g, t, p); else for (o = 0,
                        s = (a = Object.keys(h)).length; o < s; ++o) f[l = a[o]] = Q([i[l], d[h[l]], d[l], u[l]], g, t, p);
                ...
                setHoverStyle: function (e) {
                    var t = this.chart.data.datasets[e._datasetIndex], n = e._index, i = e.custom || {}, r = e._model, a = W.getHoverColor;
                    e.$previousStyle = {
                ...
                _setDatasetHoverStyle: function () {
                    ...
                    if (o) {
                        for (a = o._model, r = this._resolveDatasetElementOptions(o, !0), e = 0, t = (i = Object.keys(r)).length; e < t; ++e) s[n = i[e]] = a[n],
                            a[n] = r[n];
                        o.$previousStyle = s;
                    }
                },
            ...
            function ae(e, t) {
                ...
                e.beginPath(), e.arc(o, s, t.outerRadius, n - a, i + a), t.innerRadius > r ? (a = r / t.innerRadius,
                    e.arc(o, s, t.innerRadius - r, i + a, n - a, !0)) : e.arc(o, s, r, i + Math.PI / 2, n - Math.PI / 2),
                    e.closePath(), e.clip();
            }
            function oe(e, t, n) {
                var i = "inner" === t.borderAlign;
                i ? (e.lineWidth = 2 * t.borderWidth, e.lineJoin = "round") : (e.lineWidth = t.borderWidth,
                    e.lineJoin = "bevel"), n.fullCircles && function (e, t, n, i) {
                        var r, a = n.endAngle;
                        for (i && (n.endAngle = n.startAngle + re, ae(e, n), n.endAngle = a, n.endAngle === n.startAngle && n.fullCircles && (n.endAngle += re,
                            n.fullCircles--)), e.beginPath(), e.arc(n.x, n.y, n.innerRadius, n.startAngle + re, n.startAngle, !0),
                            r = 0; r < n.fullCircles; ++r) e.stroke();
                        for (e.beginPath(), e.arc(n.x, n.y, t.outerRadius, n.startAngle, n.startAngle + re),
                            r = 0; r < n.fullCircles; ++r) e.stroke();
                    }(e, t, n, i), i && ae(e, n), e.beginPath(), e.arc(n.x, n.y, t.outerRadius, n.startAngle, n.endAngle),
                    e.arc(n.x, n.y, n.innerRadius, n.endAngle, n.startAngle, !0), e.closePath(), e.stroke();
            }
            B._set("global", {
                elements: {
                    arc: {
            ...
            var se = $.extend({
                ...
                tooltipPosition: function () {
                    var e = this._view, t = e.startAngle + (e.endAngle - e.startAngle) / 2, n = (e.outerRadius - e.innerRadius) / 2 + e.innerRadius;
                    return {
                        x: e.x + Math.cos(t) * n,
                        y: e.y + Math.sin(t) * n
                    };
                ...
                draw: function () {
                    ...
                    if (t.save(), t.fillStyle = n.backgroundColor, t.strokeStyle = n.borderColor, r.fullCircles) {
                        for (r.endAngle = r.startAngle + re, t.beginPath(), t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle),
                            t.arc(r.x, r.y, r.innerRadius, r.endAngle, r.startAngle, !0), t.closePath(), e = 0; e < r.fullCircles; ++e) t.fill();
                        r.endAngle = r.startAngle + n.circumference % re;
                    }
                    t.beginPath(), t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle), t.arc(r.x, r.y, r.innerRadius, r.endAngle, r.startAngle, !0),
                        t.closePath(), t.fill(), n.borderWidth && oe(t, n, r), t.restore();
                }
            ...
            var de = $.extend({
                _type: "line",
                draw: function () {
                    var e, t, n, i = this, r = i._view, a = i._chart.ctx, o = r.spanGaps, s = i._children.slice(), l = B.global, c = l.elements.line, d = -1, u = i._loop;
                    if (s.length) {
                        if (i._loop) {
                        ...
                        for (a.save(), a.lineCap = r.borderCapStyle || c.borderCapStyle, a.setLineDash && a.setLineDash(r.borderDash || c.borderDash),
                            a.lineDashOffset = le(r.borderDashOffset, c.borderDashOffset), a.lineJoin = r.borderJoinStyle || c.borderJoinStyle,
                            a.lineWidth = le(r.borderWidth, c.borderWidth), a.strokeStyle = r.borderColor || l.defaultColor,
                            a.beginPath(), (n = s[0]._view).skip || (a.moveTo(n.x, n.y), d = 0), e = 1; e < s.length; ++e) n = s[e]._view,
                                t = -1 === d ? W.previousItem(s, e) : s[d], n.skip || (d !== e - 1 && !o || -1 === d ? a.moveTo(n.x, n.y) : W.canvas.lineTo(a, t._view, n),
                                    d = e);
            ...
            var ge = $.extend({
                ...
                draw: function (e) {
                    var t = this._view, n = this._chart.ctx, i = t.pointStyle, r = t.rotation, a = t.radius, o = t.x, s = t.y, l = B.global, c = l.defaultColor;
                    t.skip || void 0 !== e && !W.canvas._isPointInArea(t, e) || (n.strokeStyle = t.borderColor || c,
                        n.lineWidth = ue(t.borderWidth, l.elements.point.borderWidth), n.fillStyle = t.backgroundColor || c,
                        W.canvas.drawPoint(n, i, a, o, s, r));
                }
            ...
            function me(e) {
                var t, n, i, r, a;
                return r = ve(e) ? (a = e.width / 2, t = e.x - a, n = e.x + a, i = Math.min(e.y, e.base),
                    Math.max(e.y, e.base)) : (a = e.height / 2, t = Math.min(e.x, e.base), n = Math.max(e.x, e.base),
                        i = e.y - a, e.y + a), {
                    left: t,
                    top: i,
                    right: n,
            ...
            function be(e, t, n) {
                var i, r, a, o, s = e.borderWidth, l = function (e) {
                    ...
                    return t && (e.horizontal ? e.base > e.x && (t = ye(t, "left", "right")) : e.base < e.y && (t = ye(t, "bottom", "top")),
                        n[t] = !0), n;
                }(e);
                return W.isObject(s) ? (i = +s.top || 0, r = +s.right || 0, a = +s.bottom || 0,
                    o = +s.left || 0) : i = r = a = o = +s || 0, {
            ...
            var Me = $.extend({
                ...
                draw: function () {
                    ...
                    e.fillStyle = t.backgroundColor, e.fillRect(i.x, i.y, i.w, i.h), i.w === r.w && i.h === r.h || (e.save(),
                        e.beginPath(), e.rect(i.x, i.y, i.w, i.h), e.clip(), e.fillStyle = t.borderColor,
                        e.rect(r.x, r.y, r.w, r.h), e.fill("evenodd"), e.restore());
                },
                height: function () {
                    var e = this._view;
                    return e.base - e.y;
            ...
            function Ae(e, t, n) {
                var i, r, a = n.barThickness, o = t.stackCount, s = t.pixels[e], l = W.isNullOrUndef(a) ? function (e, t) {
                    var n, i, r, a, o = e._length;
                    for (r = 1, a = t.length; r < a; ++r) o = Math.min(o, Math.abs(t[r] - t[r - 1]));
                    for (r = 0, a = e.getTicks().length; r < a; ++r) i = e.getPixelForTick(r), o = 0 < r ? Math.min(o, Math.abs(i - n)) : o,
                        n = i;
                    return o;
                }(t.scale, t.pixels) : -1;
                return r = W.isNullOrUndef(a) ? (i = l * n.categoryPercentage, n.barPercentage) : (i = a * o,
                    1), {
                    chunk: i / o,
                    ratio: r,
                    start: s - i / 2
            ...
            var Ee = ie.extend({
                ...
                initialize: function () {
                    var e, t, n = this;
                    ie.prototype.initialize.apply(n, arguments), (e = n.getMeta()).stack = n.getDataset().stack,
                        e.bar = !0, t = n._getIndexScale().options, Te("bar chart", t.barPercentage, "scales.[x/y]Axes.barPercentage", "dataset.barPercentage"),
                ...
                updateElement: function (e, t, n) {
                    ...
                    e._xScale = i.getScaleForId(r.xAxisID), e._yScale = i.getScaleForId(r.yAxisID),
                        e._datasetIndex = i.index, e._index = t, e._model = {
                        ...
                        }, W.isArray(a.data[t]) && (e._model.borderSkipped = null), i._updateElementGeometry(e, t, n, o),
                        e.pivot();
                },
                _updateElementGeometry: function (e, t, n, i) {
                    var r = this, a = e._model, o = r._getValueScale(), s = o.getBasePixel(), l = o.isHorizontal(), c = r._ruler || r.getRuler(), d = r.calculateBarValuePixels(r.index, t, i), u = r.calculateBarIndexPixels(r.index, t, c, i);
                    a.horizontal = l, a.base = n ? s : d.base, a.x = l ? n ? s : d.head : u.center,
                        a.y = l ? u.center : n ? s : d.head, a.height = l ? u.size : void 0, a.width = l ? void 0 : u.size;
                },
                _getStacks: function (e) {
                    var t, n, i = this._getIndexScale(), r = i._getMatchingVisibleMetas(this._type), a = i.options.stacked, o = r.length, s = [];
                    for (t = 0; t < o && (n = r[t], (!1 === a || -1 === s.indexOf(n.stack) || void 0 === a && void 0 === n.stack) && s.push(n.stack),
                        n.index !== e); ++t);
                    return s;
                },
                ...
                calculateBarValuePixels: function (e, t, n) {
                    ...
                    if (m || void 0 === m && void 0 !== y) for (i = 0; i < M && (r = g[i]).index !== e; ++i) r.stack === y && (a = void 0 === (c = u._parseValue(f[r.index].data[t])).start ? c.end : 0 <= c.min && 0 <= c.max ? c.max : c.min,
                        (p.min < 0 && a < 0 || 0 <= p.max && 0 < a) && (b += a));
                    return o = u.getPixelForValue(b), l = (s = u.getPixelForValue(b + x)) - o, void 0 !== v && Math.abs(l) < v && (l = v,
                        s = 0 <= x && !h || x < 0 && h ? o - v : o + v), {
                        size: l,
                        base: o,
                        head: s,
                        center: s + l / 2
                ...
                calculateBarIndexPixels: function (e, t, n, i) {
                    var r = "flex" === i.barThickness ? function (e, t, n) {
                        var i, r = t.pixels, a = r[e], o = 0 < e ? r[e - 1] : null, s = e < r.length - 1 ? r[e + 1] : null, l = n.categoryPercentage;
                        return null === o && (o = a - (null === s ? t.end - t.start : s - a)), null === s && (s = a + a - o),
                            i = a - (a - Math.min(o, s)) / 2 * l, {
                            chunk: Math.abs(s - o) / 2 * l / t.stackCount,
                            ratio: n.barPercentage,
                            start: i
                        };
                    }(t, n, i) : Ae(t, n, i), a = this.getStackIndex(e, this.getMeta().stack), o = r.start + r.chunk * a + r.chunk / 2, s = Math.min(Le(i.maxBarThickness, 1 / 0), r.chunk * r.ratio);
                    return {
                        base: o - s / 2,
                        head: o + s / 2,
                        center: o,
                ...
                draw: function () {
                    var e = this.chart, t = this._getValueScale(), n = this.getMeta().data, i = this.getDataset(), r = n.length, a = 0;
                ...
                _resolveDataElementOptions: function () {
                    var e = W.extend({}, ie.prototype._resolveDataElementOptions.apply(this, arguments)), t = this._getIndexScale().options, n = this._getValueScale().options;
                    return e.barPercentage = Le(t.barPercentage, e.barPercentage), e.barThickness = Le(t.barThickness, e.barThickness),
                        e.categoryPercentage = Le(t.categoryPercentage, e.categoryPercentage), e.maxBarThickness = Le(t.maxBarThickness, e.maxBarThickness),
                        e.minBarLength = Le(n.minBarLength, e.minBarLength), e;
                }
            ...
            var De = ie.extend({
                ...
                updateElement: function (e, t, n) {
                    var i = this, r = i.getMeta(), a = e.custom || {}, o = i.getScaleForId(r.xAxisID), s = i.getScaleForId(r.yAxisID), l = i._resolveDataElementOptions(e, t), c = i.getDataset().data[t], d = i.index, u = n ? o.getPixelForDecimal(.5) : o.getPixelForValue("object" == typeof c ? c : NaN, t, d), h = n ? s.getBasePixel() : s.getPixelForValue(c, t, d);
                    e._xScale = o, e._yScale = s, e._options = l, e._datasetIndex = d, e._index = t,
                        e._model = {
                ...
                setHoverStyle: function (e) {
                    ...
                    e.$previousStyle = {
                        ...
                        radius: t.radius
                    }, t.backgroundColor = Oe(n.hoverBackgroundColor, i(n.backgroundColor)), t.borderColor = Oe(n.hoverBorderColor, i(n.borderColor)),
                        t.borderWidth = Oe(n.hoverBorderWidth, n.borderWidth), t.radius = n.radius + n.hoverRadius;
                },
                _resolveDataElementOptions: function (e, t) {
                    var n = this, i = n.chart, r = n.getDataset(), a = e.custom || {}, o = r.data[t] || {}, s = ie.prototype._resolveDataElementOptions.apply(n, arguments), l = {
                        chart: i,
                        dataIndex: t,
                        dataset: r,
                        datasetIndex: n.index
                    };
                    return n._cachedDataOpts === s && (s = W.extend({}, s)), s.radius = Pe([a.radius, o.r, n._config.radius, i.options.elements.point.radius], l, t),
                        s;
                }
            ...
            B._set("doughnut", {
                ...
                legendCallback: function (e) {
                    ...
                    if (r.setAttribute("class", e.id + "-legend"), o.length) for (n = o[t = 0].data.length; t < n; ++t) (i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = o[0].backgroundColor[t],
                        s[t] && i.appendChild(document.createTextNode(s[t]));
                    return r.outerHTML;
                },
                legend: {
                    labels: {
            ...
            var He = ie.extend({
                ...
                update: function (e) {
                    var t, n, i, r, a = this, o = a.chart, s = o.chartArea, l = o.options, c = 1, d = 1, u = 0, h = 0, f = a.getMeta(), g = f.data, p = l.cutoutPercentage / 100 || 0, v = l.circumference, m = a._getRingWeight(a.index);
                    if (v < ze) {
                        var y = l.rotation % ze, b = (y += Re <= y ? -ze : y < -Re ? ze : 0) + v, x = Math.cos(y), M = Math.sin(y), w = Math.cos(b), _ = Math.sin(b), S = y <= 0 && 0 <= b || ze <= b, C = y <= Be && Be <= b || ze + Be <= b, k = y <= -Be && -Be <= b || Re + Be <= b, T = y === -Re || Re <= b ? -1 : Math.min(x, x * p, w, w * p), L = k ? -1 : Math.min(M, M * p, _, _ * p), A = S ? 1 : Math.max(x, x * p, w, w * p), E = C ? 1 : Math.max(M, M * p, _, _ * p);
                        c = (A - T) / 2, d = (E - L) / 2, u = -(A + T) / 2, h = -(E + L) / 2;
                    }
                    for (i = 0, r = g.length; i < r; ++i) g[i]._options = a._resolveDataElementOptions(g[i], i);
                    for (o.borderWidth = a.getMaxBorderWidth(), t = (s.right - s.left - o.borderWidth) / c,
                        n = (s.bottom - s.top - o.borderWidth) / d, o.outerRadius = Math.max(Math.min(t, n) / 2, 0),
                        o.innerRadius = Math.max(o.outerRadius * p, 0), o.radiusLength = (o.outerRadius - o.innerRadius) / (a._getVisibleDatasetWeightTotal() || 1),
                        o.offsetX = u * o.outerRadius, o.offsetY = h * o.outerRadius, f.total = a.calculateTotal(),
                        a.outerRadius = o.outerRadius - o.radiusLength * a._getRingWeightOffset(a.index),
                        a.innerRadius = Math.max(a.outerRadius - o.radiusLength * m, 0), i = 0, r = g.length; i < r; ++i) a.updateElement(g[i], i, e);
                },
                updateElement: function (e, t, n) {
                    var i = this, r = i.chart, a = r.chartArea, o = r.options, s = o.animation, l = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2, d = o.rotation, u = o.rotation, h = i.getDataset(), f = n && s.animateRotate ? 0 : e.hidden ? 0 : i.calculateCircumference(h.data[t]) * (o.circumference / ze), g = n && s.animateScale ? 0 : i.innerRadius, p = n && s.animateScale ? 0 : i.outerRadius, v = e._options || {};
                    W.extend(e, {
                    ...
                    var m = e._model;
                    n && s.animateRotate || (m.startAngle = 0 === t ? o.rotation : i.getMeta().data[t - 1]._model.endAngle,
                        m.endAngle = m.startAngle + m.circumference), e.pivot();
                },
                ...
                getMaxBorderWidth: function (e) {
                    ...
                    if (!e) return 0;
                    for (t = 0, n = e.length; t < n; ++t) r = e[t], "inner" !== (o = a ? (a._configure(),
                        a._resolveDataElementOptions(r, t)) : r._options).borderAlign && (c = (c = c < (s = o.borderWidth) ? s : c) < (l = o.hoverBorderWidth) ? l : c);
                    return c;
                },
                setHoverStyle: function (e) {
                    var t = e._model, n = e._options, i = W.getHoverColor;
                    e.$previousStyle = {
                        ...
                        borderColor: t.borderColor,
                        borderWidth: t.borderWidth
                    }, t.backgroundColor = Ve(n.hoverBackgroundColor, i(n.backgroundColor)), t.borderColor = Ve(n.hoverBorderColor, i(n.borderColor)),
            ...
            function je(e, t) {
                var n = e && e.options.ticks || {}, i = n.reverse, r = void 0 === n.min ? t : 0, a = void 0 === n.max ? t : 0;
                return {
                    start: i ? a : r,
                    end: i ? r : a
                };
            ...
            var Ye = ie.extend({
                ...
                update: function (e) {
                    var t, n, i = this, r = i.getMeta(), a = r.dataset, o = r.data || [], s = i.chart.options, l = i._config, c = i._showLine = Ie(l.showLine, s.showLines);
                    for (i._xScale = i.getScaleForId(r.xAxisID), i._yScale = i.getScaleForId(r.yAxisID),
                        c && (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension),
                            a._scale = i._yScale, a._datasetIndex = i.index, a._children = o, a._model = i._resolveDatasetElementOptions(a),
                            a.pivot()), t = 0, n = o.length; t < n; ++t) i.updateElement(o[t], t, e);
                    for (c && 0 !== a._model.tension && i.updateBezierControlPoints(), t = 0, n = o.length; t < n; ++t) o[t].pivot();
                },
                updateElement: function (e, t, n) {
                    var i, r, a = this, o = a.getMeta(), s = e.custom || {}, l = a.getDataset(), c = a.index, d = l.data[t], u = a._xScale, h = a._yScale, f = o.dataset._model, g = a._resolveDataElementOptions(e, t);
                    i = u.getPixelForValue("object" == typeof d ? d : NaN, t, c), r = n ? h.getBasePixel() : a.calculatePointY(d, t, c),
                        e._xScale = u, e._yScale = h, e._options = g, e._datasetIndex = c, e._index = t,
                        e._model = {
                            x: i,
                            y: r,
                ...
                _resolveDatasetElementOptions: function (e) {
                    var t = this, n = t._config, i = e.custom || {}, r = t.chart.options, a = r.elements.line, o = ie.prototype._resolveDatasetElementOptions.apply(t, arguments);
                    return o.spanGaps = Ie(n.spanGaps, r.spanGaps), o.tension = Ie(n.lineTension, a.tension),
                        o.steppedLine = Fe([i.steppedLine, n.steppedLine, a.stepped]), o.clip = function (e) {
                            var t, n, i, r;
                ...
                calculatePointY: function (e, t, n) {
                    ...
                    if (u.options.stacked) {
                        for (s = +u.getRightValue(e), c = (l = d._getSortedVisibleDatasetMetas()).length,
                            i = 0; i < c && (a = l[i]).index !== n; ++i) r = d.data.datasets[a.index], "line" === a.type && a.yAxisID === u.id && ((o = +u.getRightValue(r.data[t])) < 0 ? f += o || 0 : h += o || 0);
                        return s < 0 ? u.getPixelForValue(f + s) : u.getPixelForValue(h + s);
                    }
                    return u.getPixelForValue(e);
                },
                updateBezierControlPoints: function () {
                    var e, t, n, i, r = this.chart, a = this.getMeta(), o = a.dataset._model, s = r.chartArea, l = a.data || [];
                    function c(e, t, n) {
                        return Math.max(Math.min(e, n), t);
                    }
                    if (o.spanGaps && (l = l.filter(function (e) {
                        return !e._model.skip;
                    })), "monotone" === o.cubicInterpolationMode) W.splineCurveMonotone(l); else for (e = 0,
                        t = l.length; e < t; ++e) n = l[e]._model, i = W.splineCurve(W.previousItem(l, e)._model, n, W.nextItem(l, e)._model, o.tension),
                    ...
                    if (r.options.elements.line.capBezierPoints) for (e = 0, t = l.length; e < t; ++e) n = l[e]._model,
                        We(n, s) && (0 < e && We(l[e - 1]._model, s) && (n.controlPointPreviousX = c(n.controlPointPreviousX, s.left, s.right),
                            n.controlPointPreviousY = c(n.controlPointPreviousY, s.top, s.bottom)), e < l.length - 1 && We(l[e + 1]._model, s) && (n.controlPointNextX = c(n.controlPointNextX, s.left, s.right),
                                n.controlPointNextY = c(n.controlPointNextY, s.top, s.bottom)));
                },
                draw: function () {
                    var e, t = this.chart, n = this.getMeta(), i = n.data || [], r = t.chartArea, a = t.canvas, o = 0, s = i.length;
                ...
                setHoverStyle: function (e) {
                    ...
                    e.$previousStyle = {
                        ...
                        borderWidth: t.borderWidth,
                        radius: t.radius
                    }, t.backgroundColor = Ie(n.hoverBackgroundColor, i(n.backgroundColor)), t.borderColor = Ie(n.hoverBorderColor, i(n.borderColor)),
                        t.borderWidth = Ie(n.hoverBorderWidth, n.borderWidth), t.radius = Ie(n.hoverRadius, n.radius);
                }
            ...
            var Ue = ie.extend({
                ...
                update: function (e) {
                    var t, n, i, r = this, a = r.getDataset(), o = r.getMeta(), s = r.chart.options.startAngle || 0, l = r._starts = [], c = r._angles = [], d = o.data;
                    for (r._updateRadius(), o.count = r.countVisibleElements(), t = 0, n = a.data.length; t < n; t++) l[t] = s,
                        i = r._computeAngle(t), s += c[t] = i;
                    for (t = 0, n = d.length; t < n; ++t) d[t]._options = r._resolveDataElementOptions(d[t], t),
                        r.updateElement(d[t], t, e);
                },
                _updateRadius: function () {
                    var e = this, t = e.chart, n = t.chartArea, i = t.options, r = Math.min(n.right - n.left, n.bottom - n.top);
                    t.outerRadius = Math.max(r / 2, 0), t.innerRadius = Math.max(i.cutoutPercentage ? t.outerRadius / 100 * i.cutoutPercentage : 1, 0),
                        t.radiusLength = (t.outerRadius - t.innerRadius) / t.getVisibleDatasetCount(), e.outerRadius = t.outerRadius - t.radiusLength * e.index,
                        e.innerRadius = e.outerRadius - t.radiusLength;
                },
                updateElement: function (e, t, n) {
                    var i = this, r = i.chart, a = i.getDataset(), o = r.options, s = o.animation, l = r.scale, c = r.data.labels, d = l.xCenter, u = l.yCenter, h = o.startAngle, f = e.hidden ? 0 : l.getDistanceFromCenterForValue(a.data[t]), g = i._starts[t], p = g + (e.hidden ? 0 : i._angles[t]), v = s.animateScale ? 0 : l.getDistanceFromCenterForValue(a.data[t]), m = e._options || {};
                    W.extend(e, {
                        _datasetIndex: i.index,
                        _index: t,
                        _scale: l,
                ...
                setHoverStyle: function (e) {
                    ...
                    e.$previousStyle = {
                        ...
                        borderColor: t.borderColor,
                        borderWidth: t.borderWidth
                    }, t.backgroundColor = r(n.hoverBackgroundColor, i(n.backgroundColor)), t.borderColor = r(n.hoverBorderColor, i(n.borderColor)),
            ...
            var $e = ie.extend({
                ...
                update: function (e) {
                    var t, n, i = this, r = i.getMeta(), a = r.dataset, o = r.data || [], s = i.chart.scale, l = i._config;
                    for (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension),
                        a._scale = s, a._datasetIndex = i.index, a._children = o, a._loop = !0, a._model = i._resolveDatasetElementOptions(a),
                        a.pivot(), t = 0, n = o.length; t < n; ++t) i.updateElement(o[t], t, e);
                    for (i.updateBezierControlPoints(), t = 0, n = o.length; t < n; ++t) o[t].pivot();
                },
                updateElement: function (e, t, n) {
                    var i = this, r = e.custom || {}, a = i.getDataset(), o = i.chart.scale, s = o.getPointPositionForValue(t, a.data[t]), l = i._resolveDataElementOptions(e, t), c = i.getMeta().dataset._model, d = n ? o.xCenter : s.x, u = n ? o.yCenter : s.y;
                ...
                _resolveDatasetElementOptions: function () {
                    var e = this._config, t = this.chart.options, n = ie.prototype._resolveDatasetElementOptions.apply(this, arguments);
                    return n.spanGaps = Xe(e.spanGaps, t.spanGaps), n.tension = Xe(e.lineTension, t.elements.line.tension),
                        n;
                },
                updateBezierControlPoints: function () {
                    ...
                    for (r.dataset._model.spanGaps && (o = o.filter(function (e) {
                        return !e._model.skip;
                    })), e = 0, t = o.length; e < t; ++e) n = o[e]._model, i = W.splineCurve(W.previousItem(o, e, !0)._model, n, W.nextItem(o, e, !0)._model, n.tension),
                        n.controlPointPreviousX = s(i.previous.x, a.left, a.right), n.controlPointPreviousY = s(i.previous.y, a.top, a.bottom),
                        n.controlPointNextX = s(i.next.x, a.left, a.right), n.controlPointNextY = s(i.next.y, a.top, a.bottom);
                },
                setHoverStyle: function (e) {
                    var t = e._model, n = e._options, i = W.getHoverColor;
                    e.$previousStyle = {
                        ...
                        borderWidth: t.borderWidth,
                        radius: t.radius
                    }, t.backgroundColor = Xe(n.hoverBackgroundColor, i(n.backgroundColor)), t.borderColor = Xe(n.hoverBorderColor, i(n.borderColor)),
                        t.borderWidth = Xe(n.hoverBorderWidth, n.borderWidth), t.radius = Xe(n.hoverRadius, n.radius);
                }
            });
            B._set("scatter", {
                hover: {
            ...
            function lt(e, t, n) {
                ...
                if (n.size && (e[n.pos] -= n.size), n.size = n.horizontal ? a.height : a.width,
                    e[n.pos] += n.size, a.getPadding) {
                    var s = a.getPadding();
                    o.top = Math.max(o.top, s.top), o.left = Math.max(o.left, s.left), o.bottom = Math.max(o.bottom, s.bottom),
                        o.right = Math.max(o.right, s.right);
                }
                if (i = t.outerWidth - st(o, e, "left", "right"), r = t.outerHeight - st(o, e, "top", "bottom"),
                    i !== e.w || r !== e.h) return e.w = i, e.h = r, n.horizontal ? i !== e.w : r !== e.h;
            }
            function ct(e, n) {
                var i = n.maxPadding;
                function t(e) {
            ...
            function dt(e, t, n) {
                var i, r, a, o, s, l, c = [];
                for (i = 0, r = e.length; i < r; ++i) (o = (a = e[i]).box).update(a.width || t.w, a.height || t.h, ct(a.horizontal, t)),
                    lt(t, n, a) && (l = !0, c.length && (s = !0)), o.fullWidth || c.push(a);
                return s && dt(c, t, n) || l;
            }
            function ut(e, t, n) {
                var i, r, a, o, s = n.padding, l = t.x, c = t.y;
                for (i = 0, r = e.length; i < r; ++i) o = (a = e[i]).box, a.horizontal ? (o.left = o.fullWidth ? s.left : t.left,
                    o.right = o.fullWidth ? n.outerWidth - s.right : t.left + t.w, o.top = c, o.bottom = c + o.height,
                    o.width = o.right - o.left, c = o.bottom) : (o.left = l, o.right = l + o.width,
                        o.top = t.top, o.bottom = t.top + t.h, o.height = o.bottom - o.top, l = o.right);
                t.x = l, t.y = c;
            }
            B._set("global", {
                layout: {
            ...
            var ht, ft = {
                ...
                addBox: function (e, t) {
                    e.boxes || (e.boxes = []), t.fullWidth = t.fullWidth || !1, t.position = t.position || "top",
                        t.weight = t.weight || 0, t._layers = t._layers || function () {
                            return [{
                                z: 0,
                                draw: function () {
                ...
                configure: function (e, t, n) {
                    for (var i, r = ["fullWidth", "position", "weight"], a = r.length, o = 0; o < a; ++o) i = r[o],
                        n.hasOwnProperty(i) && (t[i] = n[i]);
                },
                update: function (n, e, t) {
                    if (n) {
                        var i = n.options.layout || {}, r = W.options.toPadding(i.padding), a = e - r.width, o = t - r.height, s = function (e) {
                            var t = function (e) {
                                var t, n, i, r = [];
                                ...
                                return r;
                            }(e), n = ot(at(t, "left"), !0), i = ot(at(t, "right")), r = ot(at(t, "top"), !0), a = ot(at(t, "bottom"));
                            return {
                        ...
                        !function (e, t) {
                            var n, i, r;
                            for (n = 0, i = e.length; n < i; ++n) (r = e[n]).width = r.horizontal ? r.box.fullWidth && t.availableWidth : t.vBoxMaxWidth,
                        ...
                        }(u), ut(s.leftAndTop, u, d), u.x += u.w, u.y += u.h, ut(s.rightAndBottom, u, d),
                            n.chartArea = {
                                left: u.left,
                                top: u.top,
                                right: u.left + u.w,
            ...
            })) && ht.default || ht, pt = "$chartjs", vt = "chartjs-", mt = vt + "size-monitor", yt = vt + "render-monitor", bt = vt + "render-animation", xt = ["animationstart", "webkitAnimationStart"], Mt = {
            ...
            function Lt(n, i, r) {
                var a = n[pt] || (n[pt] = {}), t = a.resizer = function (e) {
                    ...
                    return n.appendChild(Tt()), i.appendChild(Tt()), t.appendChild(n), t.appendChild(i),
                        t._reset = function () {
            ...
            var Dt = {
                ...
                notify: function (e, t, n) {
                    ...
                    for (i = 0; i < c; ++i) if ("function" == typeof (s = (a = (r = l[i]).plugin)[t]) && ((o = [e].concat(n || [])).push(r.options),
                ...
                addScalesToLayout: function (t) {
                    W.each(t.scales, function (e) {
                        e.fullWidth = e.options.fullWidth, e.position = e.options.position, e.weight = e.options.weight,
                            ft.addBox(t, e);
                    });
                }
                ...
                tooltips: {
                    ...
                    callbacks: {
                        ...
                        label: function (e, t) {
                            ...
                            return n && (n += ": "), W.isNullOrUndef(e.value) ? n += e.yLabel : n += e.value,
                                n;
                        },
            ...
            var jt = $.extend({
                ...
                getTitle: function () {
                    var e = this._options.callbacks, t = e.beforeTitle.apply(this, arguments), n = e.title.apply(this, arguments), i = e.afterTitle.apply(this, arguments), r = [];
                ...
                getBody: function (e, n) {
                    ...
                    return W.each(e, function (e) {
                        ...
                        Ht(t.before, Nt(r.beforeLabel.call(i, e, n))), Ht(t.lines, r.label.call(i, e, n)),
                            Ht(t.after, Nt(r.afterLabel.call(i, e, n))), a.push(t);
                    }), a;
                },
                ...
                getFooter: function () {
                    var e = this._options.callbacks, t = e.beforeFooter.apply(this, arguments), n = e.footer.apply(this, arguments), i = e.afterFooter.apply(this, arguments), r = [];
                    return r = Ht(r = Ht(r = Ht(r, Nt(t)), Nt(n)), Nt(i));
                },
                update: function (e) {
                    var t, n, i, r, a, o, s, l, c, d, u = this, h = u._options, f = u._model, g = u._model = It(h), p = u._active, v = u._data, m = {
                        xAlign: f.xAlign,
                        yAlign: f.yAlign
                    }, y = {
                        x: f.x,
                    ...
                    if (p.length) {
                        ...
                        var _ = [];
                        for (t = 0, n = p.length; t < n; ++t) _.push((i = p[t], d = c = l = a = r = void 0,
                            r = i._xScale, a = i._yScale || i._scale, o = i._index, s = i._datasetIndex, l = i._chart.getDatasetMeta(s).controller,
                            c = l._getIndexScale(), d = l._getValueScale(), {
                        ...
                        }), g.title = u.getTitle(_, v), g.beforeBody = u.getBeforeBody(_, v), g.body = u.getBody(_, v),
                            g.afterBody = u.getAfterBody(_, v), g.footer = u.getFooter(_, v), g.x = x.x, g.y = x.y,
                            g.caretPadding = h.caretPadding, g.labelColors = M, g.labelTextColors = w, g.dataPoints = _,
                            y = function (e, t, n, i) {
                                var r = e.x, a = e.y, o = e.caretSize, s = e.caretPadding, l = e.cornerRadius, c = n.xAlign, d = n.yAlign, u = o + s, h = l + s;
                                return "right" === c ? r -= t.width : "center" === c && ((r -= t.width / 2) + t.width > i.width && (r = i.width - t.width),
                                    r < 0 && (r = 0)), "top" === d ? a += u : a -= "bottom" === d ? t.height + u : t.height / 2,
                                ...
                                var s = t.title.length, l = t.footer.length, c = t.titleFontSize, d = t.bodyFontSize, u = t.footerFontSize;
                                function h(e) {
                                    r = Math.max(r, n.measureText(e).width + f);
                                }
                                i += s * c, i += s ? (s - 1) * t.titleSpacing : 0, i += s ? t.titleMarginBottom : 0,
                                    i += o * d, i += o ? (o - 1) * t.bodySpacing : 0, i += l ? t.footerMarginTop : 0,
                                    i += l * u, i += l ? (l - 1) * t.footerSpacing : 0;
                                var f = 0;
                                return n.font = W.fontString(c, t._titleFontStyle, t._titleFontFamily), W.each(t.title, h),
                                    n.font = W.fontString(d, t._bodyFontStyle, t._bodyFontFamily), W.each(t.beforeBody.concat(t.afterBody), h),
                                    f = t.displayColors ? d + 2 : 0, W.each(a, function (e) {
                                ...
                                var n, i, r, a, o, s = e._model, l = e._chart, c = e._chart.chartArea, d = "center", u = "center";
                                ...
                                }, n(s.x) ? (d = "left", r(s.x) && (d = "center", u = o(s.y))) : i(s.x) && (d = "right",
                                    a(s.x) && (d = "center", u = o(s.y)));
                                var g = e._options;
                                return {
                    ...
                    return g.xAlign = m.xAlign, g.yAlign = m.yAlign, g.x = y.x, g.y = y.y, g.width = b.width,
                        g.height = b.height, g.caretX = x.x, g.caretY = x.y, u._model = g, e && h.custom && h.custom.call(u, g),
                        u;
                },
                ...
                getCaretPosition: function (e, t, n) {
                    var i, r, a, o, s, l, c = n.caretSize, d = n.cornerRadius, u = n.xAlign, h = n.yAlign, f = e.x, g = e.y, p = t.width, v = t.height;
                    if ("center" === h) s = g + v / 2, l = "left" === u ? (r = (i = f) - c, a = i, o = s + c,
                        s - c) : (r = (i = f + p) + c, a = i, o = s - c, s + c); else if (a = (i = "left" === u ? (r = f + d + c) - c : "right" === u ? (r = f + p - d - c) - c : (r = n.caretX) - c,
                            r + c), "top" === h) s = (o = g) - c, l = o; else {
                        s = (o = g + v) + c, l = o;
                        var m = a;
                        a = i, i = m;
                    }
                ...
                drawTitle: function (e, t, n) {
                    ...
                    if (s) {
                        ...
                        for (e.x = Ft(t, t._titleAlign), n.textAlign = l.textAlign(t._titleAlign), n.textBaseline = "middle",
                            i = t.titleFontSize, r = t.titleSpacing, n.fillStyle = t.titleFontColor, n.font = W.fontString(i, t._titleFontStyle, t._titleFontFamily),
                            a = 0; a < s; ++a) n.fillText(o[a], l.x(e.x), e.y + i / 2), e.y += i + r, a + 1 === s && (e.y += t.titleMarginBottom - r);
                    }
                },
                drawBody: function (t, e, n) {
                    ...
                    var r, a, o, s, l, c, d, u, h = e.bodyFontSize, f = e.bodySpacing, g = e._bodyAlign, p = e.body, v = e.displayColors, m = 0, y = v ? Ft(e, "left") : 0, b = zt(e.rtl, e.x, e.width), x = b.textAlign(g);
                    for (n.textAlign = g, n.textBaseline = "middle", n.font = W.fontString(h, e._bodyFontStyle, e._bodyFontFamily),
                        t.x = Ft(e, x), n.fillStyle = e.bodyFontColor, W.each(e.beforeBody, i), m = v && "right" !== x ? "center" === g ? h / 2 + 1 : h + 2 : 0,
                        l = 0, d = p.length; l < d; ++l) {
                        for (r = p[l], a = e.labelTextColors[l], o = e.labelColors[l], n.fillStyle = a,
                            W.each(r.before, i), c = 0, u = (s = r.lines).length; c < u; ++c) {
                            if (v) {
                                var M = b.x(y);
                                n.fillStyle = e.legendColorBackground, n.fillRect(b.leftForLtr(M, h), t.y, h, h),
                                    n.lineWidth = 1, n.strokeStyle = o.borderColor, n.strokeRect(b.leftForLtr(M, h), t.y, h, h),
                                    n.fillStyle = o.backgroundColor, n.fillRect(b.leftForLtr(b.xPlus(M, 1), h - 2), t.y + 1, h - 2, h - 2),
                                    n.fillStyle = a;
                            }
                            i(s[c]);
                        }
                ...
                drawFooter: function (e, t, n) {
                    ...
                    if (o) {
                        ...
                        for (e.x = Ft(t, t._footerAlign), e.y += t.footerMarginTop, n.textAlign = s.textAlign(t._footerAlign),
                            n.textBaseline = "middle", i = t.footerFontSize, n.fillStyle = t.footerFontColor,
                            n.font = W.fontString(i, t._footerFontStyle, t._footerFontFamily), r = 0; r < o; ++r) n.fillText(a[r], s.x(e.x), e.y + i / 2),
                ...
                drawBackground: function (e, t, n, i) {
                    ...
                    n.beginPath(), n.moveTo(o + d, s), "top" === a && this.drawCaret(e, i), n.lineTo(o + l - d, s),
                        n.quadraticCurveTo(o + l, s, o + l, s + d), "center" === a && "right" === r && this.drawCaret(e, i),
                        n.lineTo(o + l, s + c - d), n.quadraticCurveTo(o + l, s + c, o + l - d, s + c),
                        "bottom" === a && this.drawCaret(e, i), n.lineTo(o + d, s + c), n.quadraticCurveTo(o, s + c, o, s + c - d),
                        "center" === a && "left" === r && this.drawCaret(e, i), n.lineTo(o, s + d), n.quadraticCurveTo(o, s, o + d, s),
                        n.closePath(), n.fill(), 0 < t.borderWidth && n.stroke();
                },
                draw: function () {
                    ...
                    if (0 !== t.opacity) {
                        var n = {
                            ...
                            x: t.x,
                            y: t.y
                        }, r = Math.abs(t.opacity < .001) ? 0 : t.opacity, a = t.title.length || t.beforeBody.length || t.body.length || t.afterBody.length || t.footer.length;
                        this._options.enabled && a && (e.save(), e.globalAlpha = r, this.drawBackground(i, t, e, n),
                            i.y += t.yPadding, W.rtl.overrideTextDirection(e, t.textDirection), this.drawTitle(i, t, e),
                            this.drawBody(i, t, e), this.drawFooter(i, t, e), W.rtl.restoreTextDirection(e, t.textDirection),
                            e.restore());
                    }
                },
                handleEvent: function (e) {
                    var t, n = this, i = n._options;
                    return n._lastActive = n._lastActive || [], "mouseout" === e.type ? n._active = [] : (n._active = n._chart.getElementsAtEventForMode(e, i.mode, i),
                        i.reverse && n._active.reverse()), (t = !W.arrayEquals(n._active, n._lastActive)) && (n._lastActive = n._active,
                ...
                return W.merge({}, [].slice.call(arguments), {
                    merger: function (e, t, n, i) {
                        if ("xAxes" === e || "yAxes" === e) {
                            ...
                            for (t[e] || (t[e] = []), r = 0; r < s; ++r) o = n[e][r], a = Ut(o.type, "xAxes" === e ? "category" : "linear"),
                                r >= t[e].length && t[e].push({}), !t[e][r].type || o.type && o.type !== t[e][r].type ? W.merge(t[e][r], [Vt.getScaleDefaults(a), o]) : W.merge(t[e][r], o);
            ...
            W.extend(Jt.prototype, {
                construct: function (e, t) {
                    ...
                    t = function (e) {
                        ...
                        return t.datasets = t.datasets || [], t.labels = t.labels || [], e.options = Xt(B.global, B[e.type], e.options || {}),
                            e;
                    }(t);
                    var i = Pt.acquireContext(e, t), r = i && i.canvas, a = r && r.height, o = r && r.width;
                    n.id = W.uid(), n.ctx = i, n.canvas = r, n.config = t, n.width = o, n.height = a,
                        n.aspectRatio = a ? o / a : null, n.options = t.options, n._bufferedRender = !1,
                        n._layers = [], (n.chart = n).controller = n, Jt.instances[n.id] = n, Object.defineProperty(n, "data", {
                            get: function () {
                ...
                initialize: function () {
                    var e = this;
                    return Dt.notify(e, "beforeInit"), W.retinaScale(e, e.options.devicePixelRatio),
                ...
                resize: function (e) {
                    var t = this, n = t.options, i = t.canvas, r = n.maintainAspectRatio && t.aspectRatio || null, a = Math.max(0, Math.floor(W.getMaximumWidth(i))), o = Math.max(0, Math.floor(r ? a / r : W.getMaximumHeight(i)));
                    if ((t.width !== a || t.height !== o) && (i.width = t.width = a, i.height = t.height = o,
                        i.style.width = a + "px", i.style.height = o + "px", W.retinaScale(t, n.devicePixelRatio),
                        !e)) {
                        var s = {
                            width: a,
                            height: o
                ...
                buildOrUpdateControllers: function () {
                    ...
                    for (e = 0, t = r.length; e < t; e++) {
                        ...
                        if (o.type && o.type !== s && (n.destroyDatasetMeta(e), o = n.getDatasetMeta(e)),
                            o.type = s, o.order = a.order || 0, o.index = e, o.controller) o.controller.updateIndex(e),
                                o.controller.linkScales(); else {
                            var l = Ze[o.type];
                ...
                update: function (e) {
                    ...
                    if (e && "object" == typeof e || (e = {
                        ...
                        W.each(t.scales, function (e) {
                            ft.removeBox(t, e);
                        }), e = Xt(B.global, B[t.config.type], e), t.options = t.config.options = e, t.ensureScalesHaveIDs(),
                            t.buildOrUpdateScales(), t.tooltip._options = e.tooltips, t.tooltip.initialize();
                        ...
                        i.updateLayout(), i.options.animation && i.options.animation.duration && W.each(r, function (e) {
                            e.reset();
                        }), i.updateDatasets(), i.tooltip.initialize(), i.lastActive = [], Dt.notify(i, "afterUpdate"),
                            i._layers.sort(Kt("z", "_idx")), i._bufferedRender ? i._bufferedRequest = {
                                duration: e.duration,
                                easing: e.easing,
                                lazy: e.lazy
                            } : i.render(e);
                ...
                updateLayout: function () {
                    var t = this;
                    !1 !== Dt.notify(t, "beforeLayout") && (ft.update(this, this.width, this.height),
                        t._layers = [], W.each(t.boxes, function (e) {
                ...
                updateDataset: function (e) {
                    var t = this.getDatasetMeta(e), n = {
                        meta: t,
                        index: e
                    };
                    !1 !== Dt.notify(this, "beforeDatasetUpdate", [n]) && (t.controller._update(),
                        Dt.notify(this, "afterDatasetUpdate", [n]));
                },
                render: function (e) {
                    var t = this;
                    e && "object" == typeof e || (e = {
                ...
                destroy: function () {
                    ...
                    i && (n.unbindEvents(), W.canvas.clear(n), Pt.releaseContext(n.ctx), n.canvas = null,
                        n.ctx = null), Dt.notify(n, "destroy"), delete Jt.instances[n.id];
                },
                ...
                handleEvent: function (e) {
                    ...
                    return n.lastActive = n.lastActive || [], "mouseout" === e.type ? n.active = [] : n.active = n.getElementsAtEventForMode(e, r.mode, r),
                        W.callback(i.onHover || i.hover.onHover, [e.native, n.active], n), "mouseup" !== e.type && "click" !== e.type || i.onClick && i.onClick.call(n, e.native, n.active),
                        n.lastActive.length && n.updateHoverStyle(n.lastActive, r.mode, !1), n.active.length && r.mode && n.updateHoverStyle(n.active, r.mode, !0),
                        t = !W.arrayEquals(n.active, n.lastActive), n.lastActive = n.active, t;
                }
            }), Jt.instances = {};
            var Qt = Jt;
            ...
            function cn(e, t, n) {
                var i, r = e.getTicks().length, a = Math.min(t, r - 1), o = e.getPixelForTick(a), s = e._startPixel, l = e._endPixel;
                if (!(n && (i = 1 === r ? Math.max(o - s, l - o) : 0 === t ? (e.getPixelForTick(1) - o) / 2 : (o - e.getPixelForTick(a - 1)) / 2,
                    (o += a < t ? i : -i) < s - 1e-6 || l + 1e-6 < o))) return o;
            }
            function dn(e, t, n, i) {
                ...
                for (r = 0; r < m; ++r) {
                    if (s = n[r].label, l = n[r].major ? t.major : t.minor, e.font = c = l.string, d = i[c] = i[c] || {
                        ...
                        if (an(s)) for (a = 0, o = s.length; a < o; ++a) g = s[a], on(g) || an(g) || (h = W.measureText(e, d.data, d.gc, h, g),
                            f += u);
            ...
            function hn(e) {
                var t, n;
                return e.display ? (t = W.options._parseFont(e), n = W.options.toPadding(e.padding),
            ...
            function vn(e, t, n, i) {
                ...
                for (t = Math.ceil(t), i && (t = (r = i - n) / Math.floor(r / t)), s = l; s < 0;) d++,
                    s = Math.round(l + d * t);
            ...
            var mn = $.extend({
                ...
                update: function (e, t, n) {
                    ...
                    if (l.beforeUpdate(), l.maxWidth = e, l.maxHeight = t, l.margins = W.extend({
                        ...
                        top: 0,
                        bottom: 0
                    }, n), l._ticks = null, l.ticks = null, l._labelSizes = null, l._maxLabelLines = 0,
                        l.longestLabelWidth = 0, l.longestTextCache = l.longestTextCache || {}, l._gridLineItems = null,
                        l._labelItems = null, l.beforeSetDimensions(), l.setDimensions(), l.afterSetDimensions(),
                        l.beforeDataLimits(), l.determineDataLimits(), l.afterDataLimits(), l.beforeBuildTicks(),
                        o = l.buildTicks() || [], (!(o = l.afterBuildTicks(o) || o) || !o.length) && l.ticks) for (o = [],
                            i = 0, r = l.ticks.length; i < r; ++i) o.push({
                                value: l.ticks[i],
                                major: !1
                            });
                    return s = d < (l._ticks = o).length, a = l._convertTicksToLabels(s ? function (e, t) {
                        ...
                        return n;
                    }(o, d) : o), l._configure(), l.beforeCalculateTickRotation(), l.calculateTickRotation(),
                        l.afterCalculateTickRotation(), l.beforeFit(), l.fit(), l.afterFit(), l._ticksToDraw = c.display && (c.autoSkip || "auto" === c.source) ? l._autoSkip(o) : o,
                        s && (a = l._convertTicksToLabels(l._ticksToDraw)), l.ticks = a, l.afterUpdate(),
                        l.minSize;
                },
                _configure: function () {
                    var e, t, n = this, i = n.options.ticks.reverse;
                    n.isHorizontal() ? (e = n.left, t = n.right) : (e = n.top, t = n.bottom, i = !i),
                        n._startPixel = e, n._endPixel = t, n._reversePixels = i, n._length = t - e;
                },
                ...
                afterBuildTicks: function (e) {
                    var t = this;
                    return an(e) && e.length ? W.callback(t.options.afterBuildTicks, [t, e]) : (t.ticks = W.callback(t.options.afterBuildTicks, [t, t.ticks]) || t.ticks,
                        e);
                },
                ...
                calculateTickRotation: function () {
                    var e, t, n, i, r, a, o, s = this, l = s.options, c = l.ticks, d = s.getTicks().length, u = c.minRotation || 0, h = c.maxRotation, f = u;
                    !s._isVisible() || !c.display || h <= u || d <= 1 || !s.isHorizontal() ? s.labelRotation = u : (t = (e = s._getLabelSizes()).widest.width,
                        n = e.highest.height - e.highest.offset, i = Math.min(s.maxWidth, s.chart.width - t),
                        (r = l.offset ? s.maxWidth / d : i / (d - 1)) < t + 6 && (r = i / (d - (l.offset ? .5 : 1)),
                            a = s.maxHeight - un(l.gridLines) - c.padding - hn(l.scaleLabel), o = Math.sqrt(t * t + n * n),
                            f = W.toDegrees(Math.min(Math.asin(Math.min((e.highest.height + 6) / r, 1)), Math.asin(Math.min(a / o, 1)) - Math.asin(n / o))),
                            f = Math.max(u, Math.min(h, f))), s.labelRotation = f);
                },
                ...
                fit: function () {
                    var e = this, t = e.minSize = {
                        width: 0,
                        height: 0
                    }, n = e.chart, i = e.options, r = i.ticks, a = i.scaleLabel, o = i.gridLines, s = e._isVisible(), l = "bottom" === i.position, c = e.isHorizontal();
                    if (c ? t.width = e.maxWidth : s && (t.width = un(o) + hn(a)), c ? s && (t.height = un(o) + hn(a)) : t.height = e.maxHeight,
                        r.display && s) {
                        var d = gn(r), u = e._getLabelSizes(), h = u.first, f = u.last, g = u.widest, p = u.highest, v = .4 * d.minor.lineHeight, m = r.padding;
                        if (c) {
                            var y = 0 !== e.labelRotation, b = W.toRadians(e.labelRotation), x = Math.cos(b), M = Math.sin(b), w = M * g.width + x * (p.height - (y ? p.offset : 0)) + (y ? 0 : v);
                            t.height = Math.min(e.maxHeight, t.height + w + m);
                            var _, S, C = e.getPixelForTick(0) - e.left, k = e.right - e.getPixelForTick(e.getTicks().length - 1);
                            S = y ? (_ = l ? x * h.width + M * h.offset : M * (h.height - h.offset), l ? M * (f.height - f.offset) : x * f.width + M * f.offset) : (_ = h.width / 2,
                                f.width / 2), e.paddingLeft = Math.max((_ - C) * e.width / (e.width - C), 0) + 3,
                    ...
                    e.handleMargins(), c ? (e.width = e._length = n.width - e.margins.left - e.margins.right,
                        e.height = t.height) : (e.width = t.width, e.height = e._length = n.height - e.margins.top - e.margins.bottom);
                },
                handleMargins: function () {
                    var e = this;
                    e.margins && (e.margins.left = Math.max(e.paddingLeft, e.margins.left), e.margins.top = Math.max(e.paddingTop, e.margins.top),
                        e.margins.right = Math.max(e.paddingRight, e.margins.right), e.margins.bottom = Math.max(e.paddingBottom, e.margins.bottom));
                },
                afterFit: function () {
                ...
                _convertTicksToLabels: function (e) {
                    ...
                    for (r.ticks = e.map(function (e) {
                        return e.value;
                    }), r.beforeTickToLabelConversion(), t = r.convertTicksToLabels(e) || r.ticks, r.afterTickToLabelConversion(),
                        n = 0, i = e.length; n < i; ++n) e[n].label = t[n];
                    return t;
                },
                _getLabelSizes: function () {
                    var e = this, t = e._labelSizes;
                    return t || (e._labelSizes = t = dn(e.ctx, gn(e.options.ticks), e.getTicks(), e.longestTextCache),
                        e.longestLabelWidth = t.widest.width), t;
                },
                _parseValue: function (e) {
                    var t, n, i, r;
                    return r = an(e) ? (t = +this.getRightValue(e[0]), n = +this.getRightValue(e[1]),
                        i = Math.min(t, n), Math.max(t, n)) : (t = void 0, i = n = e = +this.getRightValue(e)),
                    {
                        min: i,
                        max: r,
                        start: t,
                ...
                _autoSkip: function (e) {
                    var t, n, i, r, a = this.options.ticks, o = this._length, s = a.maxTicksLimit || o / this._tickSize() + 1, l = a.major.enabled ? function (e) {
                        var t, n, i = [];
                    ...
                    if (s < c) return function (e, t, n) {
                        var i, r, a = 0, o = t[0];
                        for (n = Math.ceil(n), i = 0; i < e.length; i++) r = e[i], i === o ? (r._index = i,
                            o = t[++a * n]) : delete r.label;
                    }(e, l, c / s), pn(e);
                    if (i = function (e, t, n, i) {
                        ...
                        return r = 1 < c ? (u - d) / (c - 1) : null, vn(e, i, W.isNullOrUndef(r) ? 0 : d - r, d),
                            vn(e, i, u, W.isNullOrUndef(r) ? e.length : u + r), pn(e);
                    }
                    return vn(e, i), pn(e);
                },
                _tickSize: function () {
                    var e = this.options.ticks, t = W.toRadians(this.labelRotation), n = Math.abs(Math.cos(t)), i = Math.abs(Math.sin(t)), r = this._getLabelSizes(), a = e.autoSkipPadding || 0, o = r ? r.widest.width + a : 0, s = r ? r.highest.height + a : 0;
                ...
                _computeGridLineItems: function (e) {
                    ...
                    var n, i, r, a, o, s, l, c, d, u, h, f, g, p, v, m, y, b = this, x = b.chart, M = b.options, w = M.gridLines, _ = M.position, S = w.offsetGridLines, C = b.isHorizontal(), k = b._ticksToDraw, T = k.length + (S ? 1 : 0), L = un(w), A = [], E = w.drawBorder ? ln(w.lineWidth, 0, 0) : 0, O = E / 2, P = W._alignPixel;
                    for ("top" === _ ? (n = t(b.bottom), l = b.bottom - L, d = n - O, h = t(e.top) + O,
                        g = e.bottom) : "bottom" === _ ? (n = t(b.top), h = e.top, g = t(e.bottom) - O,
                            l = n + O, d = b.top + L) : "left" === _ ? (n = t(b.right), s = b.right - L, c = n - O,
                                u = t(e.left) + O, f = e.right) : (n = t(b.left), u = e.left, f = t(e.right) - O,
                                    s = n + O, c = b.left + L), i = 0; i < T; ++i) r = k[i] || {}, on(r.label) && i < k.length || (y = i === b.zeroLineIndex && M.offset === S ? (p = w.zeroLineWidth,
                                        v = w.zeroLineColor, m = w.zeroLineBorderDash || [], w.zeroLineBorderDashOffset || 0) : (p = ln(w.lineWidth, i, 1),
                                            v = ln(w.color, i, "rgba(0,0,0,0.1)"), m = w.borderDash || [], w.borderDashOffset || 0),
                                        void 0 !== (a = cn(b, r._index || i, S)) && (o = P(x, a, p), C ? s = c = u = f = o : l = d = h = g = o,
                                            A.push({
                                                tx1: s,
                                                ty1: l,
                                                tx2: c,
                ...
                _computeLabelItems: function () {
                    var e, t, n, i, r, a, o, s, l, c, d, u, h = this, f = h.options, g = f.ticks, p = f.position, v = g.mirror, m = h.isHorizontal(), y = h._ticksToDraw, b = gn(g), x = g.padding, M = un(f.gridLines), w = -W.toRadians(h.labelRotation), _ = [];
                    for (o = "top" === p ? (a = h.bottom - M - x, w ? "left" : "center") : "bottom" === p ? (a = h.top + M + x,
                        w ? "right" : "center") : "left" === p ? (r = h.right - (v ? 0 : M) - x, v ? "left" : "right") : (r = h.left + (v ? 0 : M) + x,
                            v ? "right" : "left"), e = 0, t = y.length; e < t; ++e) i = (n = y[e]).label, on(i) || (s = h.getPixelForTick(n._index || e) + g.labelOffset,
                                c = (l = n.major ? b.major : b.minor).lineHeight, d = an(i) ? i.length : 1, u = m ? (r = s,
                                    "top" === p ? ((w ? 1 : .5) - d) * c : (w ? 0 : .5) * c) : (a = s, (1 - d) * c / 2),
                                _.push({
                                    x: r,
                                    y: a,
                                    rotation: w,
                ...
                _drawGrid: function (e) {
                    ...
                    if (n.display) {
                        var i, r, a, o, s, l = t.ctx, c = t.chart, d = W._alignPixel, u = n.drawBorder ? ln(n.lineWidth, 0, 0) : 0, h = t._gridLineItems || (t._gridLineItems = t._computeGridLineItems(e));
                        for (a = 0, o = h.length; a < o; ++a) i = (s = h[a]).width, r = s.color, i && r && (l.save(),
                            l.lineWidth = i, l.strokeStyle = r, l.setLineDash && (l.setLineDash(s.borderDash),
                                l.lineDashOffset = s.borderDashOffset), l.beginPath(), n.drawTicks && (l.moveTo(s.tx1, s.ty1),
                                    l.lineTo(s.tx2, s.ty2)), n.drawOnChartArea && (l.moveTo(s.x1, s.y1), l.lineTo(s.x2, s.y2)),
                            l.stroke(), l.restore());
                        if (u) {
                            var f, g, p, v, m = u, y = ln(n.lineWidth, h.ticksLength - 1, 1), b = h.borderValue;
                            t.isHorizontal() ? (f = d(c, t.left, m) - m / 2, g = d(c, t.right, y) + y / 2, p = v = b) : (p = d(c, t.top, m) - m / 2,
                                v = d(c, t.bottom, y) + y / 2, f = g = b), l.lineWidth = u, l.strokeStyle = ln(n.color, 0),
                                l.beginPath(), l.moveTo(f, p), l.lineTo(g, v), l.stroke();
                        }
                    }
                },
                _drawLabels: function () {
                    ...
                    if (e.options.ticks.display) {
                        var t, n, i, r, a, o, s, l, c = e.ctx, d = e._labelItems || (e._labelItems = e._computeLabelItems());
                        for (t = 0, i = d.length; t < i; ++t) {
                            if (o = (a = d[t]).font, c.save(), c.translate(a.x, a.y), c.rotate(a.rotation),
                                c.font = o.string, c.fillStyle = o.color, c.textBaseline = "middle", c.textAlign = a.textAlign,
                                s = a.label, l = a.textOffset, an(s)) for (n = 0, r = s.length; n < r; ++n) c.fillText("" + s[n], 0, l),
                                    l += o.lineHeight; else c.fillText(s, 0, l);
                            c.restore();
                        }
                    }
                },
                _drawTitle: function () {
                    ...
                    if (i.display) {
                        var r, a, o = sn(i.fontColor, B.global.defaultFontColor), s = W.options._parseFont(i), l = W.options.toPadding(i.padding), c = s.lineHeight / 2, d = n.position, u = 0;
                        ...
                        t.save(), t.translate(r, a), t.rotate(u), t.textAlign = "center", t.textBaseline = "middle",
                            t.fillStyle = o, t.font = s.string, t.fillText(i.labelString, 0, 0), t.restore();
                    }
                },
                draw: function (e) {
            ...
            var yn = mn, bn = W.isNullOrUndef, xn = yn.extend({
                determineDataLimits: function () {
                    var e, t = this, n = t._getLabels(), i = t.options.ticks, r = i.min, a = i.max, o = 0, s = n.length - 1;
                    void 0 !== r && 0 <= (e = n.indexOf(r)) && (o = e), void 0 !== a && 0 <= (e = n.indexOf(a)) && (s = e),
                        t.minIndex = o, t.maxIndex = s, t.min = n[o], t.max = n[s];
                },
                buildTicks: function () {
                ...
                _configure: function () {
                    ...
                    yn.prototype._configure.call(e), e.isHorizontal() || (e._reversePixels = !e._reversePixels),
                        n && (e._startValue = e.minIndex - (t ? .5 : 0), e._valueRange = Math.max(n.length - (t ? 0 : 1), 1));
                },
                getPixelForValue: function (e, t, n) {
                    var i, r, a, o = this;
                    return bn(t) || bn(n) || (e = o.chart.data.datasets[n].data[t]), bn(e) || (i = o.isHorizontal() ? e.x : e.y),
                        (void 0 !== i || void 0 !== e && isNaN(t)) && (r = o._getLabels(), e = W.valueOrDefault(i, e),
                            t = -1 !== (a = r.indexOf(e)) ? a : t, isNaN(t) && (t = e)), o.getPixelForDecimal((t - o._startValue) / o._valueRange);
                },
                getPixelForTick: function (e) {
                    var t = this.ticks;
            ...
            var Sn = yn.extend({
                ...
                handleTickRangeOptions: function () {
                    ...
                    var r = void 0 !== t.min || void 0 !== t.suggestedMin, a = void 0 !== t.max || void 0 !== t.suggestedMax;
                    void 0 !== t.min ? e.min = t.min : void 0 !== t.suggestedMin && (null === e.min ? e.min = t.suggestedMin : e.min = Math.min(e.min, t.suggestedMin)),
                        ...
                        r != a && e.min >= e.max && (r ? e.max = e.min + 1 : e.min = e.max - 1), e.min === e.max && (e.max++,
                            t.beginAtZero || e.min--);
                },
                getTickLimit: function () {
                    var e, t = this.options.ticks, n = t.stepSize, i = t.maxTicksLimit;
                    return n ? e = Math.ceil(this.max / n) - Math.floor(this.min / n) + 1 : (e = this._computeTickLimit(),
                        i = i || 11), i && (e = Math.min(i, e)), e;
                },
                ...
                buildTicks: function () {
                    var e = this, t = e.options.ticks, n = e.getTickLimit(), i = {
                        ...
                        var n, i, r, a, o = [], s = e.stepSize, l = s || 1, c = e.maxTicks - 1, d = e.min, u = e.max, h = e.precision, f = t.min, g = t.max, p = W.niceNum((g - f) / c / l) * l;
                        ...
                        c < (a = Math.ceil(g / p) - Math.floor(f / p)) && (p = W.niceNum(a * p / c / l) * l),
                            ...
                            i = Math.floor(f / p) * p, r = Math.ceil(g / p) * p, s && (!_n(d) && W.almostWhole(d / p, p / 1e3) && (i = d),
                                !_n(u) && W.almostWhole(u / p, p / 1e3) && (r = u)), a = (r - i) / p, a = W.almostEquals(a, Math.round(a), p / 1e3) ? Math.round(a) : Math.ceil(a),
                            i = Math.round(i * n) / n, r = Math.round(r * n) / n, o.push(_n(d) ? i : d);
                        for (var v = 1; v < a; ++v) o.push(Math.round((i + v * p) * n) / n);
                        return o.push(_n(u) ? r : u), o;
                    }(i, e);
                    e.handleDirectionalChanges(), e.max = W.max(r), e.min = W.min(r), t.reverse ? (r.reverse(),
                ...
                _configure: function () {
                    ...
                    yn.prototype._configure.call(t), t.options.offset && n.length && (i -= e = (r - i) / Math.max(n.length - 1, 1) / 2,
                        r += e), t._startValue = i, t._endValue = r, t._valueRange = r - i;
                }
            }), Cn = {
                position: "left",
                ticks: {
            ...
            function kn(e, t, n, i) {
                ...
                for (r = 0; r < d; ++r) a = e._parseValue(i[r]), isNaN(a.min) || isNaN(a.max) || n.data[r].hidden || (l[r] = l[r] || 0,
                    c[r] = c[r] || 0, o.relativePoints ? l[r] = 100 : a.min < 0 || a.max < 0 ? c[r] += a.min : l[r] += a.max);
            }
            function Tn(e, t, n) {
                var i, r, a = n.length;
                for (i = 0; i < a; ++i) r = e._parseValue(n[i]), isNaN(r.min) || isNaN(r.max) || t.data[i].hidden || (e.min = Math.min(e.min, r.min),
                    e.max = Math.max(e.max, r.max));
            }
            var Ln = Sn.extend({
                determineDataLimits: function () {
                    var e, t, n, i, r = this, a = r.options, o = r.chart.data.datasets, s = r._getMatchingVisibleMetas(), l = a.stacked, c = {}, d = s.length;
                    ...
                    }), r.min = W.isFinite(r.min) && !isNaN(r.min) ? r.min : 0, r.max = W.isFinite(r.max) && !isNaN(r.max) ? r.max : 1,
                        r.handleTickRangeOptions();
                },
                _computeTickLimit: function () {
                    var e;
                    return this.isHorizontal() ? Math.ceil(this.width / 40) : (e = W.options._parseFont(this.options.ticks),
            ...
            var Vn = yn.extend({
                determineDataLimits: function () {
                    var e, t, n, i, r, a, o = this, s = o.options, l = o.chart, c = l.data.datasets, d = o.isHorizontal();
                    function u(e) {
                    ...
                    if (s.stacked || h) {
                        ...
                        for (e = 0; e < c.length; e++) {
                            ...
                            if (l.isDatasetVisible(e) && u(t)) for (void 0 === f[g] && (f[g] = []), r = 0, a = (i = c[e].data).length; r < a; r++) {
                                var p = f[g];
                                n = o._parseValue(i[r]), isNaN(n.min) || isNaN(n.max) || t.data[r].hidden || n.min < 0 || n.max < 0 || (p[r] = p[r] || 0,
                                    p[r] += n.max);
                            }
                        }
                        W.each(f, function (e) {
                    ...
                    } else for (e = 0; e < c.length; e++) if (t = l.getDatasetMeta(e), l.isDatasetVisible(e) && u(t)) for (r = 0,
                        a = (i = c[e].data).length; r < a; r++) n = o._parseValue(i[r]), isNaN(n.min) || isNaN(n.max) || t.data[r].hidden || n.min < 0 || n.max < 0 || (o.min = Math.min(n.min, o.min),
                            o.max = Math.max(n.max, o.max), 0 !== n.min && (o.minNotZero = Math.min(n.min, o.minNotZero)));
                    o.min = W.isFinite(o.min) ? o.min : null, o.max = W.isFinite(o.max) ? o.max : null,
                        o.minNotZero = W.isFinite(o.minNotZero) ? o.minNotZero : null, this.handleTickRangeOptions();
                },
                handleTickRangeOptions: function () {
                    var e = this, t = e.options.ticks;
                    e.min = Dn(t.min, e.min), e.max = Dn(t.max, e.max), e.min === e.max && (0 !== e.min && null !== e.min ? (e.min = Math.pow(10, Math.floor(On(e.min)) - 1),
                        e.max = Math.pow(10, Math.floor(On(e.max)) + 1)) : (e.min = 1, e.max = 10)), null === e.min && (e.min = Math.pow(10, Math.floor(On(e.max)) - 1)),
                        null === e.max && (e.max = 0 !== e.min ? Math.pow(10, Math.floor(On(e.min)) + 1) : 10),
                        null === e.minNotZero && (0 < e.min ? e.minNotZero = e.min : e.max < 1 ? e.minNotZero = Math.pow(10, Math.floor(On(e.max))) : e.minNotZero = 1);
                },
                buildTicks: function () {
                    var e = this, t = e.options.ticks, n = !e.isHorizontal(), i = {
                        min: Dn(t.min),
                        max: Dn(t.max)
                    }, r = e.ticks = function (e, t) {
                        var n, i, r = [], a = En(e.min, Math.pow(10, Math.floor(On(t.min)))), o = Math.floor(On(t.max)), s = Math.ceil(t.max / Math.pow(10, o));
                        0 === a ? (n = Math.floor(On(t.minNotZero)), i = Math.floor(t.minNotZero / Math.pow(10, n)),
                            r.push(a), a = i * Math.pow(10, n)) : (n = Math.floor(On(a)), i = Math.floor(a / Math.pow(10, n)));
                        for (var l = n < 0 ? Math.pow(10, Math.abs(n)) : 1; r.push(a), 10 === ++i && (i = 1,
                            l = 0 <= ++n ? 1 : l), a = Math.round(i * Math.pow(10, n) * l) / l, n < o || n === o && i < s;);
                        var c = En(e.max, a);
                        return r.push(c), r;
                    }(i, e);
                    e.max = W.max(r), e.min = W.min(r), t.reverse ? (n = !n, e.start = e.max, e.end = e.min) : (e.start = e.min,
                        e.end = e.max), n && r.reverse();
                },
                convertTicksToLabels: function () {
                ...
                _configure: function () {
                    ...
                    yn.prototype._configure.call(e), 0 === t && (t = e._getFirstTickValue(e.minNotZero),
                        n = En(e.options.ticks.fontSize, B.global.defaultFontSize) / e._length), e._startValue = On(t),
                        e._valueOffset = n, e._valueRange = (On(e.max) - On(t)) / (1 - n);
                },
                getPixelForValue: function (e) {
                    var t = this, n = 0;
                    return (e = +t.getRightValue(e)) > t.min && 0 < e && (n = (On(e) - t._startValue) / t._valueRange + t._valueOffset),
            ...
            function Wn(e, t, n, i) {
                var r, a, o = n.y + i / 2;
                if (W.isArray(t)) for (r = 0, a = t.length; r < a; ++r) e.fillText(t[r], n.x, o),
                    o += i; else e.fillText(t, n.x, o);
            }
            function jn(e) {
            ...
            var Yn = Sn.extend({
                setDimensions: function () {
                    var e = this;
                    e.width = e.maxWidth, e.height = e.maxHeight, e.paddingTop = In(e.options) / 2,
                        e.xCenter = Math.floor(e.width / 2), e.yCenter = Math.floor((e.height - e.paddingTop) / 2),
                ...
                determineDataLimits: function () {
                    ...
                    }), r.min = a === Number.POSITIVE_INFINITY ? 0 : a, r.max = o === Number.NEGATIVE_INFINITY ? 0 : o,
                        r.handleTickRangeOptions();
                },
                _computeTickLimit: function () {
                ...
                fit: function () {
                    ...
                    e.display && e.pointLabels.display ? function (e) {
                        var t, n, i, r = W.options._parseFont(e.options.pointLabels), a = {
                            l: 0,
                            r: e.width,
                            t: 0,
                        ...
                        for (t = 0; t < d; t++) {
                            i = e.getPointPosition(t, e.drawingArea + 5), s = e.ctx, l = r.lineHeight, c = e.pointLabels[t],
                                n = W.isArray(c) ? {
                            ...
                            var u = e.getIndexAngle(t), h = W.toDegrees(u) % 360, f = Fn(h, i.x, n.w, 0, 180), g = Fn(h, i.y, n.h, 90, 270);
                            f.start < a.l && (a.l = f.start, o.l = u), f.end > a.r && (a.r = f.end, o.r = u),
                                g.start < a.t && (a.t = g.start, o.t = u), g.end > a.b && (a.b = g.end, o.b = u);
                        }
                        e.setReductions(e.drawingArea, a, o);
                    }(this) : this.setCenterPoint(0, 0, 0, 0);
                },
                setReductions: function (e, t, n) {
                    var i = this, r = t.l / Math.sin(n.l), a = Math.max(t.r - i.width, 0) / Math.sin(n.r), o = -t.t / Math.cos(n.t), s = -Math.max(t.b - (i.height - i.paddingTop), 0) / Math.cos(n.b);
                    r = jn(r), a = jn(a), o = jn(o), s = jn(s), i.drawingArea = Math.min(Math.floor(e - (r + a) / 2), Math.floor(e - (o + s) / 2)),
                        i.setCenterPoint(r, a, o, s);
                },
                setCenterPoint: function (e, t, n, i) {
                    var r = this, a = r.width - t - r.drawingArea, o = e + r.drawingArea, s = n + r.drawingArea, l = r.height - r.paddingTop - i - r.drawingArea;
                ...
                _drawGrid: function () {
                    var e, n, t, i = this, r = i.ctx, a = i.options, o = a.gridLines, s = a.angleLines, l = zn(s.lineWidth, o.lineWidth), c = zn(s.color, o.color);
                    if (a.pointLabels.display && function (e) {
                        var t, n, i, r, a = e.ctx, o = e.options, s = o.pointLabels, l = In(o), c = e.getDistanceFromCenterForValue(o.ticks.reverse ? e.min : e.max), d = W.options._parseFont(s);
                        a.save(), a.font = d.string, a.textBaseline = "middle";
                        for (var u = e.chart.data.labels.length - 1; 0 <= u; u--) {
                            var h = 0 === u ? l / 2 : 0, f = e.getPointPosition(u, c + h + 5), g = Bn(s.fontColor, u, B.global.defaultFontColor);
                            a.fillStyle = g;
                            var p = e.getIndexAngle(u), v = W.toDegrees(p);
                            a.textAlign = 0 === (r = v) || 180 === r ? "center" : r < 180 ? "left" : "right",
                                t = v, n = e._pointLabelSizes[u], i = f, 90 === t || 270 === t ? i.y -= n.h / 2 : (270 < t || t < 90) && (i.y -= n.h),
                        ...
                        0 !== t && (n = i.getDistanceFromCenterForValue(i.ticksAsNumbers[t]), function (e, t, n, i) {
                            var r, a = e.ctx, o = t.circular, s = e.chart.data.labels.length, l = Bn(t.color, i - 1), c = Bn(t.lineWidth, i - 1);
                            if ((o || s) && l && c) {
                                if (a.save(), a.strokeStyle = l, a.lineWidth = c, a.setLineDash && (a.setLineDash(t.borderDash || []),
                                    a.lineDashOffset = t.borderDashOffset || 0), a.beginPath(), o) a.arc(e.xCenter, e.yCenter, n, 0, 2 * Math.PI); else {
                        ...
                        for (r.save(), r.lineWidth = l, r.strokeStyle = c, r.setLineDash && (r.setLineDash(Hn([s.borderDash, o.borderDash, []])),
                            r.lineDashOffset = Hn([s.borderDashOffset, o.borderDashOffset, 0])), e = i.chart.data.labels.length - 1; 0 <= e; e--) n = i.getDistanceFromCenterForValue(a.ticks.reverse ? i.min : i.max),
                                t = i.getPointPosition(e, n), r.beginPath(), r.moveTo(i.xCenter, i.yCenter), r.lineTo(t.x, t.y),
                                r.stroke();
                        r.restore();
                    }
                },
                _drawLabels: function () {
                    ...
                    if (r.display) {
                        var a, o, e = n.getIndexAngle(0), s = W.options._parseFont(r), l = zn(r.fontColor, B.global.defaultFontColor);
                        i.save(), i.font = s.string, i.translate(n.xCenter, n.yCenter), i.rotate(e), i.textAlign = "center",
                            i.textBaseline = "middle", W.each(n.ticks, function (e, t) {
                                0 === t && !r.reverse || (a = n.getDistanceFromCenterForValue(n.ticksAsNumbers[t]),
                                    r.showLabelBackdrop && (o = i.measureText(e).width, i.fillStyle = r.backdropColor,
                                        i.fillRect(-o / 2 - r.backdropPaddingX, -a - s.size / 2 - r.backdropPaddingY, o + 2 * r.backdropPaddingX, s.size + 2 * r.backdropPaddingY)),
                                    i.fillStyle = l, i.fillText(e, 0, -a));
                            }), i.restore();
                    }
                },
                _drawTitle: W.noop
            ...
            Yn._defaults = Gn;
            var Un = W._deprecated, qn = W.options.resolve, Xn = W.valueOrDefault, $n = Number.MIN_SAFE_INTEGER || -9007199254740991, Zn = Number.MAX_SAFE_INTEGER || 9007199254740991, Kn = {
                millisecond: {
                    common: !0,
                    size: 1,
                    steps: 1e3
            ...
            function ni(e, t, n, i) {
                ...
                }(e, t, n), a = r.lo ? r.hi ? r.lo : e[e.length - 2] : e[0], o = r.lo ? r.hi ? r.hi : e[e.length - 1] : e[1], s = o[t] - a[t], l = s ? (n - a[t]) / s : 0, c = (o[i] - a[i]) * l;
                return a[i] + c;
            }
            function ii(e, t) {
                var n = e._adapter, i = e.options.time, r = i.parser, a = r || i.format, o = t;
                return "function" == typeof r && (o = r(o)), W.isFinite(o) || (o = "string" == typeof a ? n.parse(o, a) : n.parse(o)),
                    null !== o ? +o : (r || "function" != typeof a || (o = a(t), W.isFinite(o) || (o = n.parse(o))),
                        o);
            }
            function ri(e, t) {
            ...
            function ai(e, t, n, i) {
                ...
                for (r = Jn.indexOf(e); r < s - 1; ++r) if (o = (a = Kn[Jn[r]]).steps ? a.steps : Zn,
                    a.common && Math.ceil((n - t) / (o * a.size)) <= i) return Jn[r];
                return Jn[s - 1];
            }
            function oi(e, t, n) {
            ...
            var si = yn.extend({
                ...
                update: function () {
                    var e = this.options, t = e.time || (e.time = {}), n = this._adapter = new nn._date(e.adapters.date);
                    return Un("time scale", t.format, "time.format", "time.parser"), Un("time scale", t.min, "time.min", "ticks.min"),
                        Un("time scale", t.max, "time.max", "ticks.max"), W.mergeIf(t.displayFormats, n.formats()),
                ...
                determineDataLimits: function () {
                    var e, t, n, i, r, a, o, s = this, l = s.chart, c = s._adapter, d = s.options, u = d.time.unit || "day", h = Zn, f = $n, g = [], p = [], v = [], m = s._getLabels();
                    for (e = 0, n = m.length; e < n; ++e) v.push(ri(s, m[e]));
                    for (e = 0, n = (l.data.datasets || []).length; e < n; ++e) if (l.isDatasetVisible(e)) if (r = l.data.datasets[e].data,
                        W.isObject(r[0])) for (p[e] = [], t = 0, i = r.length; t < i; ++t) a = ri(s, r[t]),
                            g.push(a), p[e][t] = a; else p[e] = v.slice(0), o || (g = g.concat(v), o = !0); else p[e] = [];
                    v.length && (h = Math.min(h, v[0]), f = Math.max(f, v[v.length - 1])), g.length && (g = 1 < n ? function (e) {
                        ...
                        return a;
                    }(g).sort(Qn) : g.sort(Qn), h = Math.min(h, g[0]), f = Math.max(f, g[g.length - 1])),
                        h = ri(s, ei(d)) || h, f = ri(s, ti(d)) || f, h = h === Zn ? +c.startOf(Date.now(), u) : h,
                        f = f === $n ? +c.endOf(Date.now(), u) + 1 : f, s.min = Math.min(h, f), s.max = Math.max(h + 1, f),
                        s._table = [], s._timestamps = {
                            data: g,
                            datasets: p,
                            labels: v
                        };
                ...
                buildTicks: function () {
                    var e, t, n, i = this, r = i.min, a = i.max, o = i.options, s = o.ticks, l = o.time, c = i._timestamps, d = [], u = i.getLabelCapacity(r), h = s.source, f = o.distribution;
                    for (c = "data" === h || "auto" === h && "series" === f ? c.data : "labels" === h ? c.labels : function (e, t, n, i) {
                        var r, a = e._adapter, o = e.options, s = o.time, l = s.unit || ai(s.minUnit, t, n, i), c = qn([s.stepSize, s.unitStepSize, 1]), d = "week" === l && s.isoWeekday, u = t, h = [];
                    ...
                    }(i, r, a, u), "ticks" === o.bounds && c.length && (r = c[0], a = c[c.length - 1]),
                        r = ri(i, ei(o)) || r, a = ri(i, ti(o)) || a, e = 0, t = c.length; e < t; ++e) r <= (n = c[e]) && n <= a && d.push(n);
                    return i.min = r, i.max = a, i._unit = l.unit || (s.autoSkip ? ai(l.minUnit, i.min, i.max, u) : function (e, t, n, i, r) {
                        ...
                        for (d.push(n), r = 0, a = d.length; r < a; ++r) l = d[r + 1], o = d[r - 1], s = d[r],
                            void 0 !== o && void 0 !== l && Math.round((l + o) / 2) === s || c.push({
                                time: s,
                                pos: r / (a - 1)
                            });
                        return c;
                        ...
                        var a, o, s = 0, l = 0;
                        return r.offset && t.length && (a = ni(e, "time", t[0], "pos"), s = 1 === t.length ? 1 - a : (ni(e, "time", t[1], "pos") - a) / 2,
                            o = ni(e, "time", t[t.length - 1], "pos"), l = 1 === t.length ? o : (o - ni(e, "time", t[t.length - 2], "pos")) / 2),
                        {
                            start: s,
                            end: l,
                            factor: 1 / (s + 1 + l)
                ...
                getLabelForIndex: function (e, t) {
                    var n = this, i = n._adapter, r = n.chart.data, a = n.options.time, o = r.labels && e < r.labels.length ? r.labels[e] : "", s = r.datasets[t].data[e];
                ...
                tickFormatFunction: function (e, t, n, i) {
                    var r = this._adapter, a = this.options, o = a.time.displayFormats, s = o[this._unit], l = this._majorUnit, c = o[l], d = n[t], u = a.ticks, h = l && c && d && d.major, f = r.format(e, i || (h ? c : s)), g = h ? u.major : u.minor, p = qn([g.callback, g.userCallback, u.callback, u.userCallback]);
                    return p ? p(f, t, n) : f;
                },
                ...
                getPixelForValue: function (e, t, n) {
                    var i = null;
                    if (void 0 !== t && void 0 !== n && (i = this._timestamps.datasets[n][t]), null === i && (i = ri(this, e)),
                        null !== i) return this.getPixelForOffset(i);
                },
                getPixelForTick: function (e) {
                    var t = this.getTicks();
                ...
                getValueForPixel: function (e) {
                    var t = this._offsets, n = this.getDecimalForPixel(e) / t.factor - t.end, i = ni(this._table, "pos", n, "time");
                    return this._adapter._create(i);
                },
                _getLabelSize: function (e) {
                    var t = this.options.ticks, n = this.ctx.measureText(e).width, i = W.toRadians(this.isHorizontal() ? t.maxRotation : t.minRotation), r = Math.cos(i), a = Math.sin(i), o = Xn(t.fontSize, B.global.defaultFontSize);
                    return {
                        w: n * r + o * a,
                        h: n * a + o * r
                    };
                ...
                getLabelCapacity: function (e) {
                    var t = this.options.time, n = t.displayFormats, i = n[t.unit] || n.millisecond, r = this.tickFormatFunction(e, 0, oi(this, [e], this._majorUnit), i), a = this._getLabelSize(r), o = Math.floor(this.isHorizontal() ? this.width / a.w : this.height / a.h);
            ...
            nn._date.override("function" == typeof i ? {
                ...
                parse: function (e, t) {
                    return "string" == typeof e && "string" == typeof t ? e = i(e, t) : e instanceof i || (e = i(e)),
            ...
            var ui = {
                dataset: function (e) {
                    var t = e.fill, n = e.chart, i = n.getDatasetMeta(t), r = i && n.isDatasetVisible(t) && i.dataset._children || [], a = r.length || 0;
            ...
            function hi(e, t, n) {
                ...
                if (i = parseFloat(a, 10), isFinite(i) && Math.floor(i) === i) return "-" !== a[0] && "+" !== a[0] || (i = t + i),
                    !(i === t || i < 0 || n <= i) && i;
                switch (a) {
                    case "bottom":
                        return "start";
            ...
            function fi(e) {
                return (e.el._scale || {}).getPointPositionForValue ? function (e) {
                    var t, n, i, r, a, o = e.el._scale, s = o.options, l = o.chart.data.labels.length, c = e.fill, d = [];
                    if (!l) return null;
                    for (t = s.ticks.reverse ? o.max : o.min, n = s.ticks.reverse ? o.min : o.max, i = o.getPointPositionForValue(0, t),
                        r = 0; r < l; ++r) a = "start" === c || "end" === c ? o.getPointPositionForValue(r, "start" === c ? t : n) : o.getBasePosition(r),
                    ...
                    if ("start" === r ? a = void 0 === n.scaleBottom ? i.bottom : n.scaleBottom : "end" === r ? a = void 0 === n.scaleTop ? i.top : n.scaleTop : void 0 !== n.scaleZero ? a = n.scaleZero : i.getBasePixel && (a = i.getBasePixel()),
                        null != a) {
            ...
            function vi(e, t, n, i, r) {
                ...
                if (i && r) {
                    ...
                    if (void 0 === n[0].angle) for (e.lineTo(n[r - 1].x, n[r - 1].y), a = r - 1; 0 < a; --a) W.canvas.lineTo(e, n[a], n[a - 1], !0); else for (o = n[0].cx,
                        s = n[0].cy, l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)), a = r - 1; 0 < a; --a) e.arc(o, s, l, n[a].angle, n[a - 1].angle, !0);
                }
            }
            function mi(e, t, n, i, r, a) {
                var o, s, l, c, d, u, h, f, g = t.length, p = i.spanGaps, v = [], m = [], y = 0, b = 0;
                for (e.beginPath(), o = 0, s = g; o < s; ++o) d = n(c = t[l = o % g]._view, l, i),
                    u = pi(c), h = pi(d), a && void 0 === f && u && (s = g + (f = o + 1)), u && h ? (y = v.push(c),
                        b = m.push(d)) : y && b && (p ? (u && v.push(c), h && m.push(d)) : (vi(e, v, m, y, b),
                            y = b = 0, v = [], m = []));
            ...
            var yi = {
                ...
                afterDatasetsUpdate: function (e, t) {
                    ...
                    for (i = 0; i < c; ++i) (a = u[i]) && (a.fill = gi(u, i, d), a.boundary = fi(a),
                        a.mapper = (l = void 0, s = (o = a).fill, !(l = "dataset") === s ? null : (isFinite(s) || (l = "boundary"),
                            ui[l](o))));
                },
                beforeDatasetsDraw: function (e) {
                    var t, n, i, r, a, o, s, l = e._getSortedVisibleDatasetMetas(), c = e.ctx;
                    for (n = l.length - 1; 0 <= n; --n) (t = l[n].$filler) && t.visible && (r = (i = t.el)._view,
                        a = i._children || [], o = t.mapper, s = r.backgroundColor || B.global.defaultColor,
                        o && s && a.length && (W.canvas.clipArea(c, e.chartArea), mi(c, a, o, r, s, i._loop),
                            W.canvas.unclipArea(c)));
                }
            ...
            B._set("global", {
                ...
                legendCallback: function (e) {
                    ...
                    for (r.setAttribute("class", e.id + "-legend"), t = 0, n = a.length; t < n; t++) (i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = a[t].backgroundColor,
            ...
            var _i = $.extend({
                ...
                update: function (e, t, n) {
                    var i = this;
                    return i.beforeUpdate(), i.maxWidth = e, i.maxHeight = t, i.margins = n, i.beforeSetDimensions(),
                        i.setDimensions(), i.afterSetDimensions(), i.beforeBuildLabels(), i.buildLabels(),
                        i.afterBuildLabels(), i.beforeFit(), i.fit(), i.afterFit(), i.afterUpdate(), i.minSize;
                },
                afterUpdate: xi,
                ...
                beforeFit: xi,
                fit: function () {
                    var e = this, t = e.options, i = t.labels, n = t.display, r = e.ctx, a = W.options._parseFont(i), o = a.size, s = e.legendHitBoxes = [], l = e.minSize, c = e.isHorizontal();
                    if (c ? (l.width = e.maxWidth, l.height = n ? 10 : 0) : (l.width = n ? 10 : 0, l.height = e.maxHeight),
                        n) {
                        if (r.font = a.string, c) {
                            ...
                            r.textAlign = "left", r.textBaseline = "middle", W.each(e.legendItems, function (e, t) {
                                ...
                                (0 === t || d[d.length - 1] + n + 2 * i.padding > l.width) && (u += o + i.padding,
                                    d[d.length - (0 < t ? 0 : 1)] = 0), s[t] = {
                                        left: 0,
                                        top: 0,
                                        width: n,
                                        height: o
                            ...
                            var h = i.padding, f = e.columnWidths = [], g = e.columnHeights = [], p = i.padding, v = 0, m = 0;
                            W.each(e.legendItems, function (e, t) {
                                var n = wi(i, o) + o / 2 + r.measureText(e.text).width;
                                0 < t && m + o + 2 * h > l.height && (p += v + i.padding, f.push(v), g.push(m),
                                    m = v = 0), v = Math.max(v, n), m += o + h, s[t] = {
                                        left: 0,
                                        top: 0,
                                        width: n,
                                        height: o
                ...
                draw: function () {
                    var s = this, n = s.options, l = n.labels, e = B.global, c = e.defaultColor, d = e.elements.line, u = s.height, h = s.columnHeights, f = s.width, g = s.lineWidths;
                    if (n.display) {
                        var p, v = bi(n.rtl, s.left, s.minSize.width), m = s.ctx, t = Mi(l.fontColor, e.defaultFontColor), i = W.options._parseFont(l), y = i.size;
                        m.textAlign = v.textAlign("left"), m.textBaseline = "middle", m.lineWidth = .5,
                            m.strokeStyle = t, m.fillStyle = t, m.font = i.string;
                        ...
                        W.each(s.legendItems, function (e, t) {
                            ...
                            v.setWidth(s.minSize.width), w ? 0 < t && r + i + l.padding > s.left + s.minSize.width && (a = p.y += _,
                                p.line++, r = p.x = s.left + M(f, g[p.line])) : 0 < t && a + _ > s.top + s.minSize.height && (r = p.x = r + s.columnWidths[p.line] + l.padding,
                                    p.line++, a = p.y = s.top + M(u, h[p.line]));
                            var o = v.x(r);
                            !function (e, t, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    m.save();
                                    var i = Mi(n.lineWidth, d.borderWidth);
                                    if (m.fillStyle = Mi(n.fillStyle, c), m.lineCap = Mi(n.lineCap, d.borderCapStyle),
                                        m.lineDashOffset = Mi(n.lineDashOffset, d.borderDashOffset), m.lineJoin = Mi(n.lineJoin, d.borderJoinStyle),
                                        m.lineWidth = i, m.strokeStyle = Mi(n.strokeStyle, c), m.setLineDash && m.setLineDash(Mi(n.lineDash, d.borderDash)),
                                        l && l.usePointStyle) {
                                ...
                                m.fillText(n.text, a, o), n.hidden && (m.beginPath(), m.lineWidth = 2, m.moveTo(a, o),
                                    m.lineTo(v.xPlus(a, i), o), m.stroke());
                ...
                _getLegendItemAt: function (e, t) {
                    var n, i, r;
                    if (e >= this.left && e <= this.right && t >= this.top && t <= this.bottom) for (r = this.legendHitBoxes,
                        n = 0; n < r.length; ++n) if (e >= (i = r[n]).left && e <= i.left + i.width && t >= i.top && t <= i.top + i.height) return this.legendItems[n];
                    return null;
                },
                handleEvent: function (e) {
                    ...
                    t = this._getLegendItemAt(e.x, e.y), "click" === i ? t && n.onClick && n.onClick.call(this, e.native, t) : (n.onLeave && t !== this._hoveredItem && (this._hoveredItem && n.onLeave.call(this, e.native, this._hoveredItem),
                        this._hoveredItem = t), n.onHover && t && n.onHover.call(this, e.native, t));
                }
            });
            function Si(e, t) {
                var n = new _i({
            ...
            var Ci = {
                ...
                beforeUpdate: function (e) {
                    ...
                    t ? (W.mergeIf(t, B.global.legend), n ? (ft.configure(e, n, t), n.options = t) : Si(e, t)) : n && (ft.removeBox(e, n),
                        delete e.legend);
                },
            ...
            var Ti = $.extend({
                ...
                fit: function () {
                    ...
                    t.display ? (e = (W.isArray(t.text) ? t.text.length : 1) * W.options._parseFont(t).lineHeight + 2 * t.padding,
                        this.width = n.width = i ? this.maxWidth : e, this.height = n.height = i ? e : this.maxHeight) : this.width = n.width = this.height = n.height = 0;
                },
                afterFit: ki,
                isHorizontal: function () {
                    var e = this.options.position;
                ...
                draw: function () {
                    ...
                    if (t.display) {
                        var n, i, r, a = W.options._parseFont(t), o = a.lineHeight, s = o / 2 + t.padding, l = 0, c = this.top, d = this.left, u = this.bottom, h = this.right;
                        e.fillStyle = W.valueOrDefault(t.fontColor, B.global.defaultFontColor), e.font = a.string,
                            this.isHorizontal() ? (i = d + (h - d) / 2, r = c + s, n = h - d) : (i = "left" === t.position ? d + s : h - s,
                                r = c + (u - c) / 2, n = u - c, l = Math.PI * ("left" === t.position ? -.5 : .5)),
                            e.save(), e.translate(i, r), e.rotate(l), e.textAlign = "center", e.textBaseline = "middle";
                        var f = t.text;
                        if (W.isArray(f)) for (var g = 0, p = 0; p < f.length; ++p) e.fillText(f[p], 0, g, n),
                            g += o; else e.fillText(f, 0, 0, n);
                        e.restore();
                    }
                }
            });
            ...
            var Ai = {}, Ei = yi, Oi = Ci, Pi = {
                ...
                beforeUpdate: function (e) {
                    ...
                    t ? (W.mergeIf(t, B.global.title), n ? (ft.configure(e, n, t), n.options = t) : Li(e, t)) : n && (ft.removeBox(e, n),
                        delete e.titleBlock);
                }
            };
            function Di(e, t, n) {
                var i;
                return "string" == typeof e ? (i = parseInt(e, 10), -1 !== e.indexOf("%") && (i = i / 100 * t.parentNode[n])) : i = e,
                    i;
            }
            function Vi(e) {
            ...
            function Ri(e, t, n) {
                var i = document.defaultView, r = W._getParentNode(e), a = i.getComputedStyle(e)[t], o = i.getComputedStyle(r)[t], s = Vi(a), l = Vi(o), c = Number.POSITIVE_INFINITY;
            ...
            for (var zi in Ai.filler = Ei, Ai.legend = Oi, Ai.title = Pi, (Qt.helpers = W).where = function (e, t) {
                ...
                var r = e.skip ? t : e, a = t, o = n.skip ? t : n, s = Math.sqrt(Math.pow(a.x - r.x, 2) + Math.pow(a.y - r.y, 2)), l = Math.sqrt(Math.pow(o.x - a.x, 2) + Math.pow(o.y - a.y, 2)), c = s / (s + l), d = l / (s + l), u = i * (c = isNaN(c) ? 0 : c), h = i * (d = isNaN(d) ? 0 : d);
                return {
                    previous: {
                        x: a.x - u * (o.x - r.x),
                        y: a.y - u * (o.y - r.y)
                ...
                for (t = 0; t < u - 1; ++t) i = d[t], r = d[t + 1], i.model.skip || r.model.skip || (W.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = r.mK = 0 : (a = i.mK / i.deltaK,
                    o = r.mK / i.deltaK, (l = Math.pow(a, 2) + Math.pow(o, 2)) <= 9 || (s = 3 / Math.sqrt(l),
                        i.mK = a * s * i.deltaK, r.mK = o * s * i.deltaK)));
                for (t = 0; t < u; ++t) (i = d[t]).model.skip || (n = 0 < t ? d[t - 1] : null, r = t < u - 1 ? d[t + 1] : null,
                    n && !n.model.skip && (c = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - c,
                        i.model.controlPointPreviousY = i.model.y - c * i.mK), r && !r.model.skip && (c = (r.model.x - i.model.x) / 3,
                            i.model.controlPointNextX = i.model.x + c, i.model.controlPointNextY = i.model.y + c * i.mK));
                ...
                var n, i, r = e.originalEvent || e, a = e.target || e.srcElement, o = a.getBoundingClientRect(), s = r.touches;
                i = s && 0 < s.length ? (n = s[0].clientX, s[0].clientY) : (n = r.clientX, r.clientY);
                var l = parseFloat(W.getStyle(a, "padding-left")), c = parseFloat(W.getStyle(a, "padding-top")), d = parseFloat(W.getStyle(a, "padding-right")), u = parseFloat(W.getStyle(a, "padding-bottom")), h = o.right - o.left - l - d, f = o.bottom - o.top - c - u;
                return {
                ...
                var n = t.clientWidth, i = n - W._calculatePadding(t, "padding-left", n) - W._calculatePadding(t, "padding-right", n), r = W.getConstraintWidth(e);
                return isNaN(r) ? i : Math.min(i, r);
            }, W.getMaximumHeight = function (e) {
                var t = W._getParentNode(e);
                if (!t) return e.clientHeight;
                var n = t.clientHeight, i = n - W._calculatePadding(t, "padding-top", n) - W._calculatePadding(t, "padding-bottom", n), r = W.getConstraintHeight(e);
                return isNaN(r) ? i : Math.min(i, r);
                ...
                if (1 !== n) {
                    ...
                    i.height = r * n, i.width = a * n, e.ctx.scale(n, n), i.style.height || i.style.width || (i.style.height = r + "px",
                        i.style.width = a + "px");
                }
                ...
                for (o = 0; o < h; o++) if (null != (c = n[o]) && !0 !== W.isArray(c)) u = W.measureText(e, r, a, u, c); else if (W.isArray(c)) for (s = 0,
                    l = c.length; s < l; s++) null == (d = c[s]) || W.isArray(d) || (u = W.measureText(e, r, a, u, d));
                var f = a.length / 2;
                if (f > n.length) {
            ...
            }, Qt._adapters = nn, Qt.Animation = K, Qt.animationService = J, Qt.controllers = Ze,
                Qt.DatasetController = ie, Qt.defaults = B, Qt.Element = $, Qt.elements = we, Qt.Interaction = it,
                Qt.layouts = ft, Qt.platform = Pt, Qt.plugins = Dt, Qt.Scale = yn, Qt.scaleService = Vt,
                Qt.Ticks = rn, Qt.Tooltip = Gt, Qt.helpers.each(ci, function (e, t) {
                    Qt.scaleService.registerScaleType(t, e, e._defaults);
                }), Ai) Ai.hasOwnProperty(zi) && Qt.plugins.register(Ai[zi]);
            Qt.platform.initialize();
            var Bi = Qt;
            return "undefined" != typeof window && (window.Chart = Qt), (Qt.Chart = Qt).Legend = Ai.legend._element,
                Qt.Title = Ai.title._element, Qt.pluginService = Qt.plugins, Qt.PluginBase = Qt.Element.extend({}),
                Qt.canvasHelpers = Qt.helpers.canvas, Qt.layoutService = Qt.layouts, Qt.LinearScaleBase = Sn,
        ...
        t = this, n = function () {
            ...
            function y(e, t) {
                ...
                if (a(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), a(t._i) || (e._i = t._i),
                    ...
                    a(t._pf) || (e._pf = g(t)), a(t._locale) || (e._locale = t._locale), 0 < m.length) for (n = 0; n < m.length; n++) a(r = t[i = m[n]]) || (e[i] = r);
                return e;
            }
            var t = !1;
            function b(e) {
                y(this, e), this._d = new Date(null != e._d ? e._d.getTime() : NaN), this.isValid() || (this._d = new Date(NaN)),
                    !1 === t && (t = !0, h.updateOffset(this), t = !1);
            }
            function x(e) {
            ...
            var H = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, N = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, I = {}, F = {};
            function W(e, t, n, i) {
                var r = i;
            ...
            function Y(e, t) {
                ...
                for (N.lastIndex = 0; 0 <= n && N.test(e);) e = e.replace(N, i), N.lastIndex = 0,
                    n -= 1;
                return e;
            }
            var G = /\d/, U = /\d\d/, q = /\d{3}/, X = /\d{4}/, $ = /[+-]?\d{6}/, Z = /\d\d?/, K = /\d\d\d\d?/, J = /\d\d\d\d\d\d?/, Q = /\d{1,3}/, ee = /\d{1,4}/, te = /[+-]?\d{1,6}/, ne = /\d+/, ie = /[+-]?\d+/, re = /Z|[+-]\d\d:?\d\d/gi, ae = /Z|[+-]\d\d(?::?\d\d)?/gi, oe = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, se = {};
            function le(e, n, i) {
            ...
            W("Y", 0, 0, function () {
                ...
                P("year", "y"), z("year", 1), le("Y", ie), le("YY", Z, U), le("YYYY", ee, X), le("YYYYY", te, $),
                le("YYYYYY", te, $), he(["YYYYY", "YYYYYY"], ge), he("YYYY", function (e, t) {
            ...
            var Oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, Pe = "January_February_March_April_May_June_July_August_September_October_November_December".split("_");
            ...
            function Ve(e, t) {
                ...
                return n = Math.min(e.date(), Ee(e.year(), t)), e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](t, n),
                    e;
            }
            function Re(e) {
            ...
            function He() {
                ...
                var t, n, i = [], r = [], a = [];
                for (t = 0; t < 12; t++) n = u([2e3, t]), i.push(this.monthsShort(n, "")), r.push(this.months(n, "")),
                    a.push(this.months(n, "")), a.push(this.monthsShort(n, ""));
                for (i.sort(e), r.sort(e), a.sort(e), t = 0; t < 12; t++) i[t] = de(i[t]), r[t] = de(r[t]);
                for (t = 0; t < 24; t++) a[t] = de(a[t]);
                this._monthsRegex = new RegExp("^(" + a.join("|") + ")", "i"), this._monthsShortRegex = this._monthsRegex,
            ...
            function Fe(e, t, n, i, r) {
                ...
                return o = s <= 0 ? _e(a = e - 1) + s : s > _e(e) ? (a = e + 1, s - _e(e)) : (a = e,
                    s), {
                    year: a,
                    dayOfYear: o
                };
            ...
            function We(e, t, n) {
                ...
                return o < 1 ? i = o + je(r = e.year() - 1, t, n) : o > je(e.year(), t, n) ? (i = o - je(e.year(), t, n),
                    r = e.year() + 1) : (r = e.year(), i = o), {
                    week: i,
                    year: r
                };
            }
            ...
            W("w", ["ww", 2], "wo", "week"), W("W", ["WW", 2], "Wo", "isoWeek"), P("week", "w"),
                P("isoWeek", "W"), z("week", 5), z("isoWeek", 5), le("w", Z), le("ww", Z, U), le("W", Z),
                le("WW", Z, U), fe(["w", "ww", "W", "WW"], function (e, t, n, i) {
                    t[i.substr(0, 1)] = w(e);
                });
            function Ye(e, t) {
            ...
            }), W("e", 0, 0, "weekday"), W("E", 0, 0, "isoWeekday"), P("day", "d"), P("weekday", "e"),
                P("isoWeekday", "E"), z("day", 11), z("weekday", 11), z("isoWeekday", 11), le("d", Z),
                le("e", Z), le("E", Z), le("dd", function (e, t) {
            ...
            function Ke() {
                ...
                for (t = 0; t < 7; t++) n = u([2e3, 1]).day(t), i = this.weekdaysMin(n, ""), r = this.weekdaysShort(n, ""),
                    a = this.weekdays(n, ""), o.push(i), s.push(r), l.push(a), c.push(i), c.push(r),
                    c.push(a);
                for (o.sort(e), s.sort(e), l.sort(e), c.sort(e), t = 0; t < 7; t++) s[t] = de(s[t]),
                    l[t] = de(l[t]), c[t] = de(c[t]);
                this._weekdaysRegex = new RegExp("^(" + c.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex,
                    ...
                    this._weekdaysShortStrictRegex = new RegExp("^(" + s.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + o.join("|") + ")", "i");
            }
            function Je() {
            ...
            }), Qe("a", !0), Qe("A", !1), P("hour", "h"), z("hour", 13), le("a", et), le("A", et),
                le("H", Z), le("h", Z), le("k", Z), le("HH", Z, U), le("hh", Z, U), le("kk", Z, U),
                le("hmm", K), le("hmmss", J), le("Hmm", K), le("Hmmss", J), he(["H", "HH"], me),
            ...
            function lt(e, t) {
                var n;
                return e && ((n = a(t) ? dt(e) : ct(e, t)) ? tt = n : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")),
                    tt._abbr;
            }
            function ct(e, t) {
                if (null === t) return delete rt[e], null;
                var n, i = it;
                if (t.abbr = e, null != rt[e]) T("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."),
                    i = rt[e]._config; else if (null != t.parentLocale) if (null != rt[t.parentLocale]) i = rt[t.parentLocale]._config; else {
                        if (null == (n = st(t.parentLocale))) return at[t.parentLocale] || (at[t.parentLocale] = []),
            ...
            function ut(e) {
                var t, n = e._a;
                return n && -2 === g(e).overflow && (t = n[pe] < 0 || 11 < n[pe] ? pe : n[ve] < 1 || n[ve] > Ee(n[ge], n[pe]) ? ve : n[me] < 0 || 24 < n[me] || 24 === n[me] && (0 !== n[ye] || 0 !== n[be] || 0 !== n[xe]) ? me : n[ye] < 0 || 59 < n[ye] ? ye : n[be] < 0 || 59 < n[be] ? be : n[xe] < 0 || 999 < n[xe] ? xe : -1,
                    g(e)._overflowDayOfYear && (t < ge || ve < t) && (t = ve), g(e)._overflowWeeks && -1 === t && (t = Me),
            ...
            function ft(e) {
                ...
                if (!e._d) {
                    for (i = function (e) {
                        ...
                        var t, n, i, r, a, o, s, l;
                        if (null != (t = e._w).GG || null != t.W || null != t.E) a = 1, o = 4, n = ht(t.GG, e._a[ge], We(Lt(), 1, 4).year),
                            i = ht(t.W, 1), ((r = ht(t.E, 1)) < 1 || 7 < r) && (l = !0); else {
                            a = e._locale._week.dow, o = e._locale._week.doy;
                            var c = We(Lt(), a, o);
                            n = ht(t.gg, e._a[ge], c.year), i = ht(t.w, c.week), null != t.d ? ((r = t.d) < 0 || 6 < r) && (l = !0) : null != t.e ? (r = t.e + a,
                                (t.e < 0 || 6 < t.e) && (l = !0)) : r = a;
                        }
                        i < 1 || i > je(n, a, o) ? g(e)._overflowWeeks = !0 : null != l ? g(e)._overflowWeekday = !0 : (s = Fe(n, i, r, a, o),
                            e._a[ge] = s.year, e._dayOfYear = s.dayOfYear);
                    }(e), null != e._dayOfYear && (a = ht(e._a[ge], i[ge]), (e._dayOfYear > _e(a) || 0 === e._dayOfYear) && (g(e)._overflowDayOfYear = !0),
                        n = Ne(a, 0, e._dayOfYear), e._a[pe] = n.getUTCMonth(), e._a[ve] = n.getUTCDate()),
                        t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = o[t] = i[t];
                    for (; t < 7; t++) e._a[t] = o[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
                    24 === e._a[me] && 0 === e._a[ye] && 0 === e._a[be] && 0 === e._a[xe] && (e._nextDay = !0,
                        e._a[me] = 0), e._d = (e._useUTC ? Ne : function (e, t, n, i, r, a, o) {
                            var s;
                            return e < 100 && 0 <= e ? (s = new Date(e + 400, t, n, i, r, a, o), isFinite(s.getFullYear()) && s.setFullYear(e)) : s = new Date(e, t, n, i, r, a, o),
                                s;
                        }).apply(null, o), r = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm),
                        e._nextDay && (e._a[me] = 24), e._w && void 0 !== e._w.d && e._w.d !== r && (g(e).weekdayMismatch = !0);
                }
            }
            ...
            function St(e) {
                ...
                if (t) {
                    ...
                    if (!function (e, t, n) {
                        return !e || Ue.indexOf(e) === new Date(t[0], t[1], t[2]).getDay() || (g(n).weekdayMismatch = !0,
                            n._isValid = !1);
                    }(t[1], n, e)) return;
                    e._a = n, e._tzm = function (e, t, n) {
                        ...
                        return 60 * ((i - r) / 100) + r;
                    }(t[8], t[9], t[10]), e._d = Ne.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm),
                        g(e).rfc2822 = !0;
                } else e._isValid = !1;
            }
            function Ct(e) {
                if (e._f !== h.ISO_8601) if (e._f !== h.RFC_2822) {
                    ...
                    for (i = Y(e._f, e._locale).match(H) || [], t = 0; t < i.length; t++) r = i[t],
                        (n = (c.match(ce(r, e)) || [])[0]) && (0 < (a = c.substr(0, c.indexOf(n))).length && g(e).unusedInput.push(a),
                            c = c.slice(c.indexOf(n) + n.length), u += n.length), F[r] ? (n ? g(e).empty = !1 : g(e).unusedTokens.push(r),
                                o = r, l = e, null != (s = n) && f(ue, o) && ue[o](s, l._a, l, o)) : e._strict && !n && g(e).unusedTokens.push(r);
                    g(e).charsLeftOver = d - u, 0 < c.length && g(e).unusedInput.push(c), e._a[me] <= 12 && !0 === g(e).bigHour && 0 < e._a[me] && (g(e).bigHour = void 0),
                        g(e).parsedDateParts = e._a.slice(0), g(e).meridiem = e._meridiem, e._a[me] = function (e, t, n) {
                            var i;
                            if (null == n) return t;
            ...
            function kt(e) {
                ...
                return e._locale = e._locale || dt(e._l), null === t || void 0 === n && "" === t ? v({
                    ...
                    for (r = 0; r < e._f.length; r++) a = 0, t = y({}, e), null != e._useUTC && (t._useUTC = e._useUTC),
                        t._f = e._f[r], Ct(t), p(t) && (a += g(t).charsLeftOver, a += 10 * g(t).unusedTokens.length,
                            g(t).score = a, (null == i || a < i) && (i = a, n = t));
                    d(e, n || t);
                }(e) : n ? Ct(e) : function (e) {
                    var t = e._i;
                    a(t) ? e._d = new Date(h.now()) : c(t) ? e._d = new Date(t.valueOf()) : "string" == typeof t ? function (e) {
                        var t = bt.exec(e._i);
                        null === t ? (xt(e), !1 === e._isValid && (delete e._isValid, St(e), !1 === e._isValid && (delete e._isValid,
                            h.createFromInputFallback(e)))) : e._d = new Date(+t[1]);
            ...
            function Tt(e, t, n, i, r) {
                ...
                return !0 !== n && !1 !== n || (i = n, n = void 0), (s(e) && function (e) {
                    ...
                    return !0;
                }(e) || o(e) && 0 === e.length) && (e = void 0), a._isAMomentObject = !0, a._useUTC = a._isUTC = r,
                    a._l = n, a._i = e, a._f = t, a._strict = i, function (e) {
                        var t = new b(ut(kt(e)));
            ...
            function Dt(e) {
                var t = V(e), n = t.year || 0, i = t.quarter || 0, r = t.month || 0, a = t.week || t.isoWeek || 0, o = t.day || 0, s = t.hour || 0, l = t.minute || 0, c = t.second || 0, d = t.millisecond || 0;
                this._isValid = function (e) {
                    ...
                    return !0;
                }(t), this._milliseconds = +d + 1e3 * c + 6e4 * l + 1e3 * s * 60 * 60, this._days = +o + 7 * a,
                    this._months = +r + 3 * i + 12 * n, this._data = {}, this._locale = dt(), this._bubble();
            }
            function Vt(e) {
            ...
            function Nt(e, t) {
                var n, i;
                return t._isUTC ? (n = t.clone(), i = (x(e) || c(e) ? e.valueOf() : Lt(e).valueOf()) - n.valueOf(),
                    n._d.setTime(n._d.valueOf() + i), h.updateOffset(n, !1), n) : Lt(e).local();
            }
            function It(e) {
            ...
            var Wt = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/, jt = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
            function Yt(e, t) {
                ...
                return Vt(e) ? a = {
                    ...
                    d: e._days,
                    M: e._months
                } : l(e) ? (a = {}, t ? a[t] = e : a.milliseconds = e) : (o = Wt.exec(e)) ? (n = "-" === o[1] ? -1 : 1,
                    a = {
                        y: 0,
                        d: w(o[ve]) * n,
                        h: w(o[me]) * n,
                        ...
                        t = Nt(t, e), e.isBefore(t) ? n = Ut(e, t) : ((n = Ut(t, e)).milliseconds = -n.milliseconds,
                            n.months = -n.months);
                        return n;
                    }(Lt(a.from), Lt(a.to)), (a = {}).ms = r.milliseconds, a.M = r.months), i = new Dt(a),
                    Vt(e) && f(e, "_locale") && (i._locale = e._locale), i;
            }
            function Gt(e, t) {
            ...
            function qt(i, r) {
                return function (e, t) {
                    var n;
                    return null === t || isNaN(+t) || (T(r, "moment()." + r + "(period, number) is deprecated. Please use moment()." + r + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
                        n = e, e = t, t = n), Xt(this, Yt(e = "string" == typeof e ? +e : e, t), i), this;
                };
            }
            function Xt(e, t, n, i) {
                var r = t._milliseconds, a = Rt(t._days), o = Rt(t._months);
                e.isValid() && (i = null == i || i, o && Ve(e, Le(e, "Month") + o * n), a && Ae(e, "Date", Le(e, "Date") + a * n),
                    r && e._d.setTime(e._d.valueOf() + r * n), i && h.updateOffset(e, a || o));
            }
            ...
            W(0, ["gg", 2], 0, function () {
                ...
                on("GGGGG", "isoWeekYear"), P("weekYear", "gg"), P("isoWeekYear", "GG"), z("weekYear", 1),
                z("isoWeekYear", 1), le("G", ie), le("g", ie), le("GG", Z, U), le("gg", Z, U), le("GGGG", ee, X),
                le("gggg", ee, X), le("GGGGG", te, $), le("ggggg", te, $), fe(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, n, i) {
                    t[i.substr(0, 2)] = w(e);
                }), fe(["gg", "GG"], function (e, t, n, i) {
                    t[i] = h.parseTwoDigitYear(e);
                }), W("Q", 0, "Qo", "quarter"), P("quarter", "Q"), z("quarter", 7), le("Q", G),
                he("Q", function (e, t) {
                    t[pe] = 3 * (w(e) - 1);
                }), W("D", ["DD", 2], "Do", "date"), P("date", "D"), z("date", 9), le("D", Z),
                le("DD", Z, U), le("Do", function (e, t) {
                    return e ? t._dayOfMonthOrdinalParse || t._ordinalParse : t._dayOfMonthOrdinalParseLenient;
                }), he(["D", "DD"], ve), he("Do", function (e, t) {
                    t[ve] = w(e.match(Z)[0]);
                });
            var ln = Te("Date", !0);
            W("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), P("dayOfYear", "DDD"), z("dayOfYear", 4),
                le("DDD", Q), le("DDDD", q), he(["DDD", "DDDD"], function (e, t, n) {
                    n._dayOfYear = w(e);
                }), W("m", ["mm", 2], 0, "minute"), P("minute", "m"), z("minute", 14), le("m", Z),
                le("mm", Z, U), he(["m", "mm"], ye);
            var cn = Te("Minutes", !1);
            W("s", ["ss", 2], 0, "second"), P("second", "s"), z("second", 15), le("s", Z),
                le("ss", Z, U), he(["s", "ss"], be);
            ...
            }), P("millisecond", "ms"), z("millisecond", 16), le("S", Q, G), le("SS", Q, U),
                le("SSS", Q, q), dn = "SSSS"; dn.length <= 9; dn += "S") le(dn, ne);
            function hn(e, t) {
                t[xe] = w(1e3 * ("0." + e));
            }
            ...
            gn.add = $t, gn.calendar = function (e, t) {
                var n = e || Lt(), i = Nt(n, this).startOf("day"), r = h.calendarFormat(this, i) || "sameElse", a = t && (L(t[r]) ? t[r].call(this, n) : t[r]);
                ...
                var n, i = x(e) ? e : Lt(e);
                return !(!this.isValid() || !i.isValid()) && ("millisecond" === (t = D(t) || "millisecond") ? this.valueOf() === i.valueOf() : (n = i.valueOf(),
                ...
                return null == e ? t : this.add(e - t, "d");
            }, gn.hour = gn.hours = nt, gn.minute = gn.minutes = cn, gn.second = gn.seconds = un,
                gn.millisecond = gn.milliseconds = fn, gn.utcOffset = function (e, t, n) {
                    ...
                    return !this._isUTC && t && (i = It(this)), this._offset = e, this._isUTC = !0,
                        null != i && this.add(i, "m"), r !== e && (!t || this._changeInProgress ? Xt(this, Yt(e - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
                ...
                }, gn.dates = n("dates accessor is deprecated. Use date instead.", ln), gn.months = n("months accessor is deprecated. Use month instead", Re),
                gn.years = n("years accessor is deprecated. Use year instead", ke), gn.zone = n("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (e, t) {
            ...
            function bn(e, t, n, i) {
                t = ("boolean" == typeof e ? l(t) && (n = t, t = void 0) : (t = e, e = !1, l(n = t) && (n = t,
                    t = void 0)), t || "");
            ...
            vn.calendar = function (e, t, n) {
                ...
                if (this._monthsParseExact) return function (e, t, n) {
                    ...
                    if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [],
                        this._shortMonthsParse = [], i = 0; i < 12; ++i) a = u([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(a, "").toLocaleLowerCase(),
                ...
                for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []),
                    ...
                    if (r = u([2e3, i]), n && !this._longMonthsParse[i] && (this._longMonthsParse[i] = new RegExp("^" + this.months(r, "").replace(".", "") + "$", "i"),
                        ...
                        n || this._monthsParse[i] || (a = "^" + this.months(r, "") + "|^" + this.monthsShort(r, ""),
                            this._monthsParse[i] = new RegExp(a.replace(".", ""), "i")), n && "MMMM" === t && this._longMonthsParse[i].test(e)) return i;
                    if (n && "MMM" === t && this._shortMonthsParse[i].test(e)) return i;
                    if (!n && this._monthsParse[i].test(e)) return i;
                }
            }, vn.monthsRegex = function (e) {
                return this._monthsParseExact ? (f(this, "_monthsRegex") || He.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (f(this, "_monthsRegex") || (this._monthsRegex = Be),
                    this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
            }, vn.monthsShortRegex = function (e) {
                return this._monthsParseExact ? (f(this, "_monthsRegex") || He.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = ze),
                ...
                if (this._weekdaysParseExact) return function (e, t, n) {
                    ...
                    if (!this._weekdaysParse) for (this._weekdaysParse = [], this._shortWeekdaysParse = [],
                        this._minWeekdaysParse = [], i = 0; i < 7; ++i) a = u([2e3, 1]).day(i), this._minWeekdaysParse[i] = this.weekdaysMin(a, "").toLocaleLowerCase(),
                            this._shortWeekdaysParse[i] = this.weekdaysShort(a, "").toLocaleLowerCase(), this._weekdaysParse[i] = this.weekdays(a, "").toLocaleLowerCase();
                ...
                for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [],
                    ...
                    if (r = u([2e3, 1]).day(i), n && !this._fullWeekdaysParse[i] && (this._fullWeekdaysParse[i] = new RegExp("^" + this.weekdays(r, "").replace(".", "\\.?") + "$", "i"),
                        ...
                        this._weekdaysParse[i] || (a = "^" + this.weekdays(r, "") + "|^" + this.weekdaysShort(r, "") + "|^" + this.weekdaysMin(r, ""),
                            this._weekdaysParse[i] = new RegExp(a.replace(".", ""), "i")), n && "dddd" === t && this._fullWeekdaysParse[i].test(e)) return i;
                    if (n && "ddd" === t && this._shortWeekdaysParse[i].test(e)) return i;
                    if (n && "dd" === t && this._minWeekdaysParse[i].test(e)) return i;
                    if (!n && this._weekdaysParse[i].test(e)) return i;
                }
            }, vn.weekdaysRegex = function (e) {
                return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Xe),
                    this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
            }, vn.weekdaysShortRegex = function (e) {
                return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $e),
                    this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
            }, vn.weekdaysMinRegex = function (e) {
                return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ze),
            ...
            var kn = Cn("ms"), Tn = Cn("s"), Ln = Cn("m"), An = Cn("h"), En = Cn("d"), On = Cn("w"), Pn = Cn("M"), Dn = Cn("Q"), Vn = Cn("y");
            function Rn(e) {
                return function () {
                    return this.isValid() ? this._data[e] : NaN;
                };
            }
            var zn = Rn("milliseconds"), Bn = Rn("seconds"), Hn = Rn("minutes"), Nn = Rn("hours"), In = Rn("days"), Fn = Rn("months"), Wn = Rn("years");
            var jn = Math.round, Yn = {
                ss: 44,
                s: 45,
                m: 45,
                h: 22,
            ...
            function qn() {
                ...
                var a = M(r / 12), o = r %= 12, s = i, l = t, c = e, d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "", u = this.asSeconds();
                if (!u) return "P0D";
                var h = u < 0 ? "-" : "", f = Un(this._months) !== Un(u) ? "-" : "", g = Un(this._days) !== Un(u) ? "-" : "", p = Un(this._milliseconds) !== Un(u) ? "-" : "";
            ...
            return Xn.isValid = function () {
                ...
                if ("month" === (e = D(e)) || "quarter" === e || "year" === e) switch (t = this._days + i / 864e5,
                    n = this._months + _n(t), e) {
                        case "month":
                            return n;
            ...
            }, Xn.asMilliseconds = kn, Xn.asSeconds = Tn, Xn.asMinutes = Ln, Xn.asHours = An,
                Xn.asDays = En, Xn.asWeeks = On, Xn.asMonths = Pn, Xn.asQuarters = Dn, Xn.asYears = Vn,
                Xn.valueOf = function () {
                    ...
                    return 0 <= a && 0 <= o && 0 <= s || a <= 0 && o <= 0 && s <= 0 || (a += 864e5 * wn(Sn(s) + o),
                        s = o = 0), l.milliseconds = a % 1e3, e = M(a / 1e3), l.seconds = e % 60, t = M(e / 60),
                        l.minutes = t % 60, n = M(t / 60), l.hours = n % 24, s += r = M(_n(o += M(n / 24))),
                        o -= wn(Sn(r)), i = M(s / 12), s %= 12, l.days = o, l.months = s, l.years = i, this;
                }, Xn.clone = function () {
                    return Yt(this);
                }, Xn.get = function (e) {
                    return e = D(e), this.isValid() ? this[e + "s"]() : NaN;
                }, Xn.milliseconds = zn, Xn.seconds = Bn, Xn.minutes = Hn, Xn.hours = Nn, Xn.days = In,
                Xn.weeks = function () {
                    return M(this.days() / 7);
                }, Xn.months = Fn, Xn.years = Wn, Xn.humanize = function (e) {
                    if (!this.isValid()) return this.localeData().invalidDate();
                    var t = this.localeData(), n = function (e, t, n) {
                        var i = Yt(e).abs(), r = jn(i.as("s")), a = jn(i.as("m")), o = jn(i.as("h")), s = jn(i.as("d")), l = jn(i.as("M")), c = jn(i.as("y")), d = r <= Yn.ss && ["s", r] || r < Yn.s && ["ss", r] || a <= 1 && ["m"] || a < Yn.m && ["mm", a] || o <= 1 && ["h"] || o < Yn.h && ["hh", o] || s <= 1 && ["d"] || s < Yn.d && ["dd", s] || l <= 1 && ["M"] || l < Yn.M && ["MM", l] || c <= 1 && ["y"] || ["yy", c];
                        return d[2] = t, d[3] = 0 < +e, d[4] = n, function (e, t, n, i, r) {
                            return r.relativeTime(t || 1, !!n, e, i);
                        }.apply(null, d);
                    }(this, !e, t);
                    return e && (n = t.pastFuture(+this, n)), t.postformat(n);
                }, Xn.toISOString = qn, Xn.toString = qn, Xn.toJSON = qn, Xn.locale = Jt, Xn.localeData = en,
                Xn.toIsoString = n("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", qn),
                Xn.lang = Qt, W("X", 0, 0, "unix"), W("x", 0, 0, "valueOf"), le("x", ie), le("X", /[+-]?\d+(\.\d{1,3})?/),
                he("X", function (e, t, n) {
                ...
                }, h.isDate = c, h.locale = lt, h.invalid = v, h.duration = Yt, h.isMoment = x,
                h.weekdays = function (e, t, n) {
                    ...
                    if (null != t) {
                        var n, i, r = it;
                        null != (i = st(e)) && (r = i._config), (n = new E(t = A(r, t))).parentLocale = rt[e],
                            rt[e] = n, lt(e);
                    ...
                    return void 0 !== Yn[e] && (void 0 === t ? Yn[e] : (Yn[e] = t, "s" === e && (Yn.ss = t - 1),
                        !0));
    ...
    3: [function (e, n, i) {
        (function (Fr) {
            ...
            e = this, t = function () {
                ...
                var h, f, g, p = "object", y = n(typeof globalThis == p && globalThis) || n(typeof window == p && window) || n(typeof self == p && self) || n(typeof e == p && e) || Function("return this")(), b = !v(function () {
                ...
                } : Object, L = {}.hasOwnProperty, A = y.document, E = m(A) && m(A.createElement), O = !b && !v(function () {
                ...
                }), H = B("native-function-to-string", Function.toString), N = y.WeakMap, I = "function" == typeof N && /native code/.test(H.call(N)), F = 0, W = Math.random(), j = B("keys"), Y = {}, G = y.WeakMap;
                if (I) {
                ...
                function de(e, t) {
                    var n;
                    return Ve(e) && ("function" != typeof (n = e.constructor) || n !== Array && !Ve(n.prototype) ? m(n) && null === (n = n[He]) && (n = void 0) : n = void 0),
                        new (void 0 === n ? Array : n)(0 === t ? 0 : t);
                }
                function ue(f) {
                    var g = 1 == f, p = 2 == f, v = 3 == f, m = 4 == f, y = 6 == f, b = 5 == f || y;
                    return function (e, t, n, i) {
                        for (var r, a, o = le(e), s = T(o), l = se(t, n, 3), c = ee(s.length), d = 0, u = i || de, h = g ? u(e, c) : p ? u(e, 0) : void 0; d < c; d++) if ((b || d in s) && (a = l(r = s[d], d, o),
                            f)) if (g) h[d] = a; else if (a) switch (f) {
                                case 3:
                                    return !0;
                ...
                var fe = {
                    ...
                    B("inspectSource", function (e) {
                        ...
                        "function" == typeof n && ("string" != typeof t || c(n, "name") || z(n, "name", t),
                            s(n).source = l.join("string" == typeof t ? t : "")), e !== y ? (r ? !o && e[t] && (a = !0) : delete e[t],
                                a ? e[t] = n : z(e, t, n)) : a ? e[t] = n : u(t, n);
                    })(Function.prototype, "toString", function () {
                        return "function" == typeof this && t(this).source || H.call(this);
                    });
                }), pe = y, ve = Math.ceil, me = Math.floor, ye = Math.min, be = Math.max, xe = Math.min, Me = (te(!0),
                    te(!1)), we = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], _e = we.concat("length", "prototype"), Se = {
                    ...
                    }, Ae = re.data = {}, Ee = re.NATIVE = "N", Oe = re.POLYFILL = "P", Pe = re, De = D.f, Ve = Array.isArray || function (e) {
                        return "Array" == r(e);
                ...
                var qe = !("undefined" == typeof window || !window.document || !window.document.createElement), Xe = ce("species"), $e = Ie.filter;
                ae({
                    target: "Array",
                    proto: !0,
                    forced: !!v(function () {
                ...
                var Ke = Object.keys || function (e) {
                    ...
                    for (t.style.display = "none", Qe.appendChild(t), t.src = String("javascript:"),
                        (e = t.contentWindow.document).open(), e.write("<script>document.F=Object</script>"),
                        e.close(), tt = e.F; n--;) delete tt.prototype[we[n]];
                    return tt();
                }, nt = Object.create || function (e, t) {
                    var n;
                    return null !== e ? (Ze.prototype = S(e), n = new Ze(), Ze.prototype = null, n[et] = e) : n = tt(),
                        void 0 === t ? n : Je(n, t);
                };
                Y[et] = !0;
                ...
                [].keys && ("next" in (lt = [].keys()) ? (st = ft(ft(lt))) !== Object.prototype && (ot = st) : pt = !0),
                    null == ot && (ot = {}), c(ot, gt) || z(ot, gt, function () {
                        return this;
                    });
                function vt(e, t, n) {
                ...
                function bt(e, t, n, i, r, a, o) {
                    ...
                    var u, h, f, g = t + " Iterator", p = !1, v = e.prototype, m = v[Tt] || v["@@iterator"] || r && v[r], y = !kt && m || d(r), b = "Array" == t && v.entries || m;
                    if (b && (u = ft(b.call(new e())), Ct !== Object.prototype && u.next && (ft(u) !== Ct && (St ? St(u, Ct) : "function" != typeof u[Tt] && z(u, Tt, yt)),
                        vt(u, g, !0))), "values" == r && m && "values" !== m.name && (p = !0, y = function () {
                            return m.call(this);
                ...
                }, Mt = R.f, wt = ce("toStringTag"), _t = xt.IteratorPrototype, St = Object.setPrototypeOf || ("__proto__" in {} ? function () {
                    var n, i = !1, e = {};
                    try {
                ...
                }() : void 0), Ct = xt.IteratorPrototype, kt = xt.BUGGY_SAFARI_ITERATORS, Tt = ce("iterator"), Lt = fe.set, At = fe.getterFor("Array Iterator"), Et = bt(Array, "Array", function (e, t) {
                    Lt(this, {
                        type: "Array Iterator",
                        target: d(e),
                        index: 0,
                ...
                var Ot = Object.assign, Pt = !Ot || v(function () {
                    ...
                    for (var n = le(e), i = arguments.length, r = 1, a = Ce.f, o = _.f; r < i;) for (var s, l = T(arguments[r++]), c = a ? Ke(l).concat(a(l)) : Ke(l), d = c.length, u = 0; u < d;) s = c[u++],
                        b && !o.call(l, s) || (n[s] = l[s]);
                    return n;
                } : Ot;
                ae({
                    target: "Object",
                ...
                var It = "	\n\x0B\f\r                　\u2028\u2029\ufeff", Ft = "[" + It + "]", Wt = RegExp("^" + Ft + Ft + "*"), jt = RegExp(Ft + Ft + "*$"), Yt = (Nt(1),
                    Nt(2), Nt(3)), Gt = y.parseInt, Ut = /^[+-]?0[Xx]/, qt = 8 !== Gt(It + "08") || 22 !== Gt(It + "0x16") ? function (e, t) {
                        var n = Yt(String(e));
                ...
                var $t = {
                    codeAt: Xt(!1),
                    charAt: Xt(!0)
                }, Zt = $t.charAt, Kt = fe.set, Jt = fe.getterFor("String Iterator");
                ...
                var nn = !v(function () {
                    ...
                    Y[i] = !0;
                }), an = (rn.REQUIRED, rn.fastKey, rn.getWeakData, rn.onFreeze, ce("iterator")), on = Array.prototype, sn = ce("iterator"), ln = t(function (e) {
                    function f(e, t) {
                ...
                function fn(s, e, t, l, i) {
                    ...
                    if (Pe(s, "function" != typeof c || !(i || r.forEach && !v(function () {
                        ...
                        g || (((d = e(function (e, t) {
                            tn(e, d, s);
                            var n, i, r, a, o = (n = new c(), i = d, St && "function" == typeof (r = e.constructor) && r !== i && m(a = r.prototype) && a !== i.prototype && St(n, a),
                                n);
                            return null != t && ln(t, o[u], o, l), o;
                        })).prototype = r).constructor = d), (f || p) && (n("delete"), n("has"), l && n("get")),
                            (p || h) && n(u), i && r.clear && delete r.clear;
                    }
                    return a[s] = d, ae({
                        global: !0,
                        forced: d != c
                ...
                var vn = rn.getWeakData, mn = fe.set, yn = fe.getterFor, bn = Ie.find, xn = Ie.findIndex, Mn = 0, wn = function () {
                    this.entries = [];
                };
                wn.prototype = {
                    get: function (e) {
                ...
                var _n = {
                    ...
                    var i, r = fe.enforce, n = !y.ActiveXObject && "ActiveXObject" in y, a = Object.isExtensible, o = e.exports = fn("WeakMap", t, _n, !0, !0);
                    if (I && n) {
                ...
                var Pn = "Expected a function", Dn = NaN, Vn = "[object Symbol]", Rn = /^\s+|\s+$/g, zn = /^[-+]0x[0-9a-f]+$/i, Bn = /^0b[01]+$/i, Hn = /^0o[0-7]+$/i, Nn = parseInt, In = "object" == typeof e && e && e.Object === Object && e, Fn = "object" == typeof self && self && self.Object === Object && self, Wn = In || Fn || Function("return this")(), jn = Object.prototype.toString, Yn = Math.max, Gn = Math.min;
                function Un(e) {
                    var t = typeof e;
                ...
                function Xn(e, t, n) {
                    ...
                    return Un(n) && (i = "leading" in n ? !!n.leading : i, r = "trailing" in n ? !!n.trailing : r),
                        function (i, r, e) {
                            ...
                            return r = qn(r) || 0, Un(e) && (u = !!e.leading, n = (h = "maxWait" in e) ? Yn(qn(e.maxWait) || 0, r) : n,
                                t = "trailing" in e ? !!e.trailing : t), m.cancel = function () {
                ...
                var Zn = /^\s+|\s+$/g, Kn = /^[-+]0x[0-9a-f]+$/i, Jn = /^0b[01]+$/i, Qn = /^0o[0-7]+$/i, ei = parseInt, ti = "object" == typeof e && e && e.Object === Object && e, ni = "object" == typeof self && self && self.Object === Object && self, ii = ti || ni || Function("return this")(), ri = Object.prototype.toString, ai = Math.max, oi = Math.min;
                function si(e) {
                    var t = typeof e;
                    return !!e && ("object" == t || "function" == t);
                }
                ...
                function ci(i, r, e) {
                    ...
                    return r = li(r) || 0, si(e) && (u = !!e.leading, n = (h = "maxWait" in e) ? ai(li(e.maxWait) || 0, r) : n,
                        t = "trailing" in e ? !!e.trailing : t), m.cancel = function () {
                            void 0 !== l && clearTimeout(l), a = c = o = l = void (d = 0);
                        }, m.flush = function () {
                ...
                var di, ui = "Expected a function", hi = "__lodash_hash_undefined__", fi = "[object Function]", gi = "[object GeneratorFunction]", pi = /^\[object .+?Constructor\]$/, vi = "object" == typeof e && e && e.Object === Object && e, mi = "object" == typeof self && self && self.Object === Object && self, yi = vi || mi || Function("return this")(), bi = Array.prototype, xi = Function.prototype, Mi = Object.prototype, wi = yi["__core-js_shared__"], _i = (di = /[^.]+$/.exec(wi && wi.keys && wi.keys.IE_PROTO || "")) ? "Symbol(src)_1." + di : "", Si = xi.toString, Ci = Mi.hasOwnProperty, ki = Mi.toString, Ti = RegExp("^" + Si.call(Ci).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Li = bi.splice, Ai = zi(yi, "Map"), Ei = zi(Object, "create");
                function Oi(e) {
                ...
                var Ii = Bi, Fi = function () {
                ...
                }(), Wi = "undefined" != typeof window && "undefined" != typeof document && window.document === document, ji = void 0 !== Fr && Fr.Math === Math ? Fr : "undefined" != typeof self && self.Math === Math ? self : "undefined" != typeof window && window.Math === Math ? window : Function("return this")(), Yi = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(ji) : function (e) {
                    return setTimeout(function () {
                        return e(Date.now());
                    }, 1e3 / 60);
                }, Gi = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], Ui = "undefined" != typeof MutationObserver, qi = (Zi.prototype.addObserver = function (e) {
                    ...
                    Wi && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_),
                        window.addEventListener("resize", this.refresh), Ui ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
                    ...
                    Wi && this.connected_ && (document.removeEventListener("transitionend", this.onTransitionEnd_),
                ...
                function er(e) {
                    return Wi ? Qi(e) ? tr(0, 0, (t = e.getBBox()).width, t.height) : function (e) {
                        ...
                        if ("border-box" === i.boxSizing && (Math.round(s + a) !== t && (s -= Ji(i, "left", "right") + a),
                            Math.round(l + o) !== n && (l -= Ji(i, "top", "bottom") + o)), e !== Xi(e).document.documentElement) {
                ...
                function nr(e, t) {
                    var n, i, r, a, o, s, l, c = (i = (n = t).x, r = n.y, a = n.width, o = n.height,
                        s = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(s.prototype),
                        Ni(l, {
                            x: i,
                            y: r,
                            width: a,
                ...
                function lr(e) {
                    this.broadcastWidth = 0, this.broadcastHeight = 0, this.contentRect_ = tr(0, 0, 0, 0),
                        this.target = e;
                }
                ...
                var fr = function () {
                    function l(e, t) {
                        ...
                        this.onScroll = function () {
                            ...
                            s.mouseX = e.clientX, s.mouseY = e.clientY, (s.axis.x.isOverflowing || s.axis.x.forceVisible) && s.onMouseMoveForAxis("x"),
                                (s.axis.y.isOverflowing || s.axis.y.forceVisible) && s.onMouseMoveForAxis("y");
                        }, this.onMouseLeave = function () {
                            s.onMouseMove.cancel(), (s.axis.x.isOverflowing || s.axis.x.forceVisible) && s.onMouseLeaveForAxis("x"),
                            ...
                            s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect(), s.axis.y.track.rect = s.axis.y.track.el.getBoundingClientRect(),
                                s.isWithinBounds(s.axis.y.track.rect) || (s.axis.y.scrollbar.el.classList.remove(s.classNames.visible),
                                    s.axis.y.isVisible = !1), s.isWithinBounds(s.axis.x.track.rect) || (s.axis.x.scrollbar.el.classList.remove(s.classNames.visible),
                            ...
                            s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect(), s.axis.y.track.rect = s.axis.y.track.el.getBoundingClientRect(),
                                ...
                                (t || n) && (e.preventDefault(), e.stopPropagation(), "mousedown" === e.type && (t && (s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect(),
                            ...
                            var t = s.axis[s.draggedAxis].track, n = t.rect[s.axis[s.draggedAxis].sizeAttr], i = s.axis[s.draggedAxis].scrollbar, r = s.contentWrapperEl[s.axis[s.draggedAxis].scrollSizeAttr], a = parseInt(s.elStyles[s.axis[s.draggedAxis].sizeAttr], 10);
                            ...
                            "x" === s.draggedAxis && (o = s.isRtl && l.getRtlHelpers().isRtlScrollbarInverted ? o - (n + i.size) : o,
                                o = s.isRtl && l.getRtlHelpers().isRtlScrollingInverted ? -o : o), s.contentWrapperEl[s.axis[s.draggedAxis].scrollOffsetAttr] = o;
                        }, this.onEndDrag = function (e) {
                            e.preventDefault(), e.stopPropagation(), s.el.classList.remove(s.classNames.dragging),
                                document.removeEventListener("mousemove", s.drag, !0), document.removeEventListener("mouseup", s.onEndDrag, !0),
                                s.removePreventClickId = window.setTimeout(function () {
                                    document.removeEventListener("click", s.preventClick, !0), document.removeEventListener("dblclick", s.preventClick, !0),
                                        s.removePreventClickId = null;
                                });
                        }, this.preventClick = function (e) {
                            e.preventDefault(), e.stopPropagation();
                        }, this.el = e, this.minScrollbarWidth = 20, this.options = Object.assign({}, l.defaultOptions, {}, t),
                            ...
                            }, this.removePreventClickId = null, l.instances.has(this.el) || (this.recalculate = Xn(this.recalculate.bind(this), 64),
                                this.onMouseMove = Xn(this.onMouseMove.bind(this), 64), this.hideScrollbars = ci(this.hideScrollbars.bind(this), this.options.timeout),
                                this.onWindowResize = ci(this.onWindowResize.bind(this), 64, {
                                    leading: !0
                    ...
                    return e.init = function () {
                        l.instances.set(this.el, this), qe && (this.initDOM(), this.scrollbarWidth = this.getScrollbarWidth(),
                        ...
                        if (!this.axis.x.track.el || !this.axis.y.track.el) {
                            ...
                            e.classList.add(this.classNames.track), n.classList.add(this.classNames.scrollbar),
                                e.appendChild(n), this.axis.x.track.el = e.cloneNode(!0), this.axis.x.track.el.classList.add(this.classNames.horizontal),
                        ...
                        this.options.autoHide && this.el.addEventListener("mouseenter", this.onMouseEnter),
                            ...
                            this.contentWrapperEl.addEventListener("scroll", this.onScroll), window.addEventListener("resize", this.onWindowResize);
                        var e = !1;
                        ...
                        var e = this.heightAutoObserverEl.offsetHeight <= 1, t = this.heightAutoObserverEl.offsetWidth <= 1, n = this.contentEl.offsetWidth, i = this.contentWrapperEl.offsetWidth, r = this.elStyles.overflowX, a = this.elStyles.overflowY;
                        this.contentEl.style.padding = this.elStyles.paddingTop + " " + this.elStyles.paddingRight + " " + this.elStyles.paddingBottom + " " + this.elStyles.paddingLeft,
                            this.wrapperEl.style.margin = "-" + this.elStyles.paddingTop + " -" + this.elStyles.paddingRight + " -" + this.elStyles.paddingBottom + " -" + this.elStyles.paddingLeft;
                        var o = this.contentEl.scrollHeight, s = this.contentEl.scrollWidth;
                        this.contentWrapperEl.style.height = e ? "auto" : "100%", this.placeholderEl.style.width = t ? n + "px" : "auto",
                            this.placeholderEl.style.height = o + "px";
                        var l = this.contentWrapperEl.offsetHeight;
                        this.axis.x.isOverflowing = n < s, this.axis.y.isOverflowing = l < o, this.axis.x.isOverflowing = "hidden" !== r && this.axis.x.isOverflowing,
                            this.axis.y.isOverflowing = "hidden" !== a && this.axis.y.isOverflowing, this.axis.x.forceVisible = "x" === this.options.forceVisible || !0 === this.options.forceVisible,
                        ...
                        this.axis.x.isOverflowing = this.axis.x.isOverflowing && i - d < s, this.axis.y.isOverflowing = this.axis.y.isOverflowing && l - c < o,
                        ...
                        var t, n = this.contentEl[this.axis[e].scrollSizeAttr], i = this.axis[e].track.el[this.axis[e].offsetSizeAttr], r = i / n;
                        return t = Math.max(~~(r * i), this.options.scrollbarMinSize), this.options.scrollbarMaxSize && (t = Math.min(t, this.options.scrollbarMaxSize)),
                            t;
                    }, e.positionScrollbar = function (e) {
                        if (void 0 === e && (e = "y"), this.axis[e].isOverflowing) {
                            var t = this.contentWrapperEl[this.axis[e].scrollSizeAttr], n = this.axis[e].track.el[this.axis[e].offsetSizeAttr], i = parseInt(this.elStyles[this.axis[e].sizeAttr], 10), r = this.axis[e].scrollbar, a = this.contentWrapperEl[this.axis[e].scrollOffsetAttr], o = (a = "x" === e && this.isRtl && l.getRtlHelpers().isRtlScrollingInverted ? -a : a) / (t - i), s = ~~((n - r.size) * o);
                        ...
                        this.axis[e].isOverflowing || this.axis[e].forceVisible ? (t.style.visibility = "visible",
                            this.contentWrapperEl.style[this.axis[e].overflowAttr] = "scroll") : (t.style.visibility = "hidden",
                                this.contentWrapperEl.style[this.axis[e].overflowAttr] = "hidden"), this.axis[e].isOverflowing ? n.style.display = "block" : n.style.display = "none";
                    }, e.hideNativeScrollbar = function () {
                        this.offsetEl.style[this.isRtl ? "left" : "right"] = this.axis.y.isOverflowing || this.axis.y.forceVisible ? "-" + this.scrollbarWidth + "px" : 0,
                            this.offsetEl.style.bottom = this.axis.x.isOverflowing || this.axis.x.forceVisible ? "-" + this.scrollbarWidth + "px" : 0;
                    }, e.onMouseMoveForAxis = function (e) {
                        void 0 === e && (e = "y"), this.axis[e].track.rect = this.axis[e].track.el.getBoundingClientRect(),
                        ...
                        void 0 === e && (e = "y"), this.axis[e].track.el.classList.remove(this.classNames.hover),
                        ...
                        this.axis[t].dragOffset = i - n.rect[this.axis[t].offsetAttr], this.draggedAxis = t,
                            this.el.classList.add(this.classNames.dragging), document.addEventListener("mousemove", this.drag, !0),
                            document.addEventListener("mouseup", this.onEndDrag, !0), null === this.removePreventClickId ? (document.addEventListener("click", this.preventClick, !0),
                        ...
                        var t = this.axis[i].scrollbar.rect[this.axis[i].offsetAttr], n = parseInt(this.elStyles[this.axis[i].sizeAttr], 10), a = this.contentWrapperEl[this.axis[i].scrollOffsetAttr], o = ("y" === i ? this.mouseY - t : this.mouseX - t) < 0 ? -1 : 1, s = -1 == o ? a - n : a + n;
                        !function e() {
                            var t, n;
                            -1 == o ? s < a && (a -= 40, r.contentWrapperEl.scrollTo(((t = {})[r.axis[i].offsetAttr] = a,
                                t)), window.requestAnimationFrame(e)) : a < s && (a += 40, r.contentWrapperEl.scrollTo(((n = {})[r.axis[i].offsetAttr] = a,
                        ...
                        this.options.autoHide && this.el.removeEventListener("mouseenter", this.onMouseEnter),
                            ...
                            this.contentWrapperEl.removeEventListener("scroll", this.onScroll), window.removeEventListener("resize", this.onWindowResize),
                            this.mutationObserver.disconnect(), this.resizeObserver.disconnect(), this.recalculate.cancel(),
                ...
                var xr, Mr, wr = RegExp.prototype.exec, _r = String.prototype.replace, Sr = wr, Cr = (xr = /a/,
                    Mr = /b*/g, wr.call(xr, "a"), wr.call(Mr, "a"), 0 !== xr.lastIndex || 0 !== Mr.lastIndex), kr = void 0 !== /()??/.exec("")[1];
                (Cr || kr) && (Sr = function (e) {
                    var t, n, i, r;
                    ...
                    }.call(this))), Cr && (t = this.lastIndex), i = wr.call(this, e), Cr && i && (this.lastIndex = this.global ? i.index + i[0].length : t),
                        kr && i && 1 < i.length && _r.call(i[0], n, function () {
                ...
                var Rr = Math.max, zr = Math.min, Br = Math.floor, Hr = /\$([$&'`]|\d\d?|<[^>]*>)/g, Nr = /\$([$&'`]|\d\d?)/g;
                ...
                return fr.initDOMLoadedElements = function () {
                    ...
                    this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this), "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(fr.handleMutations),
    ...
    10: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            t.appendChild(i);
            try {
                for (var a, o = "(10px * 10)", s = ["calc" + o, "-moz-calc" + o, "-webkit-calc" + o], l = 0; l < 3; l++) if (a = s[l],
                    i.style.width = a, 100 === i.offsetWidth) {
                    r = a.replace(o, "");
                    break;
                }
            } catch (e) { }
    ...
    17: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            for (var e, t, n, i = arguments[0] || {}, r = 1, a = arguments.length; r < a; r++) if (null !== (e = arguments[r])) for (t in e) n = e[t],
                i !== n && void 0 !== n && (i[t] = n);
            return i;
        };
    }, {}],
    ...
    25: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var t, n = document, i = (0, s.getBody)(), r = (0, l.setFakeBody)(i), a = n.createElement("p"), o = 9 < e.length ? "-" + e.slice(0, -9).toLowerCase() + "-" : "";
            return o += "transform", i.insertBefore(a, null), a.style[e] = "translate3d(1px,1px,1px)",
                t = window.getComputedStyle(a).getPropertyValue(o), i.fake ? (0, c.resetFakeBody)(i, r) : a.remove(),
    ...
    31: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var s = Math.min(a, 10), l = 0 <= e.indexOf("%") ? "%" : "px", c = (e = e.replace(l, ""),
                Number(t.style[n].replace(i, "").replace(r, "").replace(l, ""))), d = (e - c) / a * s;
    ...
    32: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var e, t = document, n = (0, s.getBody)(), i = (0, l.setFakeBody)(n), r = t.createElement("div"), a = t.createElement("style"), o = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
            a.type = "text/css", r.className = "tns-mq-test", n.appendChild(a), n.appendChild(r),
                a.styleSheet ? a.styleSheet.cssText = o : a.appendChild(t.createTextNode(o));
            return e = window.getComputedStyle ? window.getComputedStyle(r).position : r.currentStyle.position,
                n.fake ? (0, c.resetFakeBody)(n, i) : r.remove(), "absolute" === e;
        };
        var s = e("./getBody.js"), l = e("./setFakeBody.js"), c = e("./resetFakeBody.js");
    }, {
        "./getBody.js": 20,
    ...
    34: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var e, t = document, n = (0, l.getBody)(), i = (0, c.setFakeBody)(n), r = t.createElement("div"), a = t.createElement("div"), o = "";
            r.className = "tns-t-subp2", a.className = "tns-t-ct";
            for (var s = 0; s < 70; s++) o += "<div></div>";
            return a.innerHTML = o, r.appendChild(a), n.appendChild(r), e = Math.abs(r.getBoundingClientRect().left - a.children[67].getBoundingClientRect().left) < 2,
                n.fake ? (0, d.resetFakeBody)(n, i) : r.remove(), e;
        };
    ...
    35: [function (e, t, n) {
        ...
        var i = window, r = i.requestAnimationFrame || i.webkitRequestAnimationFrame || i.mozRequestAnimationFrame || i.msRequestAnimationFrame || function (e) {
    ...
    42: [function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            var t = "";
            e.fake && (t = i.docElement.style.overflow, e.style.background = "", e.style.overflow = i.docElement.style.overflow = "hidden",
                i.docElement.appendChild(e));
            return t;
        };
        var i = e("./docElement.js");
    }, {
    ...
    47: [function (e, t, n) {
        ...
        var wi = e("./helpers/raf.js"), _i = e("./helpers/caf.js"), Si = e("./helpers/extend.js"), Ci = e("./helpers/checkStorageValue.js"), ki = e("./helpers/setLocalStorage.js"), Ti = e("./helpers/getSlideId.js"), Li = e("./helpers/calc.js"), Ai = e("./helpers/percentageLayout.js"), Ei = e("./helpers/mediaquerySupport.js"), Oi = e("./helpers/createStyleSheet.js"), Pi = e("./helpers/addCSSRule.js"), Di = e("./helpers/removeCSSRule.js"), Vi = e("./helpers/getCssRulesLength.js"), Ri = e("./helpers/toDegree.js"), zi = e("./helpers/getTouchDirection.js"), Bi = e("./helpers/forEach.js"), Hi = e("./helpers/hasClass.js"), Ni = e("./helpers/addClass.js"), Ii = e("./helpers/removeClass.js"), Fi = e("./helpers/hasAttr.js"), Wi = e("./helpers/getAttr.js"), ji = e("./helpers/setAttrs.js"), Yi = e("./helpers/removeAttrs.js"), Gi = e("./helpers/arrayFromNodeList.js"), Ui = e("./helpers/hideElement.js"), qi = e("./helpers/showElement.js"), Xi = e("./helpers/isVisible.js"), $i = e("./helpers/whichProperty.js"), Zi = e("./helpers/has3DTransforms.js"), Ki = e("./helpers/getEndProperty.js"), Ji = e("./helpers/addEvents.js"), Qi = e("./helpers/removeEvents.js"), er = e("./helpers/events.js"), tr = e("./helpers/jsTransform.js");
        function nr(e) {
        ...
        n.tns = function e(A) {
            ...
            var E = document, v = window, r = {
                ENTER: 13,
                SPACE: 32,
                LEFT: 37,
                RIGHT: 39
            }, t = {}, n = A.useLocalStorage;
            if (n) {
                var i = navigator.userAgent, a = new Date();
                try {
                    (t = v.localStorage) ? (t.setItem(a, a), n = t.getItem(a) == a, t.removeItem(a)) : n = !1,
                        n || (t = {});
                } catch (e) {
                    n = !1;
                }
            ...
            var m = t.tC ? (0, Ci.checkStorageValue)(t.tC) : (0, ki.setLocalStorage)(t, "tC", (0,
                Li.calc)(), n), y = t.tPL ? (0, Ci.checkStorageValue)(t.tPL) : (0, ki.setLocalStorage)(t, "tPL", (0,
                    Ai.percentageLayout)(), n), O = t.tMQ ? (0, Ci.checkStorageValue)(t.tMQ) : (0, ki.setLocalStorage)(t, "tMQ", (0,
                        Ei.mediaquerySupport)(), n), o = t.tTf ? (0, Ci.checkStorageValue)(t.tTf) : (0,
                            ki.setLocalStorage)(t, "tTf", (0, $i.whichProperty)("transform"), n), s = t.t3D ? (0,
                                Ci.checkStorageValue)(t.t3D) : (0, ki.setLocalStorage)(t, "t3D", (0, Zi.has3DTransforms)(o), n), b = t.tTDu ? (0,
                                    Ci.checkStorageValue)(t.tTDu) : (0, ki.setLocalStorage)(t, "tTDu", (0, $i.whichProperty)("transitionDuration"), n), l = t.tTDe ? (0,
                                        Ci.checkStorageValue)(t.tTDe) : (0, ki.setLocalStorage)(t, "tTDe", (0, $i.whichProperty)("transitionDelay"), n), x = t.tADu ? (0,
                                            Ci.checkStorageValue)(t.tADu) : (0, ki.setLocalStorage)(t, "tADu", (0, $i.whichProperty)("animationDuration"), n), c = t.tADe ? (0,
                                                Ci.checkStorageValue)(t.tADe) : (0, ki.setLocalStorage)(t, "tADe", (0, $i.whichProperty)("animationDelay"), n), d = t.tTE ? (0,
                                                    Ci.checkStorageValue)(t.tTE) : (0, ki.setLocalStorage)(t, "tTE", (0, Ki.getEndProperty)(b, "Transition"), n), u = t.tAE ? (0,
                                                        Ci.checkStorageValue)(t.tAE) : (0, ki.setLocalStorage)(t, "tAE", (0, Ki.getEndProperty)(x, "Animation"), n), h = v.console && "function" == typeof v.console.warn, f = ["container", "controlsContainer", "prevButton", "nextButton", "navContainer", "autoplayButton"], g = {};
            if (f.forEach(function (e) {
                ...
                var L, U, q, X, $, Z = A.autoWidth, K = rn("fixedWidth"), J = rn("edgePadding"), Q = rn("gutter"), ee = tn(), te = rn("center"), ne = Z ? 1 : Math.floor(rn("items")), ie = rn("slideBy"), re = A.viewportMax || A.fixedWidthViewportWidth, ae = rn("arrowKeys"), oe = rn("speed"), se = A.rewind, le = !se && A.loop, ce = rn("autoHeight"), de = rn("controls"), ue = rn("controlsText"), he = rn("nav"), fe = rn("touch"), ge = rn("mouseDrag"), pe = rn("autoplay"), ve = rn("autoplayTimeout"), me = rn("autoplayText"), ye = rn("autoplayHoverPause"), be = rn("autoplayResetOnVisibility"), xe = (0,
                    ...
                    }(), $ = V ? Math.ceil((5 * X - j) / 2) : 4 * X - j, $ = Math.max(X, $), nn("edgePadding") ? $ + 1 : $) : 0, Se = V ? j + 2 * _e : j + _e, Ce = !(!K && !Z || le), ke = K ? qn() : null, Te = !V || !le, Le = N ? "left" : "top", Ae = "", Ee = "", Oe = K ? function () {
                    ...
                    }, Pe = Zt(rn("startIndex")), De = Pe, Ve = ($t(), 0), Re = Z ? null : Oe(), ze = A.preventActionWhenRunning, Be = A.swipeAngle, He = !Be || "?", Ne = !1, Ie = A.onInit, Fe = new er.Events(), We = " tns-slider tns-" + A.mode, je = F.id || (0,
                        Ti.getSlideId)(), Ye = rn("disable"), Ge = !1, Ue = A.freezable, qe = !(!Ue || Z) && bn(), Xe = !1, $e = {
                            click: ni,
                            keydown: function (e) {
                                e = di(e);
                            ...
                            keydown: function (e) {
                                ...
                                var n = [r.LEFT, r.RIGHT, r.ENTER, r.SPACE].indexOf(e.keyCode), i = Number((0,
                                    Wi.getAttr)(t, "data-nav"));
                            ...
                            mouseup: mi,
                            mouseleave: mi
                        }, nt = nn("controls"), it = nn("nav"), rt = !!Z || A.navAsThumbnails, at = nn("autoplay"), ot = nn("touch"), st = nn("mouseDrag"), lt = "tns-slide-active", ct = "tns-complete", dt = {
                            load: function (e) {
                                An(ui(e));
                            },
                            error: function (e) {
                ...
                if (nt) var ht, ft, gt = A.controlsContainer, pt = A.controlsContainer ? A.controlsContainer.outerHTML : "", vt = A.prevButton, mt = A.nextButton, yt = A.prevButton ? A.prevButton.outerHTML : "", bt = A.nextButton ? A.nextButton.outerHTML : "";
                if (it) var xt, Mt = A.navContainer, wt = A.navContainer ? A.navContainer.outerHTML : "", _t = Z ? j : bi(), St = 0, Ct = -1, kt = Jt(), Tt = kt, Lt = "tns-nav-active", At = "Carousel Page ", Et = " (Current Slide)";
                if (at) var Ot, Pt, Dt, Vt, Rt, zt = "forward" === A.autoplayDirection ? 1 : -1, Bt = A.autoplayButton, Ht = A.autoplayButton ? A.autoplayButton.outerHTML : "", Nt = ["<span class='tns-visually-hidden'>", " animation</span>"];
                if (ot || st) var It, Ft, Wt = {}, jt = {}, Yt = !1, Gt = N ? function (e, t) {
                    return e.x - t.x;
                } : function (e, t) {
                    return e.y - t.y;
                };
                Z || Xt(Ye || qe), o && (Le = o, Ae = "translate", Ee = s ? (Ae += N ? "3d(" : "3d(0px, ",
                    N ? ", 0px, 0px)" : ", 0px)") : (Ae += N ? "X(" : "Y(", ")")), V && (F.className = F.className.replace("tns-vpfix", "")),
                    function () {
                        nn("gutter");
                        C.className = "tns-outer", I.className = "tns-inner", C.id = je + "-ow", I.id = je + "-iw",
                            "" === F.id && (F.id = je);
                        We += y || Z ? " tns-subpixel" : " tns-no-subpixel", We += m ? " tns-calc" : " tns-no-calc",
                            Z && (We += " tns-autowidth");
                        We += " tns-" + A.axis, F.className += We, V ? ((S = E.createElement("div")).id = je + "-mw",
                            S.className = "tns-ovh", C.appendChild(S), S.appendChild(I)) : C.appendChild(I);
                        if (ce) {
                            (S || I).className += " tns-ah";
                        }
                        if (k.insertBefore(C, F), I.appendChild(F), (0, Bi.forEach)(W, function (e, t) {
                            (0, Ni.addClass)(e, "tns-item"), e.id || (e.id = je + "-item" + t), !V && B && (0,
                                Ni.addClass)(e, B), (0, ji.setAttrs)(e, {
                                    "aria-hidden": "true",
                                    tabindex: "-1"
                                });
                        }), _e) {
                        ...
                        N && (y || Z ? ((0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", "font-size:" + v.getComputedStyle(W[0]).fontSize + ";", (0,
                            Vi.getCssRulesLength)(xe)), (0, Pi.addCSSRule)(xe, "#" + je, "font-size:0;", (0,
                                Vi.getCssRulesLength)(xe))) : V && (0, Bi.forEach)(W, function (e, t) {
                        ...
                        if (O) {
                            ...
                            i = an(A.edgePadding, A.gutter, A.fixedWidth, A.speed, A.autoHeight), (0, Pi.addCSSRule)(xe, "#" + je + "-iw", i, (0,
                                Vi.getCssRulesLength)(xe)), V && (i = N && !Z ? "width:" + on(A.fixedWidth, A.gutter, A.items) + ";" : "",
                                    b && (i += dn(oe)), (0, Pi.addCSSRule)(xe, "#" + je, i, (0, Vi.getCssRulesLength)(xe))),
                                i = N && !Z ? sn(A.fixedWidth, A.gutter, A.items) : "", A.gutter && (i += ln(A.gutter)),
                                V || (b && (i += dn(oe)), x && (i += un(oe))), i && (0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", i, (0,
                                    Vi.getCssRulesLength)(xe));
                        } else {
                            Rn(), I.style.cssText = an(J, Q, K, ce), V && N && !Z && (F.style.width = on(K, Q, ne));
                            i = N && !Z ? sn(K, Q, ne) : "";
                            Q && (i += ln(Q)), i && (0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", i, (0,
                                Vi.getCssRulesLength)(xe));
                        }
                        if (P && O) for (var r in P) {
                            r = parseInt(r);
                            var a = P[r], o = (i = "", ""), s = "", l = "", c = "", d = Z ? null : rn("items", r), u = rn("fixedWidth", r), h = rn("speed", r), f = rn("edgePadding", r), g = rn("autoHeight", r), p = rn("gutter", r);
                            b && S && rn("autoHeight", r) && "speed" in a && (o = "#" + je + "-mw{" + dn(h) + "}"),
                                ...
                                b && "speed" in a && (l += dn(h)), l = l && "#" + je + "{" + l + "}", ("fixedWidth" in a || K && "gutter" in a || !V && "items" in a) && (c += sn(u, p, d)),
                                "gutter" in a && (c += ln(p)), !V && "speed" in a && (b && (c += dn(h)), x && (c += un(h))),
                ...
                var Ut = le ? V ? function () {
                    ...
                    Gn(F, ""), b || !oe ? (Zn(), oe && (0, Xi.isVisible)(F) || ei()) : (0, tr.jsTransform)(F, Le, Ae, Ee, Xn(), oe, ei),
                        N || yi();
                } : function () {
                    we = [];
                    var e = {};
                    e[d] = e[u] = ei, (0, Qi.removeEvents)(W[De], e), (0, Ji.addEvents)(W[Pe], e), Kn(De, R, z, !0),
                        Kn(Pe, B, R), d && u && oe && (0, Xi.isVisible)(F) || ei();
                };
                return {
                    version: "2.9.2",
                    getInfo: Mi,
                    ...
                    destroy: function () {
                        if (xe.disabled = !0, xe.ownerNode && xe.ownerNode.remove(), (0, Qi.removeEvents)(v, {
                            resize: mn
                        }), ae && (0, Qi.removeEvents)(E, Qe), gt && (0, Qi.removeEvents)(gt, $e), Mt && (0,
                            Qi.removeEvents)(Mt, Ze), (0, Qi.removeEvents)(F, Ke), (0, Qi.removeEvents)(F, Je),
                            Bt && (0, Qi.removeEvents)(Bt, {
                                click: li
            ...
            function Jt() {
                var e, t = Kt();
                return e = rt ? t : K || Z ? Math.ceil((t + 1) * _t / j - 1) : Math.floor(t / ne),
                    !le && V && Pe === Re && (e = _t - 1), e;
            }
            function Qt() {
            ...
            function tn() {
                ...
                return function e(t) {
                    ...
                    return t.appendChild(r), i = (n = r.getBoundingClientRect()).right - n.left, r.remove(),
                        i || e(t.parentNode);
                }(k) - e;
            }
            function nn(e) {
            ...
            function rn(e, t) {
                ...
                return "slideBy" === e && "page" === n && (n = rn("items")), V || "slideBy" !== e && "items" !== e || (n = Math.floor(n)),
                    n;
            }
            ...
            function hn() {
                if (nn("autoHeight") || Z || !N) {
                    ...
                    (0, Bi.forEach)(e, function (e) {
                        var t = e.src;
                        t && t.indexOf("data:image") < 0 ? ((0, Ji.addEvents)(e, dt), e.src = "", e.src = t,
                            (0, Ni.addClass)(e, "loading")) : Me || An(e);
                    }), (0, wi.raf)(function () {
            ...
            function gn() {
                N && !Z || (Hn(), Z ? (ke = qn(), Ue && (qe = bn()), Re = Oe(), Xt(Ye || qe)) : yi()),
                    V && $n(), pn(), vn();
            }
            function pn() {
                if (Nn(), C.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + kn() + "</span>  of " + j + "</div>"),
                    q = C.querySelector(".tns-liveregion .current"), at) {
                    var e = pe ? "stop" : "start";
                    Bt ? (0, ji.setAttrs)(Bt, {
                        "data-action": e
                    }) : A.autoplayButtonOutput && (C.insertAdjacentHTML(en(A.autoplayPosition), '<button data-action="' + e + '">' + Nt[0] + e + Nt[1] + me[0] + "</button>"),
                        Bt = C.querySelector("[data-action]")), Bt && (0, Ji.addEvents)(Bt, {
                            click: li
                ...
                if (it) {
                    if (Mt) (0, ji.setAttrs)(Mt, {
                        ...
                        t = '<div class="tns-nav" aria-label="Carousel Pagination">' + t + "</div>", C.insertAdjacentHTML(en(A.navPosition), t),
                            Mt = C.querySelector(".tns-nav"), xt = Mt.children;
                    }
                    if (xi(), b) {
                        var r = b.substring(0, b.length - 18).toLowerCase(), a = "transition: all " + oe / 1e3 + "s";
                        r && (a = "-" + r + "-" + a), (0, Pi.addCSSRule)(xe, "[aria-controls^=" + je + "-item]", a, (0,
                            Vi.getCssRulesLength)(xe));
                    }
                    (0, ji.setAttrs)(xt[kt], {
                ...
                nt && (gt || vt && mt || (C.insertAdjacentHTML(en(A.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + je + '">' + ue[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + je + '">' + ue[1] + "</button></div>"),
                    gt = C.querySelector(".tns-controls")), vt && mt || (vt = gt.children[0], mt = gt.children[1]),
                    A.controlsContainer && (0, ji.setAttrs)(gt, {
                        ...
                        "data-controls": "next"
                    })), ht = Fn(vt), ft = Fn(mt), Yn(), gt ? (0, Ji.addEvents)(gt, $e) : ((0, Ji.addEvents)(vt, $e),
                        (0, Ji.addEvents)(mt, $e))), Mn();
            }
            function vn() {
                if (V && d) {
                    var e = {};
                ...
                fe && (0, Ji.addEvents)(F, et, A.preventScrollOnTouch), ge && (0, Ji.addEvents)(F, tt),
                    ae && (0, Ji.addEvents)(E, Qe), "inner" === D ? Fe.on("outerResized", function () {
                        yn(), Fe.emit("innerLoaded", Mi());
                    }) : (P || K || Z || ce || !N) && (0, Ji.addEvents)(v, {
                        resize: mn
                    }), ce && ("outer" === D ? Fe.on("innerLoaded", Pn) : Ye || Pn()), Ln(), Ye ? Sn() : qe && _n(),
                    Fe.on("indexChanged", Vn), "inner" === D && Fe.emit("innerLoaded", Mi()), "function" == typeof Ie && Ie(Mi()),
                    G = !0;
            }
            function mn(e) {
                (0, wi.raf)(function () {
            ...
            function yn(e) {
                if (G) {
                    ...
                    var r, a, o = ne, s = Ye, l = qe, c = ae, d = de, u = he, h = fe, f = ge, g = pe, p = ye, v = be, m = Pe;
                    if (t) {
                        var y = K, b = ce, x = ue, M = te, w = me;
                        if (!O) var _ = Q, S = J;
                    }
                    if (ae = rn("arrowKeys"), de = rn("controls"), he = rn("nav"), fe = rn("touch"),
                        te = rn("center"), ge = rn("mouseDrag"), pe = rn("autoplay"), ye = rn("autoplayHoverPause"),
                        be = rn("autoplayResetOnVisibility"), t && (Ye = rn("disable"), K = rn("fixedWidth"),
                            oe = rn("speed"), ce = rn("autoHeight"), ue = rn("controlsText"), me = rn("autoplayText"),
                            ve = rn("autoplayTimeout"), O || (J = rn("edgePadding"), Q = rn("gutter"))), Xt(Ye),
                        ee = tn(), N && !Z || Ye || (Hn(), N || (yi(), i = !0)), (K || Z) && (ke = qn(),
                            Re = Oe()), (t || K) && (ne = rn("items"), ie = rn("slideBy"), (a = ne !== o) && (K || Z || (Re = Oe()),
                                Ut())), t && Ye !== s && (Ye ? Sn() : function () {
                                    if (!Ge) return;
                                    if (xe.disabled = !1, F.className += We, $n(), le) for (var e = _e; e--;) V && (0,
                                        qi.showElement)(W[e]), (0, qi.showElement)(W[Se - e - 1]);
                                    ...
                                    if (!Xe) return;
                                    J && O && (I.style.margin = "");
                                    if (_e) for (var e = "tns-transparent", t = _e; t--;) V && (0, Ii.removeClass)(W[t], e),
                                        (0, Ii.removeClass)(W[Se - t - 1], e);
                                    wn(), Xe = !1;
                                }(), i = !0)), Xt(Ye || qe), pe || (ye = be = !1), ae !== c && (ae ? (0, Ji.addEvents)(E, Qe) : (0,
                                    Qi.removeEvents)(E, Qe)), de !== d && (de ? gt ? (0, qi.showElement)(gt) : (vt && (0,
                                        qi.showElement)(vt), mt && (0, qi.showElement)(mt)) : gt ? (0, Ui.hideElement)(gt) : (vt && (0,
                                            Ui.hideElement)(vt), mt && (0, Ui.hideElement)(mt))), he !== u && (he ? (0, qi.showElement)(Mt) : (0,
                                                Ui.hideElement)(Mt)), fe !== h && (fe ? (0, Ji.addEvents)(F, et, A.preventScrollOnTouch) : (0,
                                                    Qi.removeEvents)(F, et)), ge !== f && (ge ? (0, Ji.addEvents)(F, tt) : (0, Qi.removeEvents)(F, tt)),
                        pe !== g && (pe ? (Bt && (0, qi.showElement)(Bt), Pt || Vt || oi()) : (Bt && (0,
                            Ui.hideElement)(Bt), Pt && si())), ye !== p && (ye ? (0, Ji.addEvents)(F, Ke) : (0,
                                Qi.removeEvents)(F, Ke)), be !== v && (be ? (0, Ji.addEvents)(E, Je) : (0, Qi.removeEvents)(E, Je)),
                        t) {
                        if (K === y && te === M || (i = !0), ce !== b && (ce || (I.style.height = "")),
                            de && ue !== x && (vt.innerHTML = ue[0], mt.innerHTML = ue[1]), Bt && me !== w) {
                            var C = pe ? 1 : 0, k = Bt.innerHTML, T = k.length - w[C].length;
                            k.substring(T) === w[C] && (Bt.innerHTML = k.substring(0, T) + me[C]);
                        }
                    } else te && (K || Z) && (i = !0);
                    if ((a || K && !Z) && (_t = bi(), xi()), (r = Pe !== m) ? (Fe.emit("indexChanged", Mi()),
                        i = !0) : a ? r || Vn() : (K || Z) && (Ln(), Nn(), Cn()), a && !V && function () {
                            for (var e = Pe + Math.min(j, ne), t = Se; t--;) {
                                var n = W[t];
                                Pe <= t && t < e ? ((0, Ni.addClass)(n, "tns-moving"), n.style.left = 100 * (t - Pe) / ne + "%",
                                    (0, Ni.addClass)(n, R), (0, Ii.removeClass)(n, B)) : n.style.left && (n.style.left = "",
                                        (0, Ni.addClass)(n, B), (0, Ii.removeClass)(n, R)), (0, Ii.removeClass)(n, z);
                            }
                            setTimeout(function () {
                        ...
                        if (t && !O && (ce === autoheightTem && oe === speedTem || Rn(), J === S && Q === _ || (I.style.cssText = an(J, Q, K, oe, ce)),
                            N)) {
                            V && (F.style.width = on(K, Q, ne));
                            var L = sn(K, Q, ne) + ln(Q);
                            (0, Di.removeCSSRule)(xe, (0, Vi.getCssRulesLength)(xe) - 1), (0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", L, (0,
                                Vi.getCssRulesLength)(xe));
                        }
                        ce && Pn(), i && ($n(), De = Pe);
                    }
            ...
            function Mn() {
                !pe && Bt && (0, Ui.hideElement)(Bt), !he && Mt && (0, Ui.hideElement)(Mt), de || (gt ? (0,
                    Ui.hideElement)(gt) : (vt && (0, Ui.hideElement)(vt), mt && (0, Ui.hideElement)(mt)));
            }
            function wn() {
                pe && Bt && (0, qi.showElement)(Bt), he && Mt && (0, qi.showElement)(Mt), de && (gt ? (0,
                    qi.showElement)(gt) : (vt && (0, qi.showElement)(vt), mt && (0, qi.showElement)(mt)));
            }
            function _n() {
                if (!Xe) {
                    if (J && (I.style.margin = "0px"), _e) for (var e = "tns-transparent", t = _e; t--;) V && (0,
                        Ni.addClass)(W[t], e), (0, Ni.addClass)(W[Se - t - 1], e);
                    Mn(), Xe = !0;
                }
            }
            function Sn() {
                if (!Ge) {
                    if (xe.disabled = !0, F.className = F.className.replace(We.substring(1), ""), (0,
                        Yi.removeAttrs)(F, ["style"]), le) for (var e = _e; e--;) V && (0, Ui.hideElement)(W[e]),
                            (0, Ui.hideElement)(W[Se - e - 1]);
            ...
            function Tn(e) {
                null == e && (e = Xn());
                var n, i, r, a = Pe;
                if (te || J ? (Z || K) && (i = -(parseFloat(e) + J), r = i + ee + 2 * J) : Z && (i = L[Pe],
                    r = i + ee), Z) L.forEach(function (e, t) {
            ...
            function Nn() {
                ...
                (0, Bi.forEach)(W, function (e, t) {
                    n <= t && t <= i ? (0, Fi.hasAttr)(e, "aria-hidden") && ((0, Yi.removeAttrs)(e, ["aria-hidden", "tabindex"]),
                        (0, Ni.addClass)(e, lt)) : (0, Fi.hasAttr)(e, "aria-hidden") || ((0, ji.setAttrs)(e, {
                            "aria-hidden": "true",
                            tabindex: "-1"
            ...
            function Yn() {
                if (de && !se && !le) {
                    ...
                    n && !e && jn(ht, vt, !0), !n && e && jn(ht, vt, !1), i && !t && jn(ft, mt, !0),
                        !i && t && jn(ft, mt, !1);
                }
            }
            function Gn(e, t) {
            ...
            function qn() {
                ...
                return te && !le && (e = K ? -(K + Q) * (Se - 1) - Un() : Un(Se - 1) - L[Se - 1]),
                    0 < e && (e = 0), e;
            }
            function Xn(e) {
                var t;
            ...
            function Kn(e, t, n, i) {
                ...
                for (var a = e; a < r; a++) {
                    var o = W[a];
                    i || (o.style.left = 100 * (a - Pe) / ne + "%"), _ && l && (o.style[l] = o.style[c] = _ * (a - e) / 1e3 + "s"),
                        (0, Ii.removeClass)(o, t), (0, Ni.addClass)(o, n), i && we.push(o);
                }
            }
            function Jn(e, t) {
                Te && Ut(), Pe === De && !t || (Fe.emit("indexChanged", Mi()), Fe.emit("transitionStart", Mi()),
                    ce && Pn(), Pt && e && 0 <= ["click", "keydown"].indexOf(e.type) && si(), Ne = !0,
                    qt());
            }
            function Qn(e) {
            ...
            function ei(e) {
                if (V || Ne) {
                    if (Fe.emit("transitionEnd", Mi(e)), !V && 0 < we.length) for (var t = 0; t < we.length; t++) {
                        var n = we[t];
                        n.style.left = "", c && l && (n.style[c] = "", n.style[l] = ""), (0, Ii.removeClass)(n, z),
                            (0, Ni.addClass)(n, B);
                    }
            ...
            function ti(e, t) {
                if (!qe) if ("prev" === e) ni(t, -1); else if ("next" === e) ni(t, 1); else {
                    ...
                    var n = Kt(), i = 0;
                    if ("first" === e ? i = -n : "last" === e ? i = V ? j - ne - n : j - 1 - n : ("number" != typeof e && (e = parseInt(e)),
                        isNaN(e) || (t || (e = Math.max(0, Math.min(j - 1, e))), i = e - n)), !V && i && Math.abs(i) < ne) {
                        var r = 0 < i ? 1 : -1;
            ...
            function pi(e) {
                ...
                var t = di(e);
                Fe.emit(hi(e) ? "touchStart" : "dragStart", Mi(e)), !hi(e) && 0 <= ["img", "a"].indexOf(In(ui(e))) && fi(e),
                    jt.x = Wt.x = t.clientX, jt.y = Wt.y = t.clientY, V && (It = parseFloat(F.style[Le].replace(Ae, "")),
                        Gn(F, "0s"));
            }
            function vi(e) {
                if (Yt) {
                    ...
                    if (Math.abs(r)) {
                        ...
                        V ? Ft = (0, wi.raf)(function () {
                            if (N && !Z) {
                                ...
                                var t = -(It + r);
                                if (t <= 0) Pe = Ve; else if (t >= L[Se - 1]) Pe = Re; else for (var n = 0; n < Se && t >= L[n];) t > L[Pe = n] && r < 0 && (Pe += 1),
                                    n++;
                            }
    ...
    48: [function (e, t, n) {
        "use strict";
        e("./global/page-loader"), e("simplebar"), e("./global/tooltips"), e("./global/popups"),
            e("./global/accordions"), e("./utils/svg-loader"), e("./utils/liquidify"), e("./utils/demo-icons"),
            e("./form/form-rating"), e("./form/form-counter"), e("./form/form-switch"), e("./form/form-input"),
            e("./form/interactive-input"), e("./landing/landing.tabs"), e("./header/header.progressBar"),
            e("./header/header.dropdown"), e("./sidebar/sidebar"), e("./global/user-avatar.hexagons"),
            e("./global/maps"), e("./content/content.progressBar"), e("./content/content.slider"),
            e("./content/content.dropdown"), e("./content/content.tab"), e("./global/charts"),
            e("./widget/twitter");
    }, {
    ...
    51: [function (e, t, n) {
        ...
        !function () {
            for (var e, t, n, i = 1; ;) {
                ...
                if (!a) break;
                e = a.getInfo(), t = 32, n = 8, e.container.style.width = "".concat(e.slideCount * t + (e.slideCount - 1) * n, "px"),
                    i++;
            }
        }();
    }, {
    ...
    53: [function (e, t, n) {
        ...
        e("../utils/core").querySelector(".form-counter", function (e) {
            ...
            try {
                for (var o, r = function () {
                    var e = o.value, t = e.querySelector(".form-counter-value"), n = e.querySelector(".form-counter-control-increase"), i = e.querySelector(".form-counter-control-decrease"), r = e.getAttribute("data-increase-by") ? Number.parseInt(e.getAttribute("data-increase-by"), 10) : 1, a = e.getAttribute("data-min") ? Number.parseInt(e.getAttribute("data-min"), 10) : 1;
                ...
                for (var a, r = function () {
                    ...
                    if (n) {
                        var i = function e(t) {
                            ...
                            "" !== n.value ? (e.classList.add("active"), window.addEventListener("keydown", i)) : "" === n.value && (e.classList.remove("active"),
    ...
    59: [function (e, t, n) {
        ...
        i.querySelector("#engagements-chart", function (e) {
            ...
            o.createChart(t, {
                ...
                data: {
                    datasets: [{
                        ...
                        backgroundColor: ["#615dfa", "#23d2e2", "#4f91ff", "#3ad2fe"],
                        hoverBackgroundColor: ["#615dfa", "#23d2e2", "#4f91ff", "#3ad2fe"],
                        borderWidth: 0
                    }],
            ...
            o.createChart(t, {
                ...
                data: {
                    datasets: [{
                        ...
                        hoverBackgroundColor: ["#615dfa", "#23d2e2"],
                        borderWidth: 0
                    }],
            ...
            var t = [20, 15, 22, 26, 12, 16, 24, 13, 17, 9, 26, 21, 14, 21, 17, 23, 30, 18, 24, 15, 28, 17, 13, 23, 16, 12, 23, 16, 24, 13, 22], n = [9, 28, 6, 9, 17, 7, 16, 12, 10, 11, 12, 3, 13, 11, 8, 17, 13, 16, 5, 19, 14, 11, 26, 8, 4, 15, 16, 25, 5, 13, 12], i = e[0].getContext("2d"), r = {
                labels: a(31),
                datasets: [{
                    label: "Engagements",
                    data: t,
    ...
    65: [function (e, t, n) {
        ...
        e("../utils/core").querySelector("#search-main", function (e) {
            ...
            960 < window.innerWidth && (i.addEventListener("input", function (e) {
                "" === r && "" !== e.target.value ? (n.showDropdowns(), window.addEventListener("keydown", t)) : "" === e.target.value && (n.hideDropdowns(),
                    window.removeEventListener("keydown", t)), r = e.target.value;
        ...
        r.querySelector(".content-grid", function (o) {
            function s(e) {
                if (1366 < window.innerWidth) {
                    var t = c.chat.active ? c.chat.maxWidth : c.chat.minWidth, n = c.navigation.active ? c.navigation.maxWidth : c.navigation.minWidth, i = (document.body.clientWidth - e.offsetWidth - t - n) / 2 + n;
            ...
            l(), window.addEventListener("resize", l), window.setTimeout(function () {
                ...
                var n = e[0], p = n.querySelector(".chat-widget-messages"), v = n.querySelector(".chat-widget-form"), m = n.querySelector(".chat-widget-button"), i = "closed";
                m.addEventListener("click", function () {
                    ...
                    var i = e[0], r = p.querySelectorAll(".chat-widget-message"), a = i.querySelector(".chat-widget-header"), o = i.querySelector(".chat-widget-conversation"), s = i.querySelector(".chat-widget-close-button"), l = !0, c = !1, d = void 0;
                    try {
                ...
                var n = e[0], i = document.querySelector("#navigation-widget"), r = document.querySelector("#navigation-widget-small"), a = "hidden";
                n.addEventListener("click", function () {
                    n.classList.toggle("active"), i.classList.toggle("delayed"), i.classList.toggle(a),
                        r.classList.toggle("delayed"), r.classList.toggle(a), c.navigation.active = !i.classList.contains(a),
                        l();
                }), t(), window.addEventListener("resize", t);
            }), r.querySelector(".navigation-widget-mobile-trigger", function (e) {
                var t = e[0], n = document.querySelector("#navigation-widget-mobile"), i = n.querySelector(".navigation-widget-close-button"), r = document.createElement("div");
                r.style.width = "100%", r.style.height = "100%", r.style.position = "fixed", r.style.top = "0",
                    r.style.left = "0", r.style.zIndex = 99998, r.style.backgroundColor = "rgba(21, 21, 31, .96)",
                    r.style.opacity = 0, r.style.visibility = "hidden", r.style.transition = "opacity .3s ease-in-out, visibility .3s ease-in-out",
                ...
                t.addEventListener("click", l), i.addEventListener("click", l), r.addEventListener("click", l),
    ...
    69: [function (e, t, n) {
        ...
        var r = {
            deepExtend: function (e, t) {
                for (var n in t) "object" === i(t[n]) ? (e[n] = t[n] instanceof Array ? [] : {},
            ...
            query: function (e) {
                ...
                return this.deepExtend(i, e), new Promise(function (e, t) {
                    ...
                    }, n.open(i.method, i.url, i.async), n.setRequestHeader(i.header.type, i.header.value),
            ...
            liquidify: function (e) {
                ...
                t.style.display = "none", e.style.background = 'url("'.concat(n, '") no-repeat center'),
                    e.style.backgroundSize = "cover";
            },
            liquidifyStatic: function (e, t) {
                t.style.display = "none", e.style.background = 'url("'.concat(t.getAttribute("src"), '") no-repeat center'),
                    e.style.backgroundSize = "cover";
            },
            dateDiff: function (e, t) {
                var n = 1 < arguments.length && void 0 !== t ? t : new Date(), i = Math.abs(e.getTime() - n.getTime()), r = Math.ceil(i / 1e3), a = Math.floor(i / 6e4), o = Math.floor(i / 36e5), s = Math.floor(i / 864e5), l = Math.floor(i / 6048e5), c = Math.floor(i / 24192e5), d = Math.floor(i / 290304e5);
                return r < 60 ? {
        ...
        e("./core").querySelector(".icon-demo-list", function (e) {
            function t(e) {
                var t = document.createElement("div"), n = document.createElement("div"), i = function (e) {
                    var t = document.createElementNS("http://www.w3.org/2000/svg", "svg"), n = document.createElementNS("http://www.w3.org/2000/svg", "use");
                    return t.classList.add("icon-".concat(e)), n.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", "#svg-".concat(e)),
                        t.appendChild(n), t;
                }(e.className), r = document.createElement("p"), a = document.createElement("p"), o = document.createElement("p"), s = document.createElement("span"), l = document.createElement("span");
                return t.classList.add("demo-box"), n.classList.add("demo-box-icon-wrap"), i.classList.add("demo-box-icon"),
                    r.classList.add("demo-box-title"), a.classList.add("demo-box-text"), o.classList.add("button", "full"),
                    s.classList.add("inactive-text"), l.classList.add("active-text"), r.innerHTML = e.name,
                    a.innerHTML = ".icon-".concat(e.className), s.innerHTML = "Copy SVG", l.innerHTML = "Copied!",
                    n.appendChild(i), t.appendChild(n), t.appendChild(r), t.appendChild(a), o.appendChild(s),
                    o.appendChild(l), {
                    container: t,
                    trigger: o
                };
    ...
    72: [function (e, t, n) {
        ...
        var r = e("tiny-slider/src/tiny-slider"), a = e("chart.js"), o = {
    ...
    74: [function (e, t, n) {
        ...
        h.querySelector(".tweet-feed", function (s) {
            function l(e) {
                var t = document.createElement("div"), n = document.createElement("a"), i = document.createElement("figure"), r = document.createElement("img"), a = document.createElement("p"), o = document.createElement("p"), s = document.createElement("a"), l = document.createElement("p");
                t.classList.add("tweet"), n.classList.add("tweet-author"), i.classList.add("tweet-author-image", "picture", "tiny", "circle", "liquid"),
                    a.classList.add("tweet-author-title"), o.classList.add("tweet-author-text"), s.classList.add("tweet-text"),
                    l.classList.add("tweet-timestamp"), i.appendChild(r), n.appendChild(i), n.appendChild(a),
                    n.appendChild(o), t.appendChild(n), t.appendChild(s), t.appendChild(l);
                var c = "https://twitter.com/".concat(e.user.screen_name), d = e.entities.urls.length ? e.entities.urls[0].url : c, u = h.dateDiff(new Date(e.created_at));
                return n.setAttribute("href", c), n.setAttribute("target", "_blank"), r.setAttribute("src", e.user.profile_image_url_https),
                    a.innerHTML = e.user.name, o.innerHTML = "@".concat(e.user.screen_name), s.setAttribute("href", d),
                    s.setAttribute("target", "_blank"), s.innerHTML = function (e) {
                        return e.replace(/(@\w+)\s/gim, '<span class="highlighted">$1</span> ');
                    }(function (e) {
                        return e.replace(/(#\w+)\s/gim, '<span class="highlighted">$1</span> ');
                    }(e.text)), l.innerHTML = "".concat(u.value, " ").concat(u.unit, " ago"), h.liquidifyStatic(i, r),
                    t;
            }
            function c(e) {
                var t = document.createElement("div");
